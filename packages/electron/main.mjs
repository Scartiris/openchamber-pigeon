...
const GITHUB_BUG_REPORT_URL = 'https://github.com/Scartiris/openchamber-pigeon/issues/new';
const GITHUB_FEATURE_REQUEST_URL = 'https://github.com/Scartiris/openchamber-pigeon/issues/new';
