...
import { BUILT_IN_CONTEXT_PANEL_MODES, isContextPanelMode, type ContextPanelMode } from '@/lib/surfaces/modes';
...
const sanitizeContextPanelByDirectory = (
  ...
  for (const [rawDirectory, rawState] of Object.entries(source)) {
    ...
    for (const mode of BUILT_IN_CONTEXT_PANEL_MODES) {
    ...
    persist(
      (set, get) => ({
        ...
        setScheduledTasksDialogOpen: (open) => {
          set(open
            ? { isScheduledTasksDialogOpen: true, isArchivePageOpen: false, isArtifactCenterPageOpen: false, worktreesPageProjectId: null, isMultiRunLauncherOpen: false, openGuestPageId: null }
            : { isScheduledTasksDialogOpen: false });
        },

        setArchivePageOpen: (open) => {
          set(open
            ? { isArchivePageOpen: true, isScheduledTasksDialogOpen: false, isArtifactCenterPageOpen: false, worktreesPageProjectId: null, isMultiRunLauncherOpen: false, openGuestPageId: null }
            : { isArchivePageOpen: false });
        },

        setArtifactCenterOpen: (open) => {
          set(open
            ? { isArtifactCenterPageOpen: true, isScheduledTasksDialogOpen: false, isArchivePageOpen: false, worktreesPageProjectId: null, isMultiRunLauncherOpen: false, openGuestPageId: null }
            : { isArtifactCenterPageOpen: false });
        },

        setWorktreesPageProjectId: (projectId) => {
          set(projectId
            ? { worktreesPageProjectId: projectId, isScheduledTasksDialogOpen: false, isArchivePageOpen: false, isArtifactCenterPageOpen: false, isMultiRunLauncherOpen: false, openGuestPageId: null }
            : { worktreesPageProjectId: null });
        },

        setOpenGuestPage: (id) => {
          set(id
            ? { openGuestPageId: id, isScheduledTasksDialogOpen: false, isArchivePageOpen: false, isArtifactCenterPageOpen: false, worktreesPageProjectId: null, isMultiRunLauncherOpen: false }
            : { openGuestPageId: null });
        },

        closeMainSurfaces: () => {
          const state = get();
          if (!state.isScheduledTasksDialogOpen && !state.isArchivePageOpen && !state.isArtifactCenterPageOpen && !state.worktreesPageProjectId && !state.isMultiRunLauncherOpen && !state.openGuestPageId) {
            return;
          }
          set({
            isScheduledTasksDialogOpen: false,
        ...
        setMultiRunLauncherOpen: (open) => {
          set((state) => ({
            ...
            ...(open ? { isScheduledTasksDialogOpen: false, isArchivePageOpen: false, isArtifactCenterPageOpen: false, worktreesPageProjectId: null, openGuestPageId: null } : {}),
          }));
        },
