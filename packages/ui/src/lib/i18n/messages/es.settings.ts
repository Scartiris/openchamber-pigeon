...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': 'Fondo de vídeo tras la interfaz',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': 'Reproduce un vídeo en bucle tras toda la interfaz: barra lateral, cabecera y paneles lo dejan ver. Solo escritorio.',
  'settings.openchamber.visual.field.chatBackdropIntensity': 'Intensidad del fondo',
  ...
  'settings.openchamber.visual.section.chatBackdropInfo': 'El vídeo lo sirve esta instancia en /ambient/chat-backdrop.mp4. Sustituye el archivo y vuelve a compilar para cambiarlo.',
  ...
  "settings.page.memoryBrowse.description": "Explora la memoria a largo plazo de OpenViking como árbol de archivos.",
  "settings.page.knowledgeSettings.title": "Ajustes de conocimiento",
  "settings.page.knowledgeSettings.description": "Conexión y disponibilidad del almacén de conocimiento de OpenViking.",
  "settings.page.knowledgeBrowse.title": "Explorador de conocimiento",
  "settings.page.knowledgeBrowse.description": "Explora recursos y documentos de OpenViking como árbol de archivos.",
  "settings.openviking.notConfigured.short": "OpenViking no está configurado.",
  "settings.openviking.notConfigured.long": "Este espacio de trabajo no tiene OpenViking configurado, así que la exploración de memoria y conocimiento no está disponible.",
  "settings.openviking.settings.envHint": "Define las variables de entorno del contenedor",
  "settings.openviking.settings.connection": "Conexión",
  "settings.openviking.settings.storage": "Almacenamiento",
  "settings.openviking.settings.upstream": "Dirección de origen",
  "settings.openviking.settings.version": "Versión",
  "settings.openviking.settings.ready": "Disponibilidad",
  "settings.openviking.settings.identity": "Identidad",
  "settings.openviking.settings.scope": "Ámbito",
  "settings.openviking.settings.unknown": "Desconocido",
  "settings.openviking.settings.unreachable": "Inaccesible",
  "settings.openviking.settings.probeFailed": "No se pudo leer el estado de OpenViking. ¿Está en ejecución el contenedor?",
  "settings.openviking.settings.readyUnavailable": "La comprobación de disponibilidad agotó el tiempo.",
  "settings.openviking.settings.healthFailed": "No se pudo leer la versión de OpenViking. ¿Está en ejecución el contenedor?",
  "settings.openviking.settings.recheck": "Comprobar de nuevo",
  "settings.openviking.settings.readOnlyNote": "Esta página es de solo lectura por ahora. La política de confirmación de memoria vive en cada sesión dentro de OpenViking, no aquí.",
  "settings.openviking.memory.sidebar.title": "Memoria a largo plazo",
  "settings.openviking.memory.sidebar.description": "Todo lo que OpenViking ha recordado, como árbol de archivos.",
  "settings.openviking.memory.empty": "Todavía no se ha guardado ninguna memoria.",
  "settings.openviking.knowledge.sidebar.title": "Conocimiento",
  "settings.openviking.knowledge.sidebar.description": "Recursos y documentos importados, como árbol de archivos.",
  "settings.openviking.knowledge.empty": "Todavía no se ha importado ningún recurso.",
  "settings.openviking.browse.loading": "Cargando…",
  "settings.openviking.browse.loadFailed": "No se pudo cargar el árbol.",
  "settings.openviking.browse.readFailed": "No se pudo leer esta entrada.",
  "settings.openviking.browse.refresh": "Actualizar",
  "settings.openviking.browse.pickHint": "Elige una entrada a la izquierda para ver su contenido.",
  "settings.openviking.browse.overview": "Resumen",
  "settings.openviking.browse.overviewEmpty": "Todavía no se ha generado un resumen para este directorio.",
  "settings.openviking.browse.overviewFailed": "No se pudo cargar el resumen del directorio.",
  "settings.openviking.browse.childCount": "{{count}} entradas",
  "settings.openviking.browse.edit": "Editar",
  "settings.openviking.browse.editBody": "Contenido del archivo",
  "settings.openviking.browse.save": "Guardar",
  "settings.openviking.browse.saving": "Guardando…",
  "settings.openviking.browse.saveFailed": "No se pudo guardar esta entrada.",
  "settings.openviking.browse.cancel": "Cancelar",
  "settings.openviking.browse.delete": "Eliminar",
  "settings.openviking.browse.deleteTitle": "¿Eliminar esta entrada?",
  "settings.openviking.browse.deleteDescription": "¿Eliminar «{name}»? Esto no se puede deshacer.",
  "settings.openviking.browse.deleteNoRecycle": "No hay papelera. Las entradas eliminadas no se pueden recuperar.",
  "settings.openviking.browse.deleteConfirm": "Eliminar",
  "settings.openviking.browse.deleting": "Eliminando…",
  "settings.openviking.browse.deleteFailed": "No se pudo eliminar esta entrada.",
  "settings.openviking.browse.create": "Nueva entrada",
  "settings.openviking.browse.createTitle": "Nueva entrada",
  "settings.openviking.browse.createDescription": "Crear en {parent}",
  "settings.openviking.browse.createNoParent": "Elige primero un directorio.",
  "settings.openviking.browse.createNameLabel": "Nombre del archivo",
  "settings.openviking.browse.createNamePlaceholder": "note.md",
  "settings.openviking.browse.createContentLabel": "Contenido",
  "settings.openviking.browse.createContentPlaceholder": "Escribe el contenido…",
  "settings.openviking.browse.createSubmit": "Crear",
  "settings.openviking.browse.createFailed": "No se pudo crear esta entrada.",
  "settings.openviking.browse.createInvalidName": "Usa un nombre de archivo sencillo sin / ni \\, y evita nombres reservados.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.agents.page.field.workspaceEntries": "Áreas del taller",
  "settings.agents.page.field.workspaceEntriesTooltip": "En qué entradas (Código / Trabajo) puede aparecer este agente. Desmarca ambas para mostrarlo en todas.",
  ...
  'settings.page.devices.description': 'Registra dispositivos Windows para que el agente use shell, archivos y pantalla mediante MCP.',
  'settings.page.pigeonBrain.description': 'Gestiona la memoria a largo plazo y el almacén de conocimiento.',
  'settings.devices.approval.deny': 'Denegar',
  'settings.devices.approval.smart': 'Aprobación inteligente',
  'settings.devices.approval.auto': 'Automático',
  'settings.devices.section.registered': 'Dispositivos registrados',
  'settings.devices.section.agentMcpToken': 'Token MCP del agente',
  'settings.devices.section.audit': 'Auditoría reciente',
  'settings.devices.audit.empty': 'Aún no hay entradas.',
  'settings.devices.empty': 'Aún no hay dispositivos. Registra la primera máquina Windows abajo.',
  'settings.devices.status.probing': 'Comprobando el estado…',
  'settings.devices.actions.probing': 'Comprobando…',
  'settings.devices.actions.refresh': 'Actualizar estado',
  'settings.devices.status.probeFailed': 'Falló la comprobación de estado: {error}',
  'settings.devices.status.onlineCount': 'En línea {online}/{total}',
  'settings.devices.status.probedAt': 'comprobado a las {time}',
  'settings.devices.status.online': 'En línea',
  'settings.devices.status.offline': 'Sin conexión',
  'settings.devices.actions.approval': 'Aprobación',
  'settings.devices.actions.delete': 'Eliminar',
  'settings.devices.dialog.deleteConfirm': '¿Eliminar este dispositivo registrado?',
  'settings.devices.enroll.title': 'Registro en un clic',
  'settings.devices.enroll.description': 'Ejecuta un comando de PowerShell como administrador en la máquina Windows de destino. El código de registro caduca en 15 minutos y se consume al completarse.',
  'settings.devices.enroll.generate': 'Generar código de registro',
  'settings.devices.enroll.hint': 'Haz clic en Generar código de registro para obtener el comando de un clic.',
  'settings.devices.enroll.copyToTarget': 'Copia en la máquina de destino (caduca: {expiresAt}):',
  'settings.devices.enroll.copyCommand': 'Copiar comando',
  'settings.devices.enroll.copyCodeOnly': 'Copiar solo el código',
  'settings.devices.enroll.scriptHelp': 'El script genera o reutiliza una clave SSH, intenta autorizar administrators_authorized_keys, sondea Tailscale, puede imprimir argumentos de inicio de Windows-MCP y luego registra el dispositivo en el banco de trabajo.',
  'settings.devices.enroll.tokenItem': 'Sin usar · {label} · caduca {expiresAt}',
  'settings.devices.form.manual': 'Registro manual (avanzado)',
  'settings.devices.form.namePlaceholder': 'Nombre, por ejemplo portátil de obra',
  'settings.devices.form.hostPlaceholder': 'IP de Tailscale (opcional)',
  'settings.devices.form.sshPortPlaceholder': 'Puerto SSH (22 de forma predeterminada)',
  'settings.devices.form.mcpPortPlaceholder': 'Puerto Windows-MCP (opcional, salida del túnel)',
  'settings.devices.form.sshUserPlaceholder': 'Usuario SSH',
  'settings.devices.form.mcpBearerPlaceholder': 'Bearer de Windows-MCP (opcional)',
  'settings.devices.form.sshKeyPlaceholder': 'Clave privada SSH (opcional, solo en el data dir del servidor)',
  'settings.devices.actions.enroll': 'Registrar dispositivo',
  'settings.devices.actions.createToken': 'Generar token',
  'settings.devices.token.copyOnce': 'Cópialo ahora; no se mostrará otra vez al cerrar esta tarjeta:',
  'settings.devices.token.endpointHint': 'Endpoint MCP: POST /api/devices/mcp (Authorization: Bearer <token>)',
  'settings.devices.token.createdAt': 'creado {time}',
  'settings.devices.toast.copyFailed': 'Falló la copia. Selecciona el comando manualmente.',
  'settings.devices.error.loadDevices': 'Lista de dispositivos HTTP {status}',
  'settings.devices.error.statusProbe': 'Sonda de estado HTTP {status}',
  'settings.devices.error.nameRequired': 'Introduce un nombre de dispositivo.',
  'settings.devices.error.enrollFailed': 'Falló el registro HTTP {status}',
  'settings.devices.error.approvalFailed': 'Falló la actualización de aprobación HTTP {status}',
  'settings.devices.error.deleteFailed': 'Falló al eliminar HTTP {status}',
  'settings.devices.error.createTokenFailed': 'Falló al crear el token HTTP {status}',
  'settings.devices.error.createEnrollFailed': 'Falló al crear el código de registro HTTP {status}',
  'settings.devices.error.enrollTokenMissing': 'La respuesta del código de registro no incluyó el token.',
  'settings.pigeonBrain.actions.reload': 'Recargar',
  'settings.pigeonBrain.actions.openInNewTab': 'Abrir en una pestaña nueva',
  'settings.pigeonBrain.status.error': 'No se pudo leer el estado ({error}). Puede que el servidor del banco de trabajo no esté en marcha.',
  'settings.pigeonBrain.status.checking': 'Comprobando…',
  'settings.pigeonBrain.notConfigured.title': 'Este banco de trabajo no tiene pigeon-brain configurado.',
  'settings.pigeonBrain.notConfigured.help': 'Define PIGEON_BRAIN_URL en el entorno del contenedor (por ejemplo http://brain:3210) y reinicia. Si no está definido, esta ruta no se monta y el resto del banco de trabajo no se ve afectado.',
  'settings.pigeonBrain.iframeTitle': 'Interfaz de administración de pigeon-brain',
  'settings.mcp.oauth.callback.working': 'Completando la autorización de MCP…',
  'settings.mcp.oauth.callback.success': 'Autorización completada. Puedes cerrar esta pestaña y volver a OpenChamber.',
  'settings.mcp.oauth.callback.error': 'Falló la autorización',
  'settings.mcp.oauth.callback.browserUnavailable': 'El contexto del navegador no está disponible.',
  'settings.mcp.oauth.callback.sessionExpired': 'La sesión de autorización caducó o se borró al recargar. Vuelve a OpenChamber y haz clic en Autorizar de nuevo.',
  'settings.mcp.oauth.callback.missingCode': 'Falta el código de autorización OAuth. Inicia la autorización de nuevo desde Ajustes de MCP o pega el código devuelto en OpenChamber manualmente.',
  'settings.mcp.oauth.callback.sessionUnavailable': 'Los detalles de la sesión de autorización no estaban disponibles. Inicia la autorización de nuevo desde Ajustes de MCP o pega el código en OpenChamber manualmente.',
  'settings.mcp.oauth.callback.completeFailed': 'No se pudo completar la autorización de MCP.',
  'settings.mcp.oauth.callback.return': 'Volver a OpenChamber',
  'settings.mcp.oauth.callback.titles.working': 'Completando la autorización',
  'settings.mcp.oauth.callback.titles.success': 'Autorización completada',
  'settings.mcp.oauth.callback.titles.error': 'Falló la autorización',
  'settings.page.home.title': 'Ajustes',
  'settings.page.home.description': 'Busca y salta a las páginas habituales.',
} as const;
