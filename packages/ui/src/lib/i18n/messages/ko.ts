...
export const dict: Record<I18nKey, string> = {
  ...
  // Document preview
  'contextPanel.mode.doc': '문서',
  'contextRail.surface.doc.description': 'Word, Excel, PowerPoint, PDF 문서 미리보기',
  ...
  'fleet.header.aria': '플릿 상태: 호스트 메모리 {mem}%, 디스크 {disk}%, 장치 {online}/{total}',
  'fleet.header.tooltip.title': '플릿 상태',
  'fleet.header.tooltip.host': '호스트 메모리 {mem}% · 디스크 {disk}%',
  'fleet.header.tooltip.devices': '온라인 장치 {online}/{total}',
  'fleet.header.tooltip.stale': '호스트 지표가 {seconds}초 전입니다',
  'fleet.header.tooltip.unavailable': '호스트 지표를 사용할 수 없습니다',
  'fleet.dialog.title': '플릿 상태',
  'fleet.dialog.description': '워크벤치 호스트와 등록된 모든 장치의 메모리, 디스크, 네트워크.',
  'fleet.dialog.refresh': '새로 고침',
  'fleet.dialog.refreshing': '새로 고치는 중…',
  'fleet.dialog.checkedAt': '{seconds}초 전 수집',
  ...
  'fleet.metric.memory': '메모리',
  'fleet.metric.disk': '디스크',
  'fleet.metric.network': '네트워크',
  'fleet.metric.networkUnavailable': '사용 불가',
  'fleet.metric.load': '부하',
  'fleet.metric.uptime': '가동 시간',
  'fleet.metric.containers': '컨테이너',
  'fleet.metric.swap': '스왑',
  'fleet.metric.rtt': 'RTT {ms} ms',
  'fleet.status.online': '온라인',
  'fleet.status.offline': '오프라인',
  'fleet.error.load': '플릿 상태 HTTP {status}',
  'fleet.error.parse': '플릿 상태 응답을 이해할 수 없습니다',
  'fleet.hostHelper.hint': '네트워크 열은 서버의 oc-host-metrics 도우미가 필요합니다.',
  ...
  'chat.composerMode.label': '모드',
  'chat.composerMode.build': '작업',
  'chat.composerMode.plan': '계획',
  'chat.composerMode.chat': '채팅',
  'chat.composerMode.buildDescription': '평소대로 작업합니다: 파일을 읽고 쓰고 명령을 실행해 결과물을 만듭니다.',
  'chat.composerMode.planDescription': '먼저 계획: 읽기와 계획 파일 쓰기만 하고 코드는 바꾸지 않습니다.',
  'chat.composerMode.chatDescription': '채팅만: 파일을 쓰지 않고 명령도 실행하지 않으며 결과물도 만들지 않습니다.',
  'chat.composerMode.unavailable': '\'{mode}\' 에이전트를 사용할 수 없습니다.',
  'chat.promptEnhance.action': '프롬프트 최적화',
  'chat.promptEnhance.busy': '프롬프트 최적화 중…',
  'chat.promptEnhance.applied': '프롬프트를 최적화했습니다 ({model})',
  'chat.promptEnhance.undo': '실행 취소',
  'chat.promptEnhance.draftChanged': '초안이 변경되어 최적화 결과를 적용하지 않았습니다',
  'chat.promptEnhance.failed': '프롬프트를 최적화하지 못했습니다',
  'chat.promptEnhance.errorTooLong': '초안이 이 모델이 받을 수 있는 길이를 넘었습니다. 줄여서 다시 시도하세요.',
  'chat.promptEnhance.errorUnavailable': '서버에서 이 모델을 호출할 수 없습니다. 자격 증명을 확인하거나 설정 → 세션 → 소형 모델에서 다른 모델을 선택하세요.',
  'chat.promptEnhance.errorGeneric': '모델이 쓸 수 있는 프롬프트를 반환하지 않았습니다. 다시 시도하세요.',
  ...
  'agents.builtin.plan': '계획',
  'agents.builtin.chat': '채팅',
  ...
  // Artifact Center
  'artifacts.page.title': '산출물 센터',
  'artifacts.list.searchPlaceholder': '산출물 검색…',
  'artifacts.list.loading': '로딩 중…',
  'artifacts.list.retry': '다시 시도',
  'artifacts.list.empty': '아직 수집된 산출물이 없습니다. 파일 트리에서 수집하면 버전 관리가 시작됩니다.',
  'artifacts.list.missing': '원본 파일 없음',
  'artifacts.detail.selectHint': '산출물을 선택해 버전을 확인하세요.',
  'artifacts.detail.meta': '{size} · 업데이트 {when}',
  'artifacts.versions.title': '버전',
  'artifacts.versions.count': '{count}개 버전',
  'artifacts.versions.tierHot': '핫',
  'artifacts.versions.tierCold': '콜드(Drive)',
  'artifacts.versions.tierRestoring': '가져오는 중',
  'artifacts.versions.labelPlaceholder': '버전 라벨…',
  'artifacts.actions.preview': '미리보기',
  'artifacts.actions.restore': '복원',
  'artifacts.actions.pull': 'Drive에서 가져오기',
  'artifacts.actions.saveLabel': '라벨 저장',
  'artifacts.actions.uncollect': '센터에서 제거',
  'artifacts.actions.collect': '산출물로 수집',
  'artifacts.actions.openCenter': '산출물 센터 열기',
  'artifacts.actions.openCenterShort': '센터',
  'artifacts.status.collectedVersions': '버전 {count}개',
  'artifacts.status.notCollected': '수집 전',
  'artifacts.status.collected': '수집됨',
  'artifacts.candidates.title': '후보 보관함',
  'artifacts.candidates.count': '후보 {count}개',
  'artifacts.candidates.empty': '최근에 수집할 산출물 파일이 없습니다.',
  'artifacts.list.collectedTitle': '수집됨',
  'artifacts.sidebar.badgeAria': '산출물 {count}개',
  'sessions.sidebar.nav.artifacts': '산출물 센터',
  'artifacts.toast.collected': '산출물 센터에 추가했습니다',
  'artifacts.toast.alreadyCollected': '이미 산출물 센터에 있습니다',
  'artifacts.toast.labelSaved': '버전 라벨을 저장했습니다',
  'artifacts.toast.labelCleared': '버전 라벨을 지웠습니다',
  'artifacts.toast.restored': '이 버전으로 원본 파일을 복원했습니다',
  'artifacts.toast.pulled': '버전을 핫 스토리지로 가져왔습니다',
  'artifacts.toast.uncollected': '산출물 센터에서 제거했습니다',
  'artifacts.restore.dirtyConfirm': '원본 파일에 스냅샷되지 않은 변경이 있습니다. 덮어쓰고 복원할까요?',
  'commandPalette.item.openArtifactCenter': '산출물 센터 열기',
  // Google Drive cold tier
  'settings.integrations.googleDrive.title': 'Google Drive',
  'settings.integrations.googleDrive.description': '산출물 센터 버전용 콜드 계층입니다. 서버에 Drive OAuth 클라이언트가 필요합니다.',
  'settings.integrations.googleDrive.status.notConfigured': '이 서버에서 설정되지 않음',
  'settings.integrations.googleDrive.status.connected': '연결됨',
  'settings.integrations.googleDrive.status.notConnected': '연결되지 않음',
  'settings.integrations.googleDrive.actions.connect': '연결',
  'settings.integrations.googleDrive.actions.disconnect': '연결 해제',
  'settings.integrations.googleDrive.actions.refresh': '새로 고침',
  'settings.integrations.googleDrive.toast.authOpened': '열린 창에서 Google 로그인을 완료하세요',
  'settings.integrations.googleDrive.toast.disconnected': 'Google Drive 연결을 해제했습니다',
  ...
  'header.workspaceEntry.label': '워크벤치 영역',
  'header.workspaceEntry.hint': '사이드바에는 이 영역의 세션만 표시됩니다.',
  'header.workspaceEntry.code': '코드',
  'header.workspaceEntry.work': '업무',
  ...
  // Document preview
  'documentPreview.actions.download': '원본 다운로드',
  ...
  'documentPreview.error.tooLarge': '이 파일은 너무 커서 미리보기할 수 없습니다.',
  'documentPreview.error.unsupported': '이 파일 형식은 미리보기할 수 없습니다.',
  'chat.fileLink.previewTitle': '클릭하여 미리보기',
  'filesView.actions.openDocumentPreview': '문서 미리보기 열기',
  // 토큰 사용량 통계 (헤더)
  'tokenUsage.header.aria': '토큰 사용량 통계 열기',
  'tokenUsage.header.tooltip': '오늘: {tokens} 토큰',
  'tokenUsage.period.today': '오늘',
  'tokenUsage.period.last7Days': '최근 7일',
  'tokenUsage.period.last30Days': '최근 30일',
  'tokenUsage.dialog.title': '토큰 사용량',
  'tokenUsage.dialog.description': '기간·모델·캐시 적중별 토큰 소비량입니다.',
  'tokenUsage.dialog.byModel': '모델별',
  'tokenUsage.dialog.empty': '이 기간에는 토큰 사용이 없습니다.',
  'tokenUsage.dialog.unknownModel': '알 수 없는 모델',
  'tokenUsage.dialog.cacheHitValue': '캐시 적중 {percent}%',
  'tokenUsage.dialog.refresh': '새로 고침',
  'tokenUsage.dialog.refreshAria': '토큰 사용량 새로 고침',
  'tokenUsage.dialog.loading': '토큰 사용량을 수집하는 중…',
  'tokenUsage.dialog.partial': '{scanned}개 세션 중 {failed}개를 읽지 못했습니다.',
  'tokenUsage.stats.input': '입력',
  'tokenUsage.stats.output': '출력',
  'tokenUsage.stats.reasoning': '추론',
  ...
  'toolDisplayName.openvikingSearch': 'OpenViking 검색',
  'toolDisplayName.openvikingFind': 'OpenViking 빠른 검색',
  'toolDisplayName.openvikingRemember': 'OpenViking 기억하기',
  'toolDisplayName.openvikingRead': 'OpenViking 읽기',
  'toolDisplayName.openvikingList': 'OpenViking 목록',
  'toolDisplayName.openvikingTree': 'OpenViking 트리',
  'toolDisplayName.openvikingGrep': 'OpenViking 문자 검색',
  'toolDisplayName.openvikingGlob': 'OpenViking 글로브',
  'toolDisplayName.openvikingWrite': 'OpenViking 쓰기',
  'toolDisplayName.openvikingEdit': 'OpenViking 편집',
  'toolDisplayName.openvikingAddResource': 'OpenViking 리소스 추가',
  'toolDisplayName.openvikingForget': 'OpenViking 망각',
  'toolDisplayName.openvikingListWatches': 'OpenViking 감시 목록',
  'toolDisplayName.openvikingCancelWatch': 'OpenViking 감시 취소',
  'toolDisplayName.openvikingHealth': 'OpenViking 상태 확인',
  'sessions.sidebar.session.fork.toast.forkedFrom': '{title}에서 분기됨',
  'sessions.sidebar.session.fork.toast.failed': '세션을 분기하지 못했습니다',
  'header.sessions.untitled': '제목 없는 세션',
  'settings.menu.opencodeStatusFailed': 'OpenCode 상태를 읽을 수 없습니다',
  'tray.respondPermissionFailed': '권한 요청에 응답하지 못했습니다',
  'session.newWorktree.toast.noActiveProject': '활성 프로젝트가 없습니다',
  'session.newWorktree.toast.notGitRepository': '이 디렉터리는 Git 저장소가 아닙니다',
  'chat.toolPart.subagent.waiting': '하위 에이전트 활동 대기 중…',
  'chat.toolPart.subagent.missingSessionId': '작업 메타데이터에 하위 에이전트 세션 ID가 없습니다.',
  'chat.toolOutputDialog.labels.command': '명령:',
  'chat.toolOutputDialog.labels.task': '작업 세부 정보:',
  'chat.toolOutputDialog.labels.input': '입력:',
  'chat.toolOutputDialog.imagePreview': '이미지 미리보기',
  'settings.commands.sidebar.toast.commandRenamed': '명령 "{name}" 이름이 변경되었습니다',
  'agentManager.view.toast.creatingGroup': '실행 {count}개로 에이전트 그룹 "{name}" 생성 중…',
  'agentManager.view.toast.groupCreated': '에이전트 그룹 "{name}"이(가) {count}개 세션으로 생성되었습니다',
  'header.services.remoteUpdate.checkFailed': '원격 인스턴스 업데이트를 확인할 수 없습니다',
  'settings.remoteInstances.page.forward.localTarget': '로컬 대상',
  'settings.remoteInstances.page.forward.localListen': '로컬 리스닝',
  'settings.remoteInstances.page.forward.remoteListen': '원격 리스닝',
  'settings.remoteInstances.page.forward.remoteTarget': '원격 대상',
  'settings.remoteInstances.page.forward.localTargetHint': '원격 -R 리스너의 트래픽을 받는 로컬 호스트와 포트.',
  'settings.remoteInstances.page.forward.localListenHint': '이 전달이 로컬에서 리스닝하는 호스트와 포트.',
  'settings.remoteInstances.page.forward.remoteListenHint': 'SSH가 -R 리스너를 만드는 원격 호스트와 포트.',
  'settings.remoteInstances.page.forward.remoteTargetHint': '로컬 -L 리스너의 트래픽을 받는 원격 호스트와 포트.',
  'chat.toolOutputDialog.taskFields.task': '작업:',
  'chat.toolOutputDialog.taskFields.agentType': '에이전트 유형:',
  'chat.toolOutputDialog.taskFields.instructions': '지시:',
  'gitView.toast.removeRemoteFailed': '원격 {name} 제거 실패',
  'gitView.toast.upstreamSetFailed': '업스트림 설정 실패',
  'gitView.toast.mergeFailed': '{branch} 병합 실패',
  'gitView.toast.rebaseFailed': '{branch}으로 리베이스 실패',
  'contextSidebar.message.userLabel': '사용자:',
  'artifacts.toast.collectFailed': '이 파일을 아티팩트로 수집하지 못했습니다',
  'guests.host.notGranted': '사용자가 이 확장에 해당 기능을 허용하지 않았습니다.',
  'guests.host.extensionUnavailable': '확장을 사용할 수 없습니다.',
  'guests.host.extensionDisabled': '이 확장은 설정 → 확장에서 비활성화되어 있습니다.',
  'guests.host.requestFailed': '요청 실패.',
  'guests.host.noProject': '열린 프로젝트가 없습니다.',
  'guests.host.operationFailed': '확장 작업 실패.',
  'guests.service.noService': '이 확장에 사용 가능한 서비스가 없습니다.',
  'serverMessage.opencode.configReloaded': '구성을 다시 불러왔습니다. 인터페이스를 새로 고치는 중…',
  'serverMessage.opencode.manualRestart': '디스크에 저장되었습니다. 연결된 OpenCode 서버를 다시 시작하여 변경 사항을 적용하세요.',
  'serverMessage.session.interruptedByRestart': 'OpenCode 다시 시작으로 인해 중단됨',
  'serverMessage.session.interruptedByRestartDetail': '실행 중이던 턴이 OpenCode 다시 시작으로 인해 중단되었습니다.',
  'serverMessage.opencode.restartToApply': '저장되었습니다. 적용하려면 OpenCode를 다시 시작하세요.',
  'serverMessage.opencode.noSkillsInstalled': '설치된 기술이 없습니다',
  'serverMessage.git.statusFailed': 'Git 상태를 가져올 수 없습니다',
  'serverMessage.git.diffFailed': 'Git 차이를 불러올 수 없습니다',
  'serverMessage.git.pushFailed': '푸시 실패',
  'serverMessage.git.pullFailed': '풀 실패',
  'serverMessage.git.branchesFailed': '브랜치를 불러올 수 없습니다',
  'serverMessage.git.remotesFailed': '원격을 불러올 수 없습니다',
  'serverMessage.git.mergeFailed': '병합 실패',
  'serverMessage.git.removeRemoteFailed': '원격 제거 실패',
  'configUpdate.updatingOpenCode': 'OpenCode 구성을 업데이트하는 중…',
  'configUpdate.creatingCommand': '명령 구성을 만드는 중…',
  'configUpdate.updatingCommand': '명령 구성을 업데이트하는 중…',
  'configUpdate.deletingCommand': '명령 구성을 삭제하는 중…',
  'configUpdate.creatingSkill': '기술을 만드는 중…',
  'configUpdate.updatingSkill': '기술을 업데이트하는 중…',
  'configUpdate.renamingSkill': '기술 이름을 바꾸는 중…',
  'configUpdate.deletingSkill': '기술을 삭제하는 중…',
  'configUpdate.installingSkills': '기술을 설치하는 중…',
  'configUpdate.creatingMcp': 'MCP 서버 구성을 만드는 중…',
  'configUpdate.updatingMcp': 'MCP 서버 구성을 업데이트하는 중…',
  'configUpdate.deletingMcp': 'MCP 서버 구성을 삭제하는 중…',
  'configUpdate.creatingAgent': '에이전트 구성을 만드는 중…',
  'configUpdate.updatingAgent': '에이전트 구성을 업데이트하는 중…',
  'configUpdate.deletingAgent': '에이전트 구성을 삭제하는 중…',
  'configUpdate.reloadingOpenCode': 'OpenCode 구성을 다시 불러오는 중…',
};
