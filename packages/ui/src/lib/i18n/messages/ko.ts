...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.planMode.label': '계획 모드',
  'chat.planMode.enable': '계획 모드 켜기',
  'chat.planMode.disable': '계획 모드 끄기',
  'chat.planMode.description': '계획 에이전트를 사용합니다. 읽기와 계획 파일 쓰기만 하고 코드는 바꾸지 않습니다. 끄면 이전 에이전트로 돌아갑니다.',
  'chat.planMode.unavailable': '이 세션에서 사용할 수 있는 계획 에이전트가 없습니다.',
