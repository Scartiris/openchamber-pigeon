...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': 'Відео на тлі чату',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': 'Відтворює відео циклом позаду повідомлень. Бічні панелі, панелі та спливні вікна лишаються непрозорими. Лише комп’ютер.',
  ...
  'settings.openchamber.visual.section.chatBackdrop': 'Тло чату',
