...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': 'Відео на тлі всього інтерфейсу',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': 'Відтворює відео циклом позаду всього робочого простору — бічна панель, заголовок і панелі його пропускають. Лише комп’ютер.',
  'settings.openchamber.visual.field.chatBackdropIntensity': 'Насиченість тла',
  ...
  'settings.openchamber.visual.section.chatBackdropInfo': 'Відео роздає цей примірник за /ambient/chat-backdrop.mp4. Замініть файл і перезберіть, щоб його змінити.',
  ...
  "settings.page.memoryBrowse.description": "Переглядайте довготривалу пам’ять OpenViking як дерево файлів.",
  "settings.page.knowledgeSettings.title": "Налаштування знань",
  "settings.page.knowledgeSettings.description": "З’єднання та готовність сховища знань OpenViking.",
  "settings.page.knowledgeBrowse.title": "Огляд знань",
  "settings.page.knowledgeBrowse.description": "Переглядайте ресурси й документи OpenViking як дерево файлів.",
  "settings.openviking.notConfigured.short": "OpenViking не налаштовано.",
  "settings.openviking.notConfigured.long": "У цьому робочому просторі OpenViking не налаштовано, тому огляд пам’яті та знань недоступний.",
  "settings.openviking.settings.envHint": "Задайте змінні середовища контейнера",
  "settings.openviking.settings.connection": "З’єднання",
  "settings.openviking.settings.storage": "Сховище",
  "settings.openviking.settings.upstream": "Адреса джерела",
  "settings.openviking.settings.version": "Версія",
  "settings.openviking.settings.ready": "Готовність",
  "settings.openviking.settings.identity": "Ідентичність",
  "settings.openviking.settings.scope": "Область",
  ...
  "settings.openviking.memory.sidebar.description": "Усе, що запам’ятав OpenViking, як дерево файлів.",
  "settings.openviking.memory.empty": "Ще не збережено жодного спогаду.",
  "settings.openviking.knowledge.sidebar.title": "Знання",
  "settings.openviking.knowledge.sidebar.description": "Імпортовані ресурси й документи як дерево файлів.",
  "settings.openviking.knowledge.empty": "Ще не імпортовано жодного ресурсу.",
  "settings.openviking.browse.loading": "Завантаження…",
  "settings.openviking.browse.loadFailed": "Не вдалося завантажити дерево.",
  "settings.openviking.browse.readFailed": "Не вдалося прочитати цей запис.",
  "settings.openviking.browse.refresh": "Оновити",
  "settings.openviking.browse.pickHint": "Виберіть запис ліворуч, щоб побачити його вміст.",
  "settings.openviking.browse.overview": "Огляд",
  "settings.openviking.browse.overviewEmpty": "Для цього каталогу огляд ще не створено.",
  "settings.openviking.browse.overviewFailed": "Не вдалося завантажити огляд каталогу.",
  "settings.openviking.browse.childCount": "{{count}} записів",
  "settings.openviking.browse.edit": "Редагувати",
  "settings.openviking.browse.editBody": "Вміст файлу",
  "settings.openviking.browse.save": "Зберегти",
  "settings.openviking.browse.saving": "Збереження…",
  "settings.openviking.browse.saveFailed": "Не вдалося зберегти цей запис.",
  "settings.openviking.browse.cancel": "Скасувати",
  "settings.openviking.browse.delete": "Видалити",
  "settings.openviking.browse.deleteTitle": "Видалити цей запис?",
  "settings.openviking.browse.deleteDescription": "Видалити «{name}»? Цю дію не можна скасувати.",
  "settings.openviking.browse.deleteNoRecycle": "Немає смітника. Видалені записи відновити неможливо.",
  "settings.openviking.browse.deleteConfirm": "Видалити",
  "settings.openviking.browse.deleting": "Видалення…",
  "settings.openviking.browse.deleteFailed": "Не вдалося видалити цей запис.",
  "settings.openviking.browse.create": "Новий запис",
  "settings.openviking.browse.createTitle": "Новий запис",
  "settings.openviking.browse.createDescription": "Створити в {parent}",
  "settings.openviking.browse.createNoParent": "Спочатку виберіть каталог.",
  "settings.openviking.browse.createNameLabel": "Назва файлу",
  "settings.openviking.browse.createNamePlaceholder": "note.md",
  "settings.openviking.browse.createContentLabel": "Вміст",
  "settings.openviking.browse.createContentPlaceholder": "Напишіть вміст…",
  "settings.openviking.browse.createSubmit": "Створити",
  "settings.openviking.browse.createFailed": "Не вдалося створити цей запис.",
  "settings.openviking.browse.createInvalidName": "Використовуйте просту назву файлу без / або \\ і уникайте зарезервованих назв.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  'settings.page.devices.description': 'Зареєструйте пристрої Windows, щоб агент міг керувати оболонкою, файлами та екраном через MCP.',
  'settings.page.pigeonBrain.description': 'Керуйте довготривалою пам’яттю та сховищем знань.',
  'settings.devices.approval.deny': 'Відхилити',
  'settings.devices.approval.smart': 'Розумне схвалення',
  'settings.devices.approval.auto': 'Автоматично',
  'settings.devices.section.registered': 'Зареєстровані пристрої',
  'settings.devices.section.agentMcpToken': 'Токен MCP агента',
  'settings.devices.section.audit': 'Нещодавній журнал',
  'settings.devices.audit.empty': 'Записів ще немає.',
  'settings.devices.empty': 'Пристроїв ще немає. Зареєструйте першу Windows-машину нижче.',
  'settings.devices.status.probing': 'Перевірка стану…',
  'settings.devices.actions.probing': 'Перевірка…',
  'settings.devices.actions.refresh': 'Оновити стан',
  'settings.devices.status.probeFailed': 'Не вдалося перевірити стан: {error}',
  'settings.devices.status.onlineCount': 'Онлайн {online}/{total}',
  'settings.devices.status.probedAt': 'перевірено о {time}',
  'settings.devices.status.online': 'Онлайн',
  'settings.devices.status.offline': 'Офлайн',
  'settings.devices.actions.approval': 'Схвалення',
  'settings.devices.actions.delete': 'Видалити',
  'settings.devices.dialog.deleteConfirm': 'Видалити цей зареєстрований пристрій?',
  'settings.devices.enroll.title': 'Реєстрація одним клацанням',
  'settings.devices.enroll.description': 'Виконайте одну команду PowerShell адміністратора на цільовій Windows-машині. Код реєстрації дійсний 15 хвилин і використовується після успіху.',
  'settings.devices.enroll.generate': 'Згенерувати код реєстрації',
  'settings.devices.enroll.hint': 'Натисніть «Згенерувати код реєстрації», щоб отримати команду одним клацанням.',
  'settings.devices.enroll.copyToTarget': 'Скопіюйте на цільову машину (спливає: {expiresAt}):',
  'settings.devices.enroll.copyCommand': 'Скопіювати команду',
  'settings.devices.enroll.copyCodeOnly': 'Скопіювати лише код',
  'settings.devices.enroll.scriptHelp': 'Скрипт згенерує або повторно використає SSH-ключ, спробує авторизувати administrators_authorized_keys, перевірить Tailscale, за потреби виведе аргументи запуску Windows-MCP, а потім зареєструє пристрій у робочому середовищі.',
  'settings.devices.enroll.tokenItem': 'Невикористаний · {label} · спливає {expiresAt}',
  'settings.devices.form.manual': 'Ручна реєстрація (розширене)',
  'settings.devices.form.namePlaceholder': 'Назва, наприклад робочий ноутбук',
  'settings.devices.form.hostPlaceholder': 'IP Tailscale (необов’язково)',
  'settings.devices.form.sshPortPlaceholder': 'Порт SSH (типово 22)',
  'settings.devices.form.mcpPortPlaceholder': 'Порт Windows-MCP (необов’язково, вихід тунелю)',
  'settings.devices.form.sshUserPlaceholder': 'Користувач SSH',
  'settings.devices.form.mcpBearerPlaceholder': 'Bearer Windows-MCP (необов’язково)',
  'settings.devices.form.sshKeyPlaceholder': 'Приватний ключ SSH (необов’язково, зберігається лише в data dir сервера)',
  'settings.devices.actions.enroll': 'Зареєструвати пристрій',
  'settings.devices.actions.createToken': 'Згенерувати токен',
  'settings.devices.token.copyOnce': 'Скопіюйте зараз — після закриття картки його не буде показано знову:',
  'settings.devices.token.endpointHint': 'Кінцева точка MCP: POST /api/devices/mcp (Authorization: Bearer <token>)',
  'settings.devices.token.createdAt': 'створено {time}',
  'settings.devices.toast.copyFailed': 'Не вдалося скопіювати. Виділіть команду вручну.',
  'settings.devices.error.loadDevices': 'Список пристроїв HTTP {status}',
  'settings.devices.error.statusProbe': 'Перевірка стану HTTP {status}',
  'settings.devices.error.nameRequired': 'Введіть назву пристрою.',
  'settings.devices.error.enrollFailed': 'Реєстрацію не вдалося HTTP {status}',
  'settings.devices.error.approvalFailed': 'Не вдалося оновити схвалення HTTP {status}',
  'settings.devices.error.deleteFailed': 'Не вдалося видалити HTTP {status}',
  'settings.devices.error.createTokenFailed': 'Не вдалося створити токен HTTP {status}',
  'settings.devices.error.createEnrollFailed': 'Не вдалося створити код реєстрації HTTP {status}',
  'settings.devices.error.enrollTokenMissing': 'У відповіді коду реєстрації не було токена.',
  'settings.pigeonBrain.actions.reload': 'Перезавантажити',
  'settings.pigeonBrain.actions.openInNewTab': 'Відкрити в новій вкладці',
  'settings.pigeonBrain.status.error': 'Не вдалося прочитати стан ({error}). Сервер робочого середовища може не запущено.',
  'settings.pigeonBrain.status.checking': 'Перевірка…',
  'settings.pigeonBrain.notConfigured.title': 'У цьому робочому середовищі pigeon-brain не налаштовано.',
  'settings.pigeonBrain.notConfigured.help': 'Встановіть PIGEON_BRAIN_URL у середовищі контейнера (наприклад http://brain:3210) і перезапустіть. Якщо змінну не задано, маршрут не монтується, а решта робочого середовища не змінюється.',
  'settings.pigeonBrain.iframeTitle': 'Адмін-інтерфейс pigeon-brain',
  'settings.mcp.oauth.callback.working': 'Завершення авторизації MCP…',
  'settings.mcp.oauth.callback.success': 'Авторизацію завершено. Можна закрити цю вкладку та повернутися до OpenChamber.',
  'settings.mcp.oauth.callback.error': 'Помилка авторизації',
  'settings.mcp.oauth.callback.browserUnavailable': 'Контекст браузера недоступний.',
  'settings.mcp.oauth.callback.sessionExpired': 'Сесію авторизації завершено або очищено під час перезавантаження. Поверніться до OpenChamber і знову натисніть Авторизувати.',
  'settings.mcp.oauth.callback.missingCode': 'Відсутній код авторизації OAuth. Запустіть авторизацію ще раз у налаштуваннях MCP або вручну вставте повернутий код в OpenChamber.',
  'settings.mcp.oauth.callback.sessionUnavailable': 'Дані сесії авторизації були недоступні. Запустіть авторизацію ще раз у налаштуваннях MCP або вручну вставте код в OpenChamber.',
  'settings.mcp.oauth.callback.completeFailed': 'Не вдалося завершити авторизацію MCP.',
  'settings.mcp.oauth.callback.return': 'Повернутися до OpenChamber',
  'settings.mcp.oauth.callback.titles.working': 'Завершення авторизації',
  'settings.mcp.oauth.callback.titles.success': 'Авторизацію завершено',
  'settings.mcp.oauth.callback.titles.error': 'Помилка авторизації',
  'settings.page.home.title': 'Налаштування',
  'settings.page.home.description': 'Шукайте й переходьте до поширених сторінок.',
} as const;
