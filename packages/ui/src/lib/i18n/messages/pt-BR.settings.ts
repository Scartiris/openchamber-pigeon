...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': 'Vídeo de fundo atrás da interface',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': 'Reproduz um vídeo em loop atrás de toda a interface: barra lateral, cabeçalho e painéis deixam passar. Somente desktop.',
  'settings.openchamber.visual.field.chatBackdropIntensity': 'Intensidade do fundo',
  'settings.openchamber.visual.field.chatBackdropIntensityHint': 'Quanto da imagem sobrevive ao véu do tema. 0 oculta, 100 mantém sem alteração.',
  'settings.openchamber.visual.field.chatBackdropScrim': 'Véu',
  'settings.openchamber.visual.field.chatBackdropScrimHint': 'Véu extra na direção do fundo do tema para recuperar contraste do texto. O tema claro soma 20%.',
  'settings.openchamber.visual.field.chatBackdropSurfaceOpacity': 'Opacidade dos painéis',
  'settings.openchamber.visual.field.chatBackdropSurfaceOpacityHint': 'Quão sólidos são os painéis. Mais baixo deixa passar muito mais o fundo; mais alto mantém o texto mais calmo. É o que mais define o clima.',
  'settings.openchamber.visual.field.chatBackdropMotion': 'Movimento de respiração',
  'settings.openchamber.visual.field.chatBackdropMotionHint': 'Amplia a imagem lentamente para um quadro parado não parecer congelado. Ignorado com movimento reduzido.',
  'settings.openchamber.visual.section.chatBackdrop': 'Fundo da interface',
  'settings.openchamber.visual.section.chatBackdropInfo': 'O vídeo é servido por esta instância em /ambient/chat-backdrop.mp4. Substitua o arquivo e recompile para trocá-lo.',
  ...
  "settings.page.memorySettings.title": "Configurações de memória",
  "settings.page.memorySettings.description": "Conexão e prontidão do armazenamento de memória do OpenViking.",
  "settings.page.memoryBrowse.title": "Navegador de memória",
  "settings.page.memoryBrowse.description": "Navegue pela memória de longo prazo do OpenViking como árvore de arquivos.",
  "settings.page.knowledgeSettings.title": "Configurações de conhecimento",
  "settings.page.knowledgeSettings.description": "Conexão e prontidão do armazenamento de conhecimento do OpenViking.",
  "settings.page.knowledgeBrowse.title": "Navegador de conhecimento",
  "settings.page.knowledgeBrowse.description": "Navegue pelos recursos e documentos do OpenViking como árvore de arquivos.",
  "settings.openviking.notConfigured.short": "O OpenViking não está configurado.",
  "settings.openviking.notConfigured.long": "Este espaço de trabalho não tem OpenViking configurado, então a navegação de memória e conhecimento não está disponível.",
  "settings.openviking.settings.envHint": "Defina as variáveis de ambiente do contêiner",
  "settings.openviking.settings.connection": "Conexão",
  "settings.openviking.settings.storage": "Armazenamento",
  "settings.openviking.settings.upstream": "Endereço de origem",
  "settings.openviking.settings.version": "Versão",
  "settings.openviking.settings.ready": "Prontidão",
  "settings.openviking.settings.identity": "Identidade",
  "settings.openviking.settings.scope": "Escopo",
  ...
  "settings.openviking.memory.sidebar.description": "Tudo o que o OpenViking lembrou, como árvore de arquivos.",
  "settings.openviking.memory.empty": "Nenhuma memória foi armazenada ainda.",
  "settings.openviking.knowledge.sidebar.title": "Conhecimento",
  "settings.openviking.knowledge.sidebar.description": "Recursos e documentos importados, como árvore de arquivos.",
  "settings.openviking.knowledge.empty": "Nenhum recurso foi importado ainda.",
  "settings.openviking.browse.loading": "Carregando…",
  "settings.openviking.browse.loadFailed": "Não foi possível carregar a árvore.",
  "settings.openviking.browse.readFailed": "Não foi possível ler esta entrada.",
  "settings.openviking.browse.refresh": "Atualizar",
  "settings.openviking.browse.pickHint": "Escolha uma entrada à esquerda para ver seu conteúdo.",
  "settings.openviking.browse.overview": "Visão geral",
  "settings.openviking.browse.overviewEmpty": "Nenhuma visão geral foi gerada para este diretório ainda.",
  "settings.openviking.browse.overviewFailed": "Não foi possível carregar a visão geral do diretório.",
  "settings.openviking.browse.childCount": "{{count}} entradas",
  "settings.openviking.browse.edit": "Editar",
  "settings.openviking.browse.editBody": "Conteúdo do arquivo",
  "settings.openviking.browse.save": "Salvar",
  "settings.openviking.browse.saving": "Salvando…",
  "settings.openviking.browse.saveFailed": "Não foi possível salvar esta entrada.",
  "settings.openviking.browse.cancel": "Cancelar",
  "settings.openviking.browse.delete": "Excluir",
  "settings.openviking.browse.deleteTitle": "Excluir esta entrada?",
  "settings.openviking.browse.deleteDescription": "Excluir “{name}”? Isso não pode ser desfeito.",
  "settings.openviking.browse.deleteNoRecycle": "Não há lixeira. Entradas excluídas não podem ser recuperadas.",
  "settings.openviking.browse.deleteConfirm": "Excluir",
  "settings.openviking.browse.deleting": "Excluindo…",
  "settings.openviking.browse.deleteFailed": "Não foi possível excluir esta entrada.",
  "settings.openviking.browse.create": "Nova entrada",
  "settings.openviking.browse.createTitle": "Nova entrada",
  "settings.openviking.browse.createDescription": "Criar em {parent}",
  "settings.openviking.browse.createNoParent": "Escolha primeiro um diretório.",
  "settings.openviking.browse.createNameLabel": "Nome do arquivo",
  "settings.openviking.browse.createNamePlaceholder": "note.md",
  "settings.openviking.browse.createContentLabel": "Conteúdo",
  "settings.openviking.browse.createContentPlaceholder": "Escreva o conteúdo…",
  "settings.openviking.browse.createSubmit": "Criar",
  "settings.openviking.browse.createFailed": "Não foi possível criar esta entrada.",
  "settings.openviking.browse.createInvalidName": "Use um nome de arquivo simples sem / ou \\ e evite nomes reservados.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.agents.page.field.workspaceEntries": "Áreas da bancada",
  "settings.agents.page.field.workspaceEntriesTooltip": "Em quais entradas (Código / Trabalho) este agente pode aparecer. Desmarque ambas para mostrar em todas.",
  ...
  'settings.page.devices.description': 'Registre dispositivos Windows para o agente operar shell, arquivos e tela via MCP.',
  'settings.page.pigeonBrain.description': 'Gerencie a memória de longo prazo e o armazenamento de conhecimento.',
  'settings.devices.approval.deny': 'Negar',
  'settings.devices.approval.smart': 'Aprovação inteligente',
  'settings.devices.approval.auto': 'Automático',
  'settings.devices.section.registered': 'Dispositivos registrados',
  'settings.devices.section.agentMcpToken': 'Token MCP do agente',
  'settings.devices.section.audit': 'Auditoria recente',
  'settings.devices.audit.empty': 'Ainda não há entradas.',
  'settings.devices.empty': 'Ainda não há dispositivos. Registre a primeira máquina Windows abaixo.',
  'settings.devices.status.probing': 'Verificando o status…',
  'settings.devices.actions.probing': 'Verificando…',
  'settings.devices.actions.refresh': 'Atualizar status',
  'settings.devices.status.probeFailed': 'Falha ao verificar o status: {error}',
  'settings.devices.status.onlineCount': 'Online {online}/{total}',
  'settings.devices.status.probedAt': 'verificado às {time}',
  'settings.devices.status.online': 'Online',
  'settings.devices.status.offline': 'Offline',
  'settings.devices.actions.approval': 'Aprovação',
  'settings.devices.actions.delete': 'Excluir',
  'settings.devices.dialog.deleteConfirm': 'Excluir este dispositivo registrado?',
  'settings.devices.enroll.title': 'Inscrição em um clique',
  'settings.devices.enroll.description': 'Execute um comando PowerShell de administrador na máquina Windows de destino. O código de inscrição vale por 15 minutos e é consumido após o sucesso.',
  'settings.devices.enroll.generate': 'Gerar código de inscrição',
  'settings.devices.enroll.hint': 'Clique em Gerar código de inscrição para obter o comando de um clique.',
  'settings.devices.enroll.copyToTarget': 'Copie para a máquina de destino (expira: {expiresAt}):',
  'settings.devices.enroll.copyCommand': 'Copiar comando',
  'settings.devices.enroll.copyCodeOnly': 'Copiar apenas o código',
  'settings.devices.enroll.scriptHelp': 'O script gera ou reutiliza uma chave SSH, tenta autorizar administrators_authorized_keys, faz probe do Tailscale, pode imprimir argumentos de inicialização do Windows-MCP e então registra o dispositivo na bancada.',
  'settings.devices.enroll.tokenItem': 'Não usado · {label} · expira {expiresAt}',
  'settings.devices.form.manual': 'Registro manual (avançado)',
  'settings.devices.form.namePlaceholder': 'Nome, por exemplo notebook de obra',
  'settings.devices.form.hostPlaceholder': 'IP do Tailscale (opcional)',
  'settings.devices.form.sshPortPlaceholder': 'Porta SSH (padrão 22)',
  'settings.devices.form.mcpPortPlaceholder': 'Porta Windows-MCP (opcional, saída do túnel)',
  'settings.devices.form.sshUserPlaceholder': 'Usuário SSH',
  'settings.devices.form.mcpBearerPlaceholder': 'Bearer do Windows-MCP (opcional)',
  'settings.devices.form.sshKeyPlaceholder': 'Chave privada SSH (opcional, armazenada apenas no data dir do servidor)',
  'settings.devices.actions.enroll': 'Registrar dispositivo',
  'settings.devices.actions.createToken': 'Gerar token',
  'settings.devices.token.copyOnce': 'Copie agora — não será exibido de novo após fechar este cartão:',
  'settings.devices.token.endpointHint': 'Endpoint MCP: POST /api/devices/mcp (Authorization: Bearer <token>)',
  'settings.devices.token.createdAt': 'criado {time}',
  'settings.devices.toast.copyFailed': 'Falha ao copiar. Selecione o comando manualmente.',
  'settings.devices.error.loadDevices': 'Lista de dispositivos HTTP {status}',
  'settings.devices.error.statusProbe': 'Sonda de status HTTP {status}',
  'settings.devices.error.nameRequired': 'Informe um nome de dispositivo.',
  'settings.devices.error.enrollFailed': 'Falha na inscrição HTTP {status}',
  'settings.devices.error.approvalFailed': 'Falha ao atualizar a aprovação HTTP {status}',
  'settings.devices.error.deleteFailed': 'Falha ao excluir HTTP {status}',
  'settings.devices.error.createTokenFailed': 'Falha ao criar o token HTTP {status}',
  'settings.devices.error.createEnrollFailed': 'Falha ao criar o código de inscrição HTTP {status}',
  'settings.devices.error.enrollTokenMissing': 'A resposta do código de inscrição não continha o token.',
  'settings.pigeonBrain.actions.reload': 'Recarregar',
  'settings.pigeonBrain.actions.openInNewTab': 'Abrir em uma nova aba',
  'settings.pigeonBrain.status.error': 'Não foi possível ler o status ({error}). O servidor da bancada pode não estar em execução.',
  'settings.pigeonBrain.status.checking': 'Verificando…',
  'settings.pigeonBrain.notConfigured.title': 'Esta bancada não tem pigeon-brain configurado.',
  'settings.pigeonBrain.notConfigured.help': 'Defina PIGEON_BRAIN_URL no ambiente do contêiner (por exemplo http://brain:3210) e reinicie. Quando não definido, esta rota não é montada e o restante da bancada não é afetado.',
  'settings.pigeonBrain.iframeTitle': 'Interface de administração do pigeon-brain',
  'settings.mcp.oauth.callback.working': 'Concluindo a autorização MCP…',
  'settings.mcp.oauth.callback.success': 'Autorização concluída. Você pode fechar esta aba e voltar ao OpenChamber.',
  'settings.mcp.oauth.callback.error': 'Falha na autorização',
  'settings.mcp.oauth.callback.browserUnavailable': 'Contexto do navegador indisponível.',
  'settings.mcp.oauth.callback.sessionExpired': 'A sessão de autorização expirou ou foi limpa durante o recarregamento. Volte ao OpenChamber e clique em Autorizar novamente.',
  'settings.mcp.oauth.callback.missingCode': 'Código de autorização OAuth ausente. Inicie a autorização novamente nas Configurações de MCP ou cole o código retornado no OpenChamber manualmente.',
  'settings.mcp.oauth.callback.sessionUnavailable': 'Os detalhes da sessão de autorização não estavam disponíveis. Inicie a autorização novamente nas Configurações de MCP ou cole o código no OpenChamber manualmente.',
  'settings.mcp.oauth.callback.completeFailed': 'Não foi possível concluir a autorização MCP.',
  'settings.mcp.oauth.callback.return': 'Voltar ao OpenChamber',
  'settings.mcp.oauth.callback.titles.working': 'Concluindo a autorização',
  'settings.mcp.oauth.callback.titles.success': 'Autorização concluída',
  'settings.mcp.oauth.callback.titles.error': 'Falha na autorização',
  'settings.page.home.title': 'Configurações',
  'settings.page.home.description': 'Pesquise e vá para páginas comuns.',
} as const;
