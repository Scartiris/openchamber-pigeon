...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.planMode.label": "Modo de planejamento",
  "chat.planMode.enable": "Ativar o modo de planejamento",
  "chat.planMode.disable": "Desativar o modo de planejamento",
  "chat.planMode.description": "Usa o agente de planejamento: ele só pode ler e gravar arquivos de plano, nunca alterar o código. Desativar volta ao agente anterior.",
  "chat.planMode.unavailable": "O agente de planejamento não está disponível nesta sessão.",
