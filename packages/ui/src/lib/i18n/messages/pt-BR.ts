...
export const dict: Record<I18nKey, string> = {
  ...
  // Document preview
  "contextPanel.mode.doc": "Documento",
  "contextRail.surface.doc.description": "Pré-visualize documentos do Word, Excel, PowerPoint e PDF",
  ...
  "fleet.header.aria": "Status da frota: memória do host {mem}%, disco {disk}%, dispositivos {online}/{total}",
  "fleet.header.tooltip.title": "Status da frota",
  "fleet.header.tooltip.host": "Memória do host {mem}% · disco {disk}%",
  "fleet.header.tooltip.devices": "Dispositivos online {online}/{total}",
  "fleet.header.tooltip.stale": "Métricas do host têm {seconds}s",
  "fleet.header.tooltip.unavailable": "Métricas do host indisponíveis",
  "fleet.dialog.title": "Status da frota",
  "fleet.dialog.description": "Memória, disco e rede do host do workbench e de todos os dispositivos registrados.",
  "fleet.dialog.refresh": "Atualizar",
  "fleet.dialog.refreshing": "Atualizando…",
  "fleet.dialog.checkedAt": "Coletado há {seconds}s",
  "fleet.section.host": "Host (este workbench)",
  "fleet.section.devices": "Dispositivos registrados",
  "fleet.devices.empty": "Nenhum dispositivo registrado ainda.",
  "fleet.devices.expand": "Expandir {name}",
  "fleet.devices.collapse": "Recolher {name}",
  "fleet.devices.openSettings": "Abrir configurações de dispositivos",
  "fleet.devices.metricsUnavailable": "Métricas indisponíveis",
  "fleet.devices.offline": "O dispositivo está offline",
  "fleet.metric.memory": "Memória",
  "fleet.metric.disk": "Disco",
  "fleet.metric.network": "Rede",
  "fleet.metric.networkUnavailable": "Indisponível",
  "fleet.metric.load": "Carga",
  "fleet.metric.uptime": "Tempo ativo",
  "fleet.metric.containers": "Contêineres",
  "fleet.metric.swap": "Swap",
  "fleet.metric.rtt": "RTT {ms} ms",
  "fleet.status.online": "Online",
  "fleet.status.offline": "Offline",
  "fleet.error.load": "Status da frota HTTP {status}",
  "fleet.error.parse": "A resposta do status da frota não foi compreendida",
  "fleet.hostHelper.hint": "A coluna de rede precisa do auxiliar oc-host-metrics no servidor.",
  ...
  "chat.composerMode.label": "Modo",
  "chat.composerMode.build": "Trabalho",
  "chat.composerMode.plan": "Planejamento",
  "chat.composerMode.chat": "Conversa",
  "chat.composerMode.buildDescription": "Trabalha normalmente: lê, grava e executa o que a tarefa exigir.",
  "chat.composerMode.planDescription": "Planeja primeiro: apenas lê e grava arquivos de plano, sem alterar o código.",
  "chat.composerMode.chatDescription": "Somente conversa: não grava arquivos, não executa comandos, não entrega nada.",
  "chat.composerMode.unavailable": "O agente \"{mode}\" não está disponível.",
  "chat.promptEnhance.action": "Melhorar prompt",
  "chat.promptEnhance.busy": "Melhorando o prompt…",
  "chat.promptEnhance.applied": "Prompt melhorado ({model})",
  "chat.promptEnhance.undo": "Desfazer",
  "chat.promptEnhance.draftChanged": "O rascunho mudou, então a melhoria não foi aplicada",
  "chat.promptEnhance.failed": "Não foi possível melhorar o prompt",
  "chat.promptEnhance.errorTooLong": "O rascunho é maior do que este modelo aceita. Encurte e tente de novo.",
  "chat.promptEnhance.errorUnavailable": "O servidor não consegue acessar este modelo. Verifique as credenciais ou escolha um modelo pequeno em Configurações → Sessões.",
  "chat.promptEnhance.errorGeneric": "O modelo não devolveu um prompt utilizável. Tente de novo.",
  ...
  "chat.permissionCard.allowAlways": "Always allow",
  "chat.permissionCard.allowAlwaysWithPatterns": "Always allow: {patterns}",
  "chat.permissionCard.deny": "Deny",
  "settings.voice.page.field.sttApiKey": "API key",
  ...
  "agents.builtin.plan": "Plano",
  "agents.builtin.chat": "Chat",
  ...
  // Artifact Center
  'artifacts.page.title': 'Central de artefatos',
  'artifacts.list.searchPlaceholder': 'Buscar artefatos…',
  'artifacts.list.loading': 'Carregando…',
  'artifacts.list.retry': 'Tentar novamente',
  'artifacts.list.empty': 'Nenhum artefato ainda. Colete um arquivo na árvore para começar o controle de versão.',
  'artifacts.list.missing': 'Arquivo de origem ausente',
  'artifacts.detail.selectHint': 'Selecione um artefato para ver as versões.',
  'artifacts.detail.meta': '{size} · atualizado {when}',
  'artifacts.versions.title': 'Versões',
  'artifacts.versions.count': '{count} versões',
  'artifacts.versions.tierHot': 'Quente',
  'artifacts.versions.tierCold': 'Frio (Drive)',
  'artifacts.versions.tierRestoring': 'Recuperando',
  'artifacts.versions.labelPlaceholder': 'Rótulo da versão…',
  'artifacts.actions.preview': 'Visualizar',
  'artifacts.actions.restore': 'Restaurar',
  'artifacts.actions.pull': 'Trazer do Drive',
  'artifacts.actions.saveLabel': 'Salvar rótulo',
  'artifacts.actions.uncollect': 'Remover da central',
  'artifacts.actions.collect': 'Coletar como artefato',
  'artifacts.actions.openCenter': 'Abrir central de artefatos',
  'artifacts.actions.openCenterShort': 'Central',
  'artifacts.status.collectedVersions': '{count} versões',
  'artifacts.status.notCollected': 'Não coletado',
  'artifacts.status.collected': 'Coletado',
  'artifacts.candidates.title': 'Caixa de candidatos',
  'artifacts.candidates.count': '{count} candidatos',
  'artifacts.candidates.empty': 'Nenhum arquivo de entrega recente para coletar.',
  'artifacts.list.collectedTitle': 'Coletados',
  'artifacts.sidebar.badgeAria': '{count} artefatos',
  'sessions.sidebar.nav.artifacts': 'Central de artefatos',
  'artifacts.toast.collected': 'Coletado na central de artefatos',
  'artifacts.toast.alreadyCollected': 'Já está na central de artefatos',
  'artifacts.toast.labelSaved': 'Rótulo da versão salvo',
  'artifacts.toast.labelCleared': 'Rótulo da versão limpo',
  'artifacts.toast.restored': 'Arquivo de origem restaurado da versão',
  'artifacts.toast.pulled': 'Versão trazida para o armazenamento quente',
  'artifacts.toast.uncollected': 'Removido da central de artefatos',
  'artifacts.restore.dirtyConfirm': 'O arquivo de origem tem alterações não capturadas. Restaurar e sobrescrever mesmo assim?',
  'commandPalette.item.openArtifactCenter': 'Abrir central de artefatos',
  // Google Drive cold tier
  'settings.integrations.googleDrive.title': 'Google Drive',
  'settings.integrations.googleDrive.description': 'Camada fria para versões da central de artefatos. O servidor precisa de um cliente OAuth do Drive.',
  'settings.integrations.googleDrive.status.notConfigured': 'Não configurado neste servidor',
  'settings.integrations.googleDrive.status.connected': 'Conectado',
  'settings.integrations.googleDrive.status.notConnected': 'Não conectado',
  'settings.integrations.googleDrive.actions.connect': 'Conectar',
  'settings.integrations.googleDrive.actions.disconnect': 'Desconectar',
  'settings.integrations.googleDrive.actions.refresh': 'Atualizar',
  'settings.integrations.googleDrive.toast.authOpened': 'Conclua o login do Google na janela aberta',
  'settings.integrations.googleDrive.toast.disconnected': 'Google Drive desconectado',
  ...
  'header.workspaceEntry.label': 'Área da bancada',
  'header.workspaceEntry.hint': 'A barra lateral mostra somente as sessões desta área.',
  'header.workspaceEntry.code': 'Código',
  'header.workspaceEntry.work': 'Trabalho',
  ...
  // Document preview
  "documentPreview.actions.download": "Baixar original",
  ...
  "documentPreview.state.converting": "Convertendo documento…",
  // Document preview editing
  "documentPreview.actions.edit": "Editar",
  "documentPreview.actions.view": "Visualizar",
  "documentPreview.state.unsaved": "Alterações não salvas",
  "documentPreview.state.saved": "Salvo",
  "documentPreview.error.editUnsupported": "Este tipo de arquivo só pode ser pré-visualizado.",
  "documentPreview.error.notConfigured": "A pré-visualização de documentos não está configurada neste servidor.",
  "documentPreview.error.unavailable": "O serviço de conversão de documentos está indisponível. Você ainda pode baixar o original.",
  "documentPreview.error.failed": "Não foi possível abrir este documento.",
  "documentPreview.error.tooLarge": "Este arquivo é grande demais para pré-visualizar.",
  "documentPreview.error.unsupported": "Este tipo de arquivo não pode ser pré-visualizado.",
  "chat.fileLink.previewTitle": "Clique para pré-visualizar",
  "filesView.actions.openDocumentPreview": "Abrir pré-visualização de documentos",
  // Estatísticas de uso de tokens (cabeçalho)
  'tokenUsage.header.aria': 'Abrir estatísticas de uso de tokens',
  'tokenUsage.header.tooltip': 'Hoje: {tokens} tokens',
  'tokenUsage.period.today': 'Hoje',
  'tokenUsage.period.last7Days': 'Últimos 7 dias',
  'tokenUsage.period.last30Days': 'Últimos 30 dias',
  'tokenUsage.dialog.title': 'Uso de tokens',
  'tokenUsage.dialog.description': 'Consumo de tokens por período, modelo e acertos de cache.',
  'tokenUsage.dialog.byModel': 'Por modelo',
  'tokenUsage.dialog.empty': 'Sem uso de tokens neste período.',
  'tokenUsage.dialog.unknownModel': 'Modelo desconhecido',
  'tokenUsage.dialog.cacheHitValue': 'Acertos de cache {percent}%',
  'tokenUsage.dialog.refresh': 'Atualizar',
  'tokenUsage.dialog.refreshAria': 'Atualizar uso de tokens',
  'tokenUsage.dialog.loading': 'Coletando uso de tokens…',
  'tokenUsage.dialog.partial': 'Não foi possível ler {failed} de {scanned} sessões.',
  'tokenUsage.stats.input': 'Entrada',
  'tokenUsage.stats.output': 'Saída',
  'tokenUsage.stats.reasoning': 'Raciocínio',
  'tokenUsage.stats.cacheRead': 'Leitura de cache',
  'tokenUsage.stats.cacheWrite': 'Gravação de cache',
  'tokenUsage.stats.cacheHit': 'Acertos de cache',
  'tokenUsage.stats.messages': 'Turnos',
  // Live assistant status shown while a turn is running (the "{model} is {status}"
  // line, the scroll-to-bottom pill and the retry countdown).
  'assistantStatus.readingFile': 'reading file',
  'assistantStatus.writingFile': 'writing file',
  'assistantStatus.editingFile': 'editing file',
  'assistantStatus.editingFiles': 'editing files',
  'assistantStatus.applyingPatch': 'applying patch',
  'assistantStatus.runningCommand': 'running command',
  'assistantStatus.searchingContent': 'searching content',
  'assistantStatus.findingFiles': 'finding files',
  'assistantStatus.listingDirectory': 'listing directory',
  'assistantStatus.delegatingTask': 'delegating task',
  'assistantStatus.fetchingUrl': 'fetching URL',
  'assistantStatus.searchingWeb': 'searching web',
  'assistantStatus.webCodeSearch': 'web code search',
  'assistantStatus.updatingTodos': 'updating todos',
  'assistantStatus.readingTodos': 'reading todos',
  'assistantStatus.learningSkill': 'learning skill',
  'assistantStatus.askingQuestion': 'asking question',
  'assistantStatus.switchingToPlanning': 'switching to planning',
  'assistantStatus.switchingToBuilding': 'switching to building',
  'assistantStatus.usingTool': 'using {tool}',
  'assistantStatus.thinking': 'thinking',
  'assistantStatus.composing': 'composing',
  'assistantStatus.waitingForPermission': 'waiting for permission',
  'assistantStatus.working': 'working',
  'assistantStatus.processing': 'processing',
  'assistantStatus.preparing': 'preparing',
  'assistantStatus.warmingUp': 'warming up',
  'assistantStatus.gearsTurning': 'gears turning',
  'assistantStatus.computing': 'computing',
  'assistantStatus.calculating': 'calculating',
  'assistantStatus.analyzing': 'analyzing',
  'assistantStatus.wheelsSpinning': 'wheels spinning',
  'assistantStatus.calibrating': 'calibrating',
  'assistantStatus.synthesizing': 'synthesizing',
  'assistantStatus.connectingDots': 'connecting dots',
  'assistantStatus.inspectingLogic': 'inspecting logic',
  'assistantStatus.weighingOptions': 'weighing options',
  'assistantStatus.retrying': 'Retrying',
  'assistantStatus.retryIn': ' in {countdown}',
  'assistantStatus.retryAttempt': ' (attempt {attempt})',
  'chat.toolPart.multipleFiles': '{count} files',
  'chat.toolPart.askedQuestion': 'Asked {count} question',
  'chat.toolPart.askedQuestions': 'Asked {count} questions',
  // Tool names shown on every tool call in the chat transcript. The canonical
  // English lives in lib/toolHelpers.ts; these are the rendered labels.
  'toolDisplayName.read': 'Read File',
  'toolDisplayName.write': 'Write File',
  'toolDisplayName.edit': 'Edit File',
  'toolDisplayName.multiedit': 'Multi-Edit',
  'toolDisplayName.applyPatch': 'Apply Patch',
  'toolDisplayName.bash': 'Shell Command',
  'toolDisplayName.grep': 'Search Files',
  'toolDisplayName.glob': 'Find Files',
  'toolDisplayName.list': 'List Directory',
  'toolDisplayName.task': 'Agent Task',
  'toolDisplayName.webfetch': 'Fetch URL',
  'toolDisplayName.websearch': 'Web Search',
  'toolDisplayName.codesearch': 'Code Search',
  'toolDisplayName.todowrite': 'Update Todo List',
  'toolDisplayName.todoread': 'Read Todo List',
  'toolDisplayName.skill': 'Load Skill',
  'toolDisplayName.question': 'Question',
  'toolDisplayName.lsp': 'LSP',
  'toolDisplayName.openchamber': 'OpenChamber',
  'toolDisplayName.openchamberWeb': 'OpenChamber Web',
  'toolDisplayName.openchamberMemory': 'OpenChamber Memory',
  'toolDisplayName.planEnter': 'Plan Mode',
  'toolDisplayName.planExit': 'Build Mode',
  'toolDisplayName.structuredOutput': 'Structured Output',
  'toolDisplayName.openvikingSearch': 'Busca OpenViking',
  'toolDisplayName.openvikingFind': 'Localizar OpenViking',
  'toolDisplayName.openvikingRemember': 'Memorizar OpenViking',
  'toolDisplayName.openvikingRead': 'Ler OpenViking',
  'toolDisplayName.openvikingList': 'Listar OpenViking',
  'toolDisplayName.openvikingTree': 'Árvore OpenViking',
  'toolDisplayName.openvikingGrep': 'Grep OpenViking',
  'toolDisplayName.openvikingGlob': 'Glob OpenViking',
  'toolDisplayName.openvikingWrite': 'Escrever OpenViking',
  'toolDisplayName.openvikingEdit': 'Editar OpenViking',
  'toolDisplayName.openvikingAddResource': 'Adicionar recurso OpenViking',
  'toolDisplayName.openvikingForget': 'Esquecer OpenViking',
  'toolDisplayName.openvikingListWatches': 'Listar monitoramentos OpenViking',
  'toolDisplayName.openvikingCancelWatch': 'Cancelar monitoramento OpenViking',
  'toolDisplayName.openvikingHealth': 'Saúde OpenViking',
  'sessions.sidebar.session.fork.toast.forkedFrom': 'Derivada de {title}',
  'sessions.sidebar.session.fork.toast.failed': 'Não foi possível derivar a sessão',
  'header.sessions.untitled': 'Sessão sem título',
  'settings.menu.opencodeStatusFailed': 'Não foi possível ler o status do OpenCode',
  'tray.respondPermissionFailed': 'Não foi possível responder à solicitação de permissão',
  'session.newWorktree.toast.noActiveProject': 'Nenhum projeto ativo',
  'session.newWorktree.toast.notGitRepository': 'Este diretório não é um repositório Git',
  'chat.toolPart.subagent.waiting': 'Aguardando atividade do subagente…',
  'chat.toolPart.subagent.missingSessionId': 'Nenhum ID de sessão de subagente nos metadados da tarefa.',
  'chat.toolOutputDialog.labels.command': 'Comando:',
  'chat.toolOutputDialog.labels.task': 'Detalhes da tarefa:',
  'chat.toolOutputDialog.labels.input': 'Entrada:',
  'chat.toolOutputDialog.imagePreview': 'Pré-visualização da imagem',
  'settings.commands.sidebar.toast.commandRenamed': 'Comando "{name}" renomeado',
  'agentManager.view.toast.creatingGroup': 'Criando o grupo de agentes "{name}" com {count} execução(ões)...',
  'agentManager.view.toast.groupCreated': 'Grupo de agentes "{name}" criado com {count} sessão(ões)',
  'header.services.remoteUpdate.checkFailed': 'Não foi possível verificar atualizações da instância remota',
  'settings.remoteInstances.page.forward.localTarget': 'Destino local',
  'settings.remoteInstances.page.forward.localListen': 'Escuta local',
  'settings.remoteInstances.page.forward.remoteListen': 'Escuta remota',
  'settings.remoteInstances.page.forward.remoteTarget': 'Destino remoto',
  'settings.remoteInstances.page.forward.localTargetHint': 'Host e porta locais na sua máquina que recebem o tráfego do listener remoto -R.',
  'settings.remoteInstances.page.forward.localListenHint': 'Host e porta locais onde este reencaminhamento escuta na sua máquina.',
  'settings.remoteInstances.page.forward.remoteListenHint': 'Host e porta remotos onde o SSH cria o listener -R.',
  'settings.remoteInstances.page.forward.remoteTargetHint': 'Host e porta remotos que recebem o tráfego do listener local -L.',
  'chat.toolOutputDialog.taskFields.task': 'Tarefa:',
  'chat.toolOutputDialog.taskFields.agentType': 'Tipo de agente:',
  'chat.toolOutputDialog.taskFields.instructions': 'Instruções:',
  'gitView.toast.removeRemoteFailed': 'Falha ao remover o remoto {name}',
  'gitView.toast.upstreamSetFailed': 'Falha ao definir upstream',
  'gitView.toast.mergeFailed': 'Falha ao mesclar {branch}',
  'gitView.toast.rebaseFailed': 'Falha ao fazer rebase em {branch}',
  'contextSidebar.message.userLabel': 'Usuário:',
  'artifacts.toast.collectFailed': 'Falha ao coletar este arquivo como artefato',
  'guests.host.notGranted': 'O usuário não permitiu este recurso para a extensão.',
  'guests.host.extensionUnavailable': 'A extensão está indisponível.',
  'guests.host.extensionDisabled': 'Esta extensão está desativada em Configurações → Extensões.',
  'guests.host.requestFailed': 'A solicitação falhou.',
  'guests.host.noProject': 'Nenhum projeto está aberto.',
  'guests.host.operationFailed': 'A operação da extensão falhou.',
  'guests.service.noService': 'Nenhum serviço disponível para esta extensão.',
  'serverMessage.opencode.configReloaded': 'Configuração recarregada com sucesso. Atualizando a interface…',
  'serverMessage.opencode.manualRestart': 'Salvo no disco. Reinicie o servidor OpenCode conectado para aplicar as alterações.',
  'serverMessage.session.interruptedByRestart': 'Interrompido pelo reinício do OpenCode',
  'serverMessage.session.interruptedByRestartDetail': 'O turno em execução foi interrompido quando o OpenCode reiniciou.',
  'serverMessage.opencode.restartToApply': 'Salvo. Reinicie o OpenCode para aplicar.',
  'serverMessage.opencode.noSkillsInstalled': 'Nenhuma habilidade foi instalada',
  'serverMessage.git.statusFailed': 'Falha ao obter o status do Git',
  'serverMessage.git.diffFailed': 'Falha ao carregar o diff do Git',
  'serverMessage.git.pushFailed': 'Falha ao enviar (push)',
  'serverMessage.git.pullFailed': 'Falha ao puxar (pull)',
  'serverMessage.git.branchesFailed': 'Falha ao carregar os ramos',
  'serverMessage.git.remotesFailed': 'Falha ao carregar remotos',
  'serverMessage.git.mergeFailed': 'Falha ao mesclar',
  'serverMessage.git.removeRemoteFailed': 'Falha ao remover o remoto',
  'configUpdate.updatingOpenCode': 'Atualizando a configuração do OpenCode…',
  'configUpdate.creatingCommand': 'Criando a configuração do comando…',
  'configUpdate.updatingCommand': 'Atualizando a configuração do comando…',
  'configUpdate.deletingCommand': 'Excluindo a configuração do comando…',
  'configUpdate.creatingSkill': 'Criando a habilidade…',
  'configUpdate.updatingSkill': 'Atualizando a habilidade…',
  'configUpdate.renamingSkill': 'Renomeando a habilidade…',
  'configUpdate.deletingSkill': 'Excluindo a habilidade…',
  'configUpdate.installingSkills': 'Instalando habilidades…',
  'configUpdate.creatingMcp': 'Criando a configuração do servidor MCP…',
  'configUpdate.updatingMcp': 'Atualizando a configuração do servidor MCP…',
  'configUpdate.deletingMcp': 'Excluindo a configuração do servidor MCP…',
  'configUpdate.creatingAgent': 'Criando a configuração do agente…',
  'configUpdate.updatingAgent': 'Atualizando a configuração do agente…',
  'configUpdate.deletingAgent': 'Excluindo a configuração do agente…',
  'configUpdate.reloadingOpenCode': 'Recarregando a configuração do OpenCode…',
};
