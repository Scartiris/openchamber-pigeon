...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.composerMode.label': 'Tryb',
  'chat.composerMode.build': 'Praca',
  'chat.composerMode.plan': 'Plan',
  'chat.composerMode.chat': 'Rozmowa',
  'chat.composerMode.buildDescription': 'Pracuje normalnie: czyta, zapisuje i wykonuje to, czego wymaga zadanie.',
  'chat.composerMode.planDescription': 'Najpierw planuje: tylko czyta i zapisuje pliki planu, nie zmienia kodu.',
  'chat.composerMode.chatDescription': 'Tylko rozmowa: nie zapisuje plików, nie uruchamia poleceń, nic nie dostarcza.',
  'chat.composerMode.unavailable': 'Agent „{mode}” jest niedostępny.',
  'chat.promptEnhance.action': 'Ulepsz prompt',
  'chat.promptEnhance.busy': 'Ulepszanie promptu…',
  'chat.promptEnhance.applied': 'Prompt ulepszony ({model})',
  'chat.promptEnhance.undo': 'Cofnij',
  'chat.promptEnhance.draftChanged': 'Szkic się zmienił, ulepszenie nie zostało zastosowane',
  'chat.promptEnhance.failed': 'Nie udało się ulepszyć promptu',
  'chat.promptEnhance.errorTooLong': 'Szkic jest dłuższy, niż przyjmuje ten model. Skróć go i spróbuj ponownie.',
  'chat.promptEnhance.errorUnavailable': 'Serwer nie może wywołać tego modelu. Sprawdź jego dane logowania albo wybierz mały model w Ustawienia → Sesje.',
  'chat.promptEnhance.errorGeneric': 'Model nie zwrócił użytecznego promptu. Spróbuj ponownie.',
  ...
  // Artifact Center
  'artifacts.page.title': 'Centrum artefaktów',
  'artifacts.list.searchPlaceholder': 'Szukaj artefaktów…',
  'artifacts.list.loading': 'Ładowanie…',
  'artifacts.list.retry': 'Spróbuj ponownie',
  'artifacts.list.empty': 'Brak artefaktów. Zbierz plik z drzewa, aby zacząć zarządzanie wersjami.',
  'artifacts.list.missing': 'Brak pliku źródłowego',
  'artifacts.detail.selectHint': 'Wybierz artefakt, aby zobaczyć wersje.',
  'artifacts.detail.meta': '{size} · zaktualizowano {when}',
  'artifacts.versions.title': 'Wersje',
  'artifacts.versions.count': '{count} wersji',
  'artifacts.versions.tierHot': 'Gorąca',
  'artifacts.versions.tierCold': 'Zimna (Drive)',
  'artifacts.versions.tierRestoring': 'Przywracanie',
  'artifacts.versions.labelPlaceholder': 'Etykieta wersji…',
  'artifacts.actions.preview': 'Podgląd',
  'artifacts.actions.restore': 'Przywróć',
  'artifacts.actions.pull': 'Pobierz z Drive',
  'artifacts.actions.saveLabel': 'Zapisz etykietę',
  'artifacts.actions.uncollect': 'Usuń z centrum',
  'artifacts.actions.collect': 'Zbierz jako artefakt',
  'artifacts.actions.openCenter': 'Otwórz centrum artefaktów',
  'artifacts.actions.openCenterShort': 'Centrum',
  'artifacts.status.collectedVersions': '{count} wersji',
  'artifacts.status.notCollected': 'Nie zebrano',
  'artifacts.status.collected': 'Zebrano',
  'artifacts.candidates.title': 'Skrzynka kandydatów',
  'artifacts.candidates.count': '{count} kandydatów',
  'artifacts.candidates.empty': 'Brak ostatnich plików wynikowych do zebrania.',
  'artifacts.list.collectedTitle': 'Zebrane',
  'artifacts.sidebar.badgeAria': '{count} artefaktów',
  'sessions.sidebar.nav.artifacts': 'Centrum artefaktów',
  'artifacts.toast.collected': 'Dodano do centrum artefaktów',
  'artifacts.toast.alreadyCollected': 'Już jest w centrum artefaktów',
  'artifacts.toast.labelSaved': 'Zapisano etykietę wersji',
  'artifacts.toast.labelCleared': 'Wyczyszczono etykietę wersji',
  'artifacts.toast.restored': 'Przywrócono plik źródłowy z wersji',
  'artifacts.toast.pulled': 'Wersja pobrana do pamięci gorącej',
  'artifacts.toast.uncollected': 'Usunięto z centrum artefaktów',
  'artifacts.restore.dirtyConfirm': 'Plik źródłowy ma niezapisane zmiany. Przywrócić i nadpisać?',
  'commandPalette.item.openArtifactCenter': 'Otwórz centrum artefaktów',
  // Google Drive cold tier
  'settings.integrations.googleDrive.title': 'Google Drive',
  'settings.integrations.googleDrive.description': 'Zimna warstwa dla wersji centrum artefaktów. Serwer wymaga klienta OAuth Drive.',
  'settings.integrations.googleDrive.status.notConfigured': 'Nieskonfigurowane na tym serwerze',
  'settings.integrations.googleDrive.status.connected': 'Połączono',
  'settings.integrations.googleDrive.status.notConnected': 'Brak połączenia',
  'settings.integrations.googleDrive.actions.connect': 'Połącz',
  'settings.integrations.googleDrive.actions.disconnect': 'Rozłącz',
  'settings.integrations.googleDrive.actions.refresh': 'Odśwież',
  'settings.integrations.googleDrive.toast.authOpened': 'Dokończ logowanie Google w otwartym oknie',
  'settings.integrations.googleDrive.toast.disconnected': 'Rozłączono Google Drive',
  ...
  'contextRail.surface.doc.description': 'Podgląd dokumentów Word, Excel, PowerPoint i PDF',
  ...
  'fleet.header.aria': 'Stan floty: pamięć hosta {mem}%, dysk {disk}%, urządzenia {online}/{total}',
  'fleet.header.tooltip.title': 'Stan floty',
  'fleet.header.tooltip.host': 'Pamięć hosta {mem}% · dysk {disk}%',
  'fleet.header.tooltip.devices': 'Urządzenia online {online}/{total}',
  'fleet.header.tooltip.stale': 'Metryki hosta mają {seconds} s',
  'fleet.header.tooltip.unavailable': 'Metryki hosta są niedostępne',
  'fleet.dialog.title': 'Stan floty',
  'fleet.dialog.description': 'Pamięć, dysk i sieć hosta workbencha oraz wszystkich zarejestrowanych urządzeń.',
  'fleet.dialog.refresh': 'Odśwież',
  'fleet.dialog.refreshing': 'Odświeżanie…',
  'fleet.dialog.checkedAt': 'Zebrano {seconds} s temu',
  ...
  'fleet.metric.memory': 'Pamięć',
  'fleet.metric.disk': 'Dysk',
  'fleet.metric.network': 'Sieć',
  'fleet.metric.networkUnavailable': 'Niedostępne',
  'fleet.metric.load': 'Obciążenie',
  'fleet.metric.uptime': 'Czas działania',
  'fleet.metric.containers': 'Kontenery',
  'fleet.metric.swap': 'Swap',
  'fleet.metric.rtt': 'RTT {ms} ms',
  'fleet.status.online': 'Online',
  'fleet.status.offline': 'Offline',
  'fleet.error.load': 'Stan floty HTTP {status}',
  'fleet.error.parse': 'Nie zrozumiano odpowiedzi stanu floty',
  'fleet.hostHelper.hint': 'Kolumna sieci wymaga pomocnika oc-host-metrics na serwerze.',
  ...
  'header.workspaceEntry.label': 'Obszar pulpitu',
  'header.workspaceEntry.hint': 'Pasek boczny wyświetla tylko sesje z tego obszaru.',
  'header.workspaceEntry.code': 'Kod',
  'header.workspaceEntry.work': 'Praca',
  ...
  // Document preview
  'documentPreview.actions.download': 'Pobierz oryginał',
  ...
  'documentPreview.error.tooLarge': 'Ten plik jest zbyt duży, aby wyświetlić podgląd.',
  'documentPreview.error.unsupported': 'Nie można wyświetlić podglądu tego typu pliku.',
  'chat.fileLink.previewTitle': 'Kliknij, aby wyświetlić podgląd',
  'filesView.actions.openDocumentPreview': 'Otwórz podgląd dokumentu',

  // Statystyki zużycia tokenów (nagłówek)
  'tokenUsage.header.aria': 'Otwórz statystyki zużycia tokenów',
  'tokenUsage.header.tooltip': 'Dziś: {tokens} tokenów',
  'tokenUsage.period.today': 'Dziś',
  'tokenUsage.period.last7Days': 'Ostatnie 7 dni',
  'tokenUsage.period.last30Days': 'Ostatnie 30 dni',
  'tokenUsage.dialog.title': 'Zużycie tokenów',
  'tokenUsage.dialog.description': 'Zużycie tokenów wg okresu, modelu i trafień cache.',
  'tokenUsage.dialog.byModel': 'Wg modelu',
  'tokenUsage.dialog.empty': 'Brak zużycia tokenów w tym okresie.',
  'tokenUsage.dialog.unknownModel': 'Nieznany model',
  'tokenUsage.dialog.cacheHitValue': 'Trafienia cache {percent}%',
  'tokenUsage.dialog.refresh': 'Odśwież',
  'tokenUsage.dialog.refreshAria': 'Odśwież zużycie tokenów',
  'tokenUsage.dialog.loading': 'Zbieranie zużycia tokenów…',
  'tokenUsage.dialog.partial': 'Nie udało się odczytać {failed} z {scanned} sesji.',
  'tokenUsage.stats.input': 'Wejście',
  'tokenUsage.stats.output': 'Wyjście',
  'tokenUsage.stats.reasoning': 'Rozumowanie',
  ...
  'toolDisplayName.openvikingSearch': 'Wyszukiwanie OpenViking',
  'toolDisplayName.openvikingFind': 'OpenViking Find',
  'toolDisplayName.openvikingRemember': 'Zapamiętaj OpenViking',
  'toolDisplayName.openvikingRead': 'Odczyt OpenViking',
  'toolDisplayName.openvikingList': 'Lista OpenViking',
  'toolDisplayName.openvikingTree': 'Drzewo OpenViking',
  'toolDisplayName.openvikingGrep': 'Grep OpenViking',
  'toolDisplayName.openvikingGlob': 'Glob OpenViking',
  'toolDisplayName.openvikingWrite': 'Zapis OpenViking',
  'toolDisplayName.openvikingEdit': 'Edycja OpenViking',
  'toolDisplayName.openvikingAddResource': 'Dodaj zasób OpenViking',
  'toolDisplayName.openvikingForget': 'Zapomnij OpenViking',
  'toolDisplayName.openvikingListWatches': 'Lista obserwacji OpenViking',
  'toolDisplayName.openvikingCancelWatch': 'Anuluj obserwację OpenViking',
  'toolDisplayName.openvikingHealth': 'Stan OpenViking',
  'sessions.sidebar.session.fork.toast.forkedFrom': 'Odgałęziono z {title}',
  'sessions.sidebar.session.fork.toast.failed': 'Nie udało się odgałęzić sesji',
  'header.sessions.untitled': 'Sesja bez tytułu',
  'settings.menu.opencodeStatusFailed': 'Nie udało się odczytać statusu OpenCode',
  'tray.respondPermissionFailed': 'Nie udało się odpowiedzieć na żądanie uprawnień',
  'session.newWorktree.toast.noActiveProject': 'Brak aktywnego projektu',
  'session.newWorktree.toast.notGitRepository': 'Ten katalog nie jest repozytorium Git',
  'chat.toolPart.subagent.waiting': 'Oczekiwanie na aktywność subagenta…',
  'chat.toolPart.subagent.missingSessionId': 'Brak identyfikatora sesji subagenta w metadanych zadania.',
  'chat.toolOutputDialog.labels.command': 'Polecenie:',
  'chat.toolOutputDialog.labels.task': 'Szczegóły zadania:',
  'chat.toolOutputDialog.labels.input': 'Wejście:',
  'chat.toolOutputDialog.imagePreview': 'Podgląd obrazu',
  'settings.commands.sidebar.toast.commandRenamed': 'Polecenie „{name}” zmieniło nazwę',
  'agentManager.view.toast.creatingGroup': 'Tworzenie grupy agentów „{name}” z {count} uruchomieniami...',
  'agentManager.view.toast.groupCreated': 'Grupa agentów „{name}” utworzona z {count} sesją/sesjami',
  'header.services.remoteUpdate.checkFailed': 'Nie udało się sprawdzić aktualizacji instancji zdalnej',
  'settings.remoteInstances.page.forward.localTarget': 'Cel lokalny',
  'settings.remoteInstances.page.forward.localListen': 'Nasłuch lokalny',
  'settings.remoteInstances.page.forward.remoteListen': 'Nasłuch zdalny',
  'settings.remoteInstances.page.forward.remoteTarget': 'Cel zdalny',
  'settings.remoteInstances.page.forward.localTargetHint': 'Lokalny host i port na Twojej maszynie, które odbierają ruch z zdalnego listenera -R.',
  'settings.remoteInstances.page.forward.localListenHint': 'Lokalny host i port, na których ta reguła nasłuchuje na Twojej maszynie.',
  'settings.remoteInstances.page.forward.remoteListenHint': 'Zdalny host i port, na których SSH tworzy listener -R.',
  'settings.remoteInstances.page.forward.remoteTargetHint': 'Zdalny host i port, które odbierają ruch z lokalnego listenera -L.',
  'chat.toolOutputDialog.taskFields.task': 'Zadanie:',
  'chat.toolOutputDialog.taskFields.agentType': 'Typ agenta:',
  'chat.toolOutputDialog.taskFields.instructions': 'Instrukcje:',
  'gitView.toast.removeRemoteFailed': 'Nie udało się usunąć zdalnego {name}',
  'gitView.toast.upstreamSetFailed': 'Nie udało się ustawić upstream',
  'gitView.toast.mergeFailed': 'Scalanie {branch} nie powiodło się',
  'gitView.toast.rebaseFailed': 'Rebase na {branch} nie powiódł się',
  'contextSidebar.message.userLabel': 'Użytkownik:',
  'artifacts.toast.collectFailed': 'Nie udało się zebrać tego pliku jako artefaktu',
  'guests.host.notGranted': 'Użytkownik nie zezwolił na tę funkcję dla rozszerzenia.',
  'guests.host.extensionUnavailable': 'Rozszerzenie jest niedostępne.',
  'guests.host.extensionDisabled': 'To rozszerzenie jest wyłączone w Ustawienia → Rozszerzenia.',
  'guests.host.requestFailed': 'Żądanie nie powiodło się.',
  'guests.host.noProject': 'Brak otwartego projektu.',
  'guests.host.operationFailed': 'Operacja rozszerzenia nie powiodła się.',
  'guests.service.noService': 'Brak dostępnego serwisu dla tego rozszerzenia.',
  'serverMessage.opencode.configReloaded': 'Konfiguracja ponownie załadowana. Odświeżanie interfejsu…',
  'serverMessage.opencode.manualRestart': 'Zapisano na dysku. Uruchom ponownie podłączony serwer OpenCode, aby zastosować zmiany.',
  'serverMessage.session.interruptedByRestart': 'Przerwane przez ponowne uruchomienie OpenCode',
  'serverMessage.session.interruptedByRestartDetail': 'Trwająca tura została przerwana przy ponownym uruchomieniu OpenCode.',
  'serverMessage.opencode.restartToApply': 'Zapisano. Uruchom ponownie OpenCode, aby zastosować.',
  'serverMessage.opencode.noSkillsInstalled': 'Nie zainstalowano żadnych umiejętności',
  'serverMessage.git.statusFailed': 'Nie udało się pobrać statusu Git',
  'serverMessage.git.diffFailed': 'Nie udało się wczytać różnic Git',
  'serverMessage.git.pushFailed': 'Push nie powiódł się',
  'serverMessage.git.pullFailed': 'Pull nie powiódł się',
  'serverMessage.git.branchesFailed': 'Nie udało się wczytać gałęzi',
  'serverMessage.git.remotesFailed': 'Nie udało się wczytać zdalnych',
  'serverMessage.git.mergeFailed': 'Scalanie nie powiodło się',
  'serverMessage.git.removeRemoteFailed': 'Nie udało się usunąć zdalnego',
  'configUpdate.updatingOpenCode': 'Aktualizowanie konfiguracji OpenCode…',
  'configUpdate.creatingCommand': 'Tworzenie konfiguracji polecenia…',
  'configUpdate.updatingCommand': 'Aktualizowanie konfiguracji polecenia…',
  'configUpdate.deletingCommand': 'Usuwanie konfiguracji polecenia…',
  'configUpdate.creatingSkill': 'Tworzenie umiejętności…',
  'configUpdate.updatingSkill': 'Aktualizowanie umiejętności…',
  'configUpdate.renamingSkill': 'Zmiana nazwy umiejętności…',
  'configUpdate.deletingSkill': 'Usuwanie umiejętności…',
  'configUpdate.installingSkills': 'Instalowanie umiejętności…',
  'configUpdate.creatingMcp': 'Tworzenie konfiguracji serwera MCP…',
  'configUpdate.updatingMcp': 'Aktualizowanie konfiguracji serwera MCP…',
  'configUpdate.deletingMcp': 'Usuwanie konfiguracji serwera MCP…',
  'configUpdate.creatingAgent': 'Tworzenie konfiguracji agenta…',
  'configUpdate.updatingAgent': 'Aktualizowanie konfiguracji agenta…',
  'configUpdate.deletingAgent': 'Usuwanie konfiguracji agenta…',
  'configUpdate.reloadingOpenCode': 'Ponowne ładowanie konfiguracji OpenCode…',
} as const;
