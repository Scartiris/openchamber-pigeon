...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.planMode.label': 'Tryb planowania',
  'chat.planMode.enable': 'Włącz tryb planowania',
  'chat.planMode.disable': 'Wyłącz tryb planowania',
  'chat.planMode.description': 'Używa agenta planowania: może tylko czytać i zapisywać pliki planu, nigdy nie zmienia kodu. Wyłączenie wraca do poprzedniego agenta.',
  'chat.planMode.unavailable': 'Agent planowania nie jest dostępny w tej sesji.',
