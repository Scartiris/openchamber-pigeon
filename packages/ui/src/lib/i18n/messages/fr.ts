...
export const dict = {
  ...
  'chat.planMode.label': 'Mode plan',
  'chat.planMode.enable': 'Activer le mode plan',
  'chat.planMode.disable': 'Désactiver le mode plan',
  'chat.planMode.description': 'Utilise l\'agent de plan : il peut seulement lire et écrire des fichiers de plan, jamais votre code. Le désactiver revient à l\'agent précédent.',
  'chat.planMode.unavailable': 'L\'agent de plan n\'est pas disponible pour cette session.',
