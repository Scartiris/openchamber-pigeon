...
export const dict = {
  ...
  'contextRail.surface.doc.description': 'Prévisualiser les documents Word, Excel, PowerPoint et PDF',
  ...
  'fleet.header.aria': 'État de la flotte : mémoire hôte {mem} %, disque {disk} %, appareils {online}/{total}',
  'fleet.header.tooltip.title': 'État de la flotte',
  'fleet.header.tooltip.host': 'Mémoire hôte {mem} % · disque {disk} %',
  'fleet.header.tooltip.devices': 'Appareils en ligne {online}/{total}',
  'fleet.header.tooltip.stale': 'Mesures hôte vieilles de {seconds} s',
  'fleet.header.tooltip.unavailable': 'Mesures hôte indisponibles',
  'fleet.dialog.title': 'État de la flotte',
  'fleet.dialog.description': 'Mémoire, disque et réseau de l\'hôte du workbench et de tous les appareils enregistrés.',
  'fleet.dialog.refresh': 'Actualiser',
  'fleet.dialog.refreshing': 'Actualisation…',
  'fleet.dialog.checkedAt': 'Relevé il y a {seconds} s',
  ...
  'fleet.metric.memory': 'Mémoire',
  'fleet.metric.disk': 'Disque',
  'fleet.metric.network': 'Réseau',
  'fleet.metric.networkUnavailable': 'Indisponible',
  'fleet.metric.load': 'Charge',
  'fleet.metric.uptime': 'Durée de fonctionnement',
  'fleet.metric.containers': 'Conteneurs',
  'fleet.metric.swap': 'Swap',
  'fleet.metric.rtt': 'RTT {ms} ms',
  'fleet.status.online': 'En ligne',
  'fleet.status.offline': 'Hors ligne',
  'fleet.error.load': 'État de la flotte HTTP {status}',
  'fleet.error.parse': 'Réponse de l\'état de la flotte illisible',
  'fleet.hostHelper.hint': 'La colonne réseau nécessite l\'outil oc-host-metrics sur le serveur.',
  ...
  'chat.composerMode.label': 'Mode',
  'chat.composerMode.build': 'Travail',
  'chat.composerMode.plan': 'Plan',
  'chat.composerMode.chat': 'Discussion',
  'chat.composerMode.buildDescription': 'Travaille normalement : lit, écrit et exécute ce que la tâche demande.',
  'chat.composerMode.planDescription': 'Planifie d\'abord : lit et n\'écrit que des fichiers de plan, sans modifier le code.',
  'chat.composerMode.chatDescription': 'Discussion seule : aucun fichier écrit, aucune commande exécutée, rien de livré.',
  'chat.composerMode.unavailable': 'L\'agent « {mode} » n\'est pas disponible.',
  'chat.promptEnhance.action': 'Améliorer le prompt',
  'chat.promptEnhance.busy': 'Amélioration du prompt…',
  'chat.promptEnhance.applied': 'Prompt amélioré ({model})',
  'chat.promptEnhance.undo': 'Annuler',
  'chat.promptEnhance.draftChanged': 'Le brouillon a changé, l\'amélioration n\'a pas été appliquée',
  'chat.promptEnhance.failed': 'Impossible d\'améliorer le prompt',
  'chat.promptEnhance.errorTooLong': 'Le brouillon dépasse ce que ce modèle peut recevoir. Raccourcissez-le et réessayez.',
  'chat.promptEnhance.errorUnavailable': 'Le serveur ne peut pas joindre ce modèle. Vérifiez ses identifiants ou choisissez un petit modèle dans Paramètres → Sessions.',
  'chat.promptEnhance.errorGeneric': 'Le modèle n\'a renvoyé aucun prompt utilisable. Réessayez.',
  ...
  // Artifact Center
  'artifacts.page.title': 'Centre d’artefacts',
  'artifacts.list.searchPlaceholder': 'Rechercher des artefacts…',
  'artifacts.list.loading': 'Chargement…',
  'artifacts.list.retry': 'Réessayer',
  'artifacts.list.empty': 'Aucun artefact pour l’instant. Collectez un fichier depuis l’arborescence pour le versionner.',
  'artifacts.list.missing': 'Fichier source manquant',
  'artifacts.detail.selectHint': 'Sélectionnez un artefact pour voir ses versions.',
  'artifacts.detail.meta': '{size} · mis à jour {when}',
  'artifacts.versions.title': 'Versions',
  'artifacts.versions.count': '{count} versions',
  'artifacts.versions.tierHot': 'Chaud',
  'artifacts.versions.tierCold': 'Froid (Drive)',
  'artifacts.versions.tierRestoring': 'Récupération',
  'artifacts.versions.labelPlaceholder': 'Libellé de version…',
  'artifacts.actions.preview': 'Aperçu',
  'artifacts.actions.restore': 'Restaurer',
  'artifacts.actions.pull': 'Récupérer depuis Drive',
  'artifacts.actions.saveLabel': 'Enregistrer le libellé',
  'artifacts.actions.uncollect': 'Retirer du centre',
  'artifacts.actions.collect': 'Collecter comme artefact',
  'artifacts.actions.openCenter': 'Ouvrir le centre d’artefacts',
  'artifacts.actions.openCenterShort': 'Centre',
  'artifacts.status.collectedVersions': '{count} versions',
  'artifacts.status.notCollected': 'Non collecté',
  'artifacts.status.collected': 'Collecté',
  'artifacts.candidates.title': 'Boîte des candidats',
  'artifacts.candidates.count': '{count} candidats',
  'artifacts.candidates.empty': 'Aucun fichier livrable récent à collecter.',
  'artifacts.list.collectedTitle': 'Collectés',
  'artifacts.sidebar.badgeAria': '{count} artefacts',
  'sessions.sidebar.nav.artifacts': 'Centre d’artefacts',
  'artifacts.toast.collected': 'Ajouté au centre d’artefacts',
  'artifacts.toast.alreadyCollected': 'Déjà dans le centre d’artefacts',
  'artifacts.toast.labelSaved': 'Libellé de version enregistré',
  'artifacts.toast.labelCleared': 'Libellé de version effacé',
  'artifacts.toast.restored': 'Fichier source restauré depuis la version',
  'artifacts.toast.pulled': 'Version ramenée en stockage chaud',
  'artifacts.toast.uncollected': 'Retiré du centre d’artefacts',
  'artifacts.restore.dirtyConfirm': 'Le fichier source a des modifications non capturées. Restaurer et écraser quand même ?',
  'commandPalette.item.openArtifactCenter': 'Ouvrir le centre d’artefacts',
  // Google Drive cold tier
  'settings.integrations.googleDrive.title': 'Google Drive',
  'settings.integrations.googleDrive.description': 'Couche froide pour les versions du centre d’artefacts. Le serveur requiert un client OAuth Drive.',
  'settings.integrations.googleDrive.status.notConfigured': 'Non configuré sur ce serveur',
  'settings.integrations.googleDrive.status.connected': 'Connecté',
  'settings.integrations.googleDrive.status.notConnected': 'Non connecté',
  'settings.integrations.googleDrive.actions.connect': 'Connecter',
  'settings.integrations.googleDrive.actions.disconnect': 'Déconnecter',
  'settings.integrations.googleDrive.actions.refresh': 'Actualiser',
  'settings.integrations.googleDrive.toast.authOpened': 'Terminez la connexion Google dans la fenêtre ouverte',
  'settings.integrations.googleDrive.toast.disconnected': 'Google Drive déconnecté',
  ...
  'header.workspaceEntry.label': 'Espace de l\'atelier',
  'header.workspaceEntry.hint': 'La barre latérale n\'affiche que les sessions de cet espace.',
  'header.workspaceEntry.code': 'Code',
  'header.workspaceEntry.work': 'Travail',
  ...
  // Document preview
  'documentPreview.actions.download': 'Télécharger l’original',
  ...
  'documentPreview.error.tooLarge': 'Ce fichier est trop volumineux pour être prévisualisé.',
  'documentPreview.error.unsupported': 'Ce type de fichier ne peut pas être prévisualisé.',
  'chat.fileLink.previewTitle': 'Cliquez pour prévisualiser',
  'filesView.actions.openDocumentPreview': 'Ouvrir l’aperçu du document',

  // Statistiques d'utilisation des tokens (en-tête)
  'tokenUsage.header.aria': 'Ouvrir les statistiques d’utilisation des tokens',
  'tokenUsage.header.tooltip': 'Aujourd’hui : {tokens} tokens',
  'tokenUsage.period.today': 'Aujourd’hui',
  'tokenUsage.period.last7Days': '7 derniers jours',
  'tokenUsage.period.last30Days': '30 derniers jours',
  'tokenUsage.dialog.title': 'Utilisation des tokens',
  'tokenUsage.dialog.description': 'Consommation de tokens par période, modèle et hits de cache.',
  'tokenUsage.dialog.byModel': 'Par modèle',
  'tokenUsage.dialog.empty': 'Aucune utilisation de tokens sur cette période.',
  'tokenUsage.dialog.unknownModel': 'Modèle inconnu',
  'tokenUsage.dialog.cacheHitValue': 'Hits de cache {percent}%',
  'tokenUsage.dialog.refresh': 'Actualiser',
  'tokenUsage.dialog.refreshAria': 'Actualiser l’utilisation des tokens',
  'tokenUsage.dialog.loading': 'Collecte de l’utilisation des tokens…',
  'tokenUsage.dialog.partial': '{failed} session(s) sur {scanned} n’ont pas pu être lues.',
  'tokenUsage.stats.input': 'Entrée',
  'tokenUsage.stats.output': 'Sortie',
  'tokenUsage.stats.reasoning': 'Raisonnement',
  ...
  'toolDisplayName.openvikingSearch': 'Recherche OpenViking',
  'toolDisplayName.openvikingFind': 'OpenViking Find',
  'toolDisplayName.openvikingRemember': 'Mémoriser OpenViking',
  'toolDisplayName.openvikingRead': 'Lire OpenViking',
  'toolDisplayName.openvikingList': 'Lister OpenViking',
  'toolDisplayName.openvikingTree': 'Arbre OpenViking',
  'toolDisplayName.openvikingGrep': 'Grep OpenViking',
  'toolDisplayName.openvikingGlob': 'Glob OpenViking',
  'toolDisplayName.openvikingWrite': 'Écrire OpenViking',
  'toolDisplayName.openvikingEdit': 'Modifier OpenViking',
  'toolDisplayName.openvikingAddResource': 'Ajouter une ressource OpenViking',
  'toolDisplayName.openvikingForget': 'Oublier OpenViking',
  'toolDisplayName.openvikingListWatches': 'Lister les surveillances OpenViking',
  'toolDisplayName.openvikingCancelWatch': 'Annuler la surveillance OpenViking',
  'toolDisplayName.openvikingHealth': 'État OpenViking',
  'sessions.sidebar.session.fork.toast.forkedFrom': 'Dérivée de {title}',
  'sessions.sidebar.session.fork.toast.failed': 'Impossible de dériver la session',
  'header.sessions.untitled': 'Session sans titre',
  'settings.menu.opencodeStatusFailed': 'Impossible de lire l’état OpenCode',
  'tray.respondPermissionFailed': 'Impossible de répondre à la demande d’autorisation',
  'session.newWorktree.toast.noActiveProject': 'Aucun projet actif',
  'session.newWorktree.toast.notGitRepository': 'Ce dossier n’est pas un dépôt Git',
  'chat.toolPart.subagent.waiting': 'En attente d’activité du sous-agent…',
  'chat.toolPart.subagent.missingSessionId': 'Aucun identifiant de session de sous-agent dans les métadonnées de la tâche.',
  'chat.toolOutputDialog.labels.command': 'Commande :',
  'chat.toolOutputDialog.labels.task': 'Détails de la tâche :',
  'chat.toolOutputDialog.labels.input': 'Entrée :',
  'chat.toolOutputDialog.imagePreview': 'Aperçu de l’image',
  'settings.commands.sidebar.toast.commandRenamed': 'Commande « {name} » renommée',
  'agentManager.view.toast.creatingGroup': 'Création du groupe d’agents « {name} » avec {count} exécution(s)…',
  'agentManager.view.toast.groupCreated': 'Groupe d’agents « {name} » créé avec {count} session(s)',
  'header.services.remoteUpdate.checkFailed': 'Impossible de vérifier les mises à jour de l’instance distante',
  'settings.remoteInstances.page.forward.localTarget': 'Cible locale',
  'settings.remoteInstances.page.forward.localListen': 'Écoute locale',
  'settings.remoteInstances.page.forward.remoteListen': 'Écoute distante',
  'settings.remoteInstances.page.forward.remoteTarget': 'Cible distante',
  'settings.remoteInstances.page.forward.localTargetHint': 'Hôte et port locaux sur votre machine qui reçoivent le trafic de l’écouteur distant -R.',
  'settings.remoteInstances.page.forward.localListenHint': 'Hôte et port locaux où cette redirection écoute sur votre machine.',
  'settings.remoteInstances.page.forward.remoteListenHint': 'Hôte et port distants où SSH crée l’écouteur -R.',
  'settings.remoteInstances.page.forward.remoteTargetHint': 'Hôte et port distants qui reçoivent le trafic de l’écouteur local -L.',
  'chat.toolOutputDialog.taskFields.task': 'Tâche :',
  'chat.toolOutputDialog.taskFields.agentType': 'Type d’agent :',
  'chat.toolOutputDialog.taskFields.instructions': 'Instructions :',
  'gitView.toast.removeRemoteFailed': 'Échec de la suppression du dépôt distant {name}',
  'gitView.toast.upstreamSetFailed': 'Échec de la définition de l’amont',
  'gitView.toast.mergeFailed': 'Échec de la fusion de {branch}',
  'gitView.toast.rebaseFailed': 'Échec du rebase sur {branch}',
  'contextSidebar.message.userLabel': 'Utilisateur :',
  'artifacts.toast.collectFailed': 'Impossible de collecter ce fichier en artefact',
  'guests.host.notGranted': 'L’utilisateur n’a pas autorisé cette capacité pour l’extension.',
  'guests.host.extensionUnavailable': 'L’extension n’est pas disponible.',
  'guests.host.extensionDisabled': 'Cette extension est désactivée dans Paramètres → Extensions.',
  'guests.host.requestFailed': 'La requête a échoué.',
  'guests.host.noProject': 'Aucun projet n’est ouvert.',
  'guests.host.operationFailed': 'L’opération de l’extension a échoué.',
  'guests.service.noService': 'Aucun service n’est disponible pour cette extension.',
  'serverMessage.opencode.configReloaded': 'Configuration rechargée avec succès. Actualisation de l’interface…',
  'serverMessage.opencode.manualRestart': 'Enregistré sur le disque. Redémarrez le serveur OpenCode connecté pour appliquer les modifications.',
  'serverMessage.session.interruptedByRestart': 'Interrompu par le redémarrage d’OpenCode',
  'serverMessage.session.interruptedByRestartDetail': 'Le tour en cours a été interrompu lors du redémarrage d’OpenCode.',
  'serverMessage.opencode.restartToApply': 'Enregistré. Redémarrez OpenCode pour appliquer.',
  'serverMessage.opencode.noSkillsInstalled': 'Aucune compétence n’a été installée',
  'serverMessage.git.statusFailed': 'Impossible d’obtenir l’état Git',
  'serverMessage.git.diffFailed': 'Impossible de charger le diff Git',
  'serverMessage.git.pushFailed': 'Échec du push',
  'serverMessage.git.pullFailed': 'Échec du pull',
  'serverMessage.git.branchesFailed': 'Impossible de charger les branches',
  'serverMessage.git.remotesFailed': 'Impossible de charger les dépôts distants',
  'serverMessage.git.mergeFailed': 'Échec de la fusion',
  'serverMessage.git.removeRemoteFailed': 'Échec de la suppression du dépôt distant',
  'configUpdate.updatingOpenCode': 'Mise à jour de la configuration OpenCode…',
  'configUpdate.creatingCommand': 'Création de la configuration de commande…',
  'configUpdate.updatingCommand': 'Mise à jour de la configuration de commande…',
  'configUpdate.deletingCommand': 'Suppression de la configuration de commande…',
  'configUpdate.creatingSkill': 'Création de la compétence…',
  'configUpdate.updatingSkill': 'Mise à jour de la compétence…',
  'configUpdate.renamingSkill': 'Renommage de la compétence…',
  'configUpdate.deletingSkill': 'Suppression de la compétence…',
  'configUpdate.installingSkills': 'Installation des compétences…',
  'configUpdate.creatingMcp': 'Création de la configuration du serveur MCP…',
  'configUpdate.updatingMcp': 'Mise à jour de la configuration du serveur MCP…',
  'configUpdate.deletingMcp': 'Suppression de la configuration du serveur MCP…',
  'configUpdate.creatingAgent': 'Création de la configuration de l’agent…',
  'configUpdate.updatingAgent': 'Mise à jour de la configuration de l’agent…',
  'configUpdate.deletingAgent': 'Suppression de la configuration de l’agent…',
  'configUpdate.reloadingOpenCode': 'Rechargement de la configuration OpenCode…',
} as const;
