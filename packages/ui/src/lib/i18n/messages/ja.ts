...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.planMode.label': 'プランモード',
  'chat.planMode.enable': 'プランモードをオンにする',
  'chat.planMode.disable': 'プランモードをオフにする',
  'chat.planMode.description': 'プランエージェントを使用します。読み取りとプランファイルの書き込みのみで、コードは変更しません。オフにすると前のエージェントに戻ります。',
  'chat.planMode.unavailable': 'このセッションで利用できるプランエージェントがありません。',
