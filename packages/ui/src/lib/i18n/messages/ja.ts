...
export const dict: Record<I18nKey, string> = {
  ...
  // Document preview
  'contextPanel.mode.doc': 'ドキュメント',
  'contextRail.surface.doc.description': 'Word、Excel、PowerPoint、PDF ドキュメントをプレビュー',
  ...
  'fleet.header.aria': 'フリート状態：ホストのメモリ {mem}%、ディスク {disk}%、デバイス {online}/{total}',
  'fleet.header.tooltip.title': 'フリート状態',
  'fleet.header.tooltip.host': 'ホストのメモリ {mem}% · ディスク {disk}%',
  'fleet.header.tooltip.devices': 'オンラインのデバイス {online}/{total}',
  'fleet.header.tooltip.stale': 'ホスト指標は {seconds} 秒前です',
  'fleet.header.tooltip.unavailable': 'ホスト指標を取得できません',
  'fleet.dialog.title': 'フリート状態',
  'fleet.dialog.description': 'ワークベンチのホストと登録済みデバイスのメモリ・ディスク・ネットワーク。',
  'fleet.dialog.refresh': '更新',
  'fleet.dialog.refreshing': '更新中…',
  'fleet.dialog.checkedAt': '{seconds} 秒前に取得',
  ...
  'fleet.metric.memory': 'メモリ',
  'fleet.metric.disk': 'ディスク',
  'fleet.metric.network': 'ネットワーク',
  'fleet.metric.networkUnavailable': '利用不可',
  'fleet.metric.load': '負荷',
  'fleet.metric.uptime': '稼働時間',
  'fleet.metric.containers': 'コンテナ',
  'fleet.metric.swap': 'スワップ',
  'fleet.metric.rtt': 'RTT {ms} ms',
  'fleet.status.online': 'オンライン',
  'fleet.status.offline': 'オフライン',
  'fleet.error.load': 'フリート状態 HTTP {status}',
  'fleet.error.parse': 'フリート状態の応答を解釈できません',
  'fleet.hostHelper.hint': 'ネットワーク列にはサーバー側の oc-host-metrics が必要です。',
  ...
  'chat.composerMode.label': 'モード',
  'chat.composerMode.build': '作業',
  'chat.composerMode.plan': '計画',
  'chat.composerMode.chat': 'チャット',
  'chat.composerMode.buildDescription': '通常どおり作業します：ファイルの読み書きとコマンド実行を行い、成果物を納品します。',
  'chat.composerMode.planDescription': 'まず計画：ファイルの読み取りと計画ファイルの書き込みのみで、コードは変更しません。',
  'chat.composerMode.chatDescription': 'チャットのみ：ファイル書き込みもコマンド実行もなく、成果物もありません。',
  'chat.composerMode.unavailable': '「{mode}」エージェントは利用できません。',
  'chat.promptEnhance.action': 'プロンプトを最適化',
  'chat.promptEnhance.busy': 'プロンプトを最適化中…',
  'chat.promptEnhance.applied': 'プロンプトを最適化しました（{model}）',
  'chat.promptEnhance.undo': '元に戻す',
  'chat.promptEnhance.draftChanged': '下書きが変更されたため、最適化結果は反映していません',
  'chat.promptEnhance.failed': 'プロンプトを最適化できませんでした',
  'chat.promptEnhance.errorTooLong': '下書きがこのモデルの受け入れ上限を超えています。短くして再試行してください。',
  'chat.promptEnhance.errorUnavailable': 'サーバーからこのモデルを呼び出せません。認証情報を確認するか、「設定 → セッション → 小型モデル」で別のモデルを選んでください。',
  'chat.promptEnhance.errorGeneric': 'モデルが使用できるプロンプトを返しませんでした。もう一度お試しください。',
  ...
  // Artifact Center
  'artifacts.page.title': '成果物センター',
  'artifacts.list.searchPlaceholder': '成果物を検索…',
  'artifacts.list.loading': '読み込み中…',
  'artifacts.list.retry': '再試行',
  'artifacts.list.empty': 'まだ成果物がありません。ファイルツリーから収集するとバージョン管理を始められます。',
  'artifacts.list.missing': '元ファイルが見つかりません',
  'artifacts.detail.selectHint': '成果物を選んでバージョンを表示します。',
  'artifacts.detail.meta': '{size} · 更新 {when}',
  'artifacts.versions.title': 'バージョン',
  'artifacts.versions.count': '{count} 件',
  'artifacts.versions.tierHot': 'ホット',
  'artifacts.versions.tierCold': 'コールド（Drive）',
  'artifacts.versions.tierRestoring': '復元中',
  'artifacts.versions.labelPlaceholder': 'バージョンラベル…',
  'artifacts.actions.preview': 'プレビュー',
  'artifacts.actions.restore': '復元',
  'artifacts.actions.pull': 'Drive から取得',
  'artifacts.actions.saveLabel': 'ラベルを保存',
  'artifacts.actions.uncollect': 'センターから削除',
  'artifacts.actions.collect': '成果物として収集',
  'artifacts.actions.openCenter': '成果物センターを開く',
  'artifacts.actions.openCenterShort': 'センター',
  'artifacts.status.collectedVersions': '{count} 件のバージョン',
  'artifacts.status.notCollected': '未収集',
  'artifacts.status.collected': '収集済み',
  'artifacts.candidates.title': '候補インボックス',
  'artifacts.candidates.count': '候補 {count} 件',
  'artifacts.candidates.empty': '最近の収集対象ファイルはありません。',
  'artifacts.list.collectedTitle': '収集済み',
  'artifacts.sidebar.badgeAria': '成果物 {count} 件',
  'sessions.sidebar.nav.artifacts': '成果物センター',
  'artifacts.toast.collected': '成果物センターに追加しました',
  'artifacts.toast.alreadyCollected': 'すでに成果物センターにあります',
  'artifacts.toast.labelSaved': 'バージョンラベルを保存しました',
  'artifacts.toast.labelCleared': 'バージョンラベルをクリアしました',
  'artifacts.toast.restored': 'このバージョンから元ファイルを復元しました',
  'artifacts.toast.pulled': 'バージョンをホットストレージに戻しました',
  'artifacts.toast.uncollected': '成果物センターから削除しました',
  'artifacts.restore.dirtyConfirm': '元ファイルに未スナップショットの変更があります。上書きして復元しますか？',
  'commandPalette.item.openArtifactCenter': '成果物センターを開く',
  // Google Drive cold tier
  'settings.integrations.googleDrive.title': 'Google Drive',
  'settings.integrations.googleDrive.description': '成果物センターのバージョン用コールド層。サーバーに Drive OAuth クライアントが必要です。',
  'settings.integrations.googleDrive.status.notConfigured': 'このサーバーでは未設定',
  'settings.integrations.googleDrive.status.connected': '接続済み',
  'settings.integrations.googleDrive.status.notConnected': '未接続',
  'settings.integrations.googleDrive.actions.connect': '接続',
  'settings.integrations.googleDrive.actions.disconnect': '切断',
  'settings.integrations.googleDrive.actions.refresh': '更新',
  'settings.integrations.googleDrive.toast.authOpened': '開いたウィンドウで Google ログインを完了してください',
  'settings.integrations.googleDrive.toast.disconnected': 'Google Drive を切断しました',
  ...
  'header.workspaceEntry.label': 'ワークベンチのエリア',
  'header.workspaceEntry.hint': 'サイドバーにはこのエリアのセッションのみ表示します。',
  'header.workspaceEntry.code': 'コード',
  'header.workspaceEntry.work': '仕事',
  ...
  // Document preview
  'documentPreview.actions.download': '元のファイルをダウンロード',
  ...
  'documentPreview.error.tooLarge': 'このファイルは大きすぎてプレビューできません。',
  'documentPreview.error.unsupported': 'このファイル形式はプレビューできません。',
  'chat.fileLink.previewTitle': 'クリックしてプレビュー',
  'filesView.actions.openDocumentPreview': 'ドキュメントプレビューを開く',
  // トークン使用量統計（ヘッダー）
  'tokenUsage.header.aria': 'トークン使用量の統計を開く',
  'tokenUsage.header.tooltip': '今日：{tokens} トークン',
  'tokenUsage.period.today': '今日',
  'tokenUsage.period.last7Days': '過去 7 日',
  'tokenUsage.period.last30Days': '過去 30 日',
  'tokenUsage.dialog.title': 'トークン使用量',
  'tokenUsage.dialog.description': '期間・モデル・キャッシュヒット別のトークン消費。',
  'tokenUsage.dialog.byModel': 'モデル別',
  'tokenUsage.dialog.empty': 'この期間のトークン使用はありません。',
  'tokenUsage.dialog.unknownModel': '不明なモデル',
  'tokenUsage.dialog.cacheHitValue': 'キャッシュヒット {percent}%',
  'tokenUsage.dialog.refresh': '更新',
  'tokenUsage.dialog.refreshAria': 'トークン使用量を更新',
  'tokenUsage.dialog.loading': 'トークン使用量を収集中…',
  'tokenUsage.dialog.partial': '{scanned} セッションのうち {failed} 件を読み取れませんでした。',
  'tokenUsage.stats.input': '入力',
  'tokenUsage.stats.output': '出力',
  'tokenUsage.stats.reasoning': '推論',
  ...
  'toolDisplayName.openvikingSearch': 'OpenViking 検索',
  'toolDisplayName.openvikingFind': 'OpenViking 検索（高速）',
  'toolDisplayName.openvikingRemember': 'OpenViking 記憶する',
  'toolDisplayName.openvikingRead': 'OpenViking 読み取り',
  'toolDisplayName.openvikingList': 'OpenViking 一覧',
  'toolDisplayName.openvikingTree': 'OpenViking ツリー',
  'toolDisplayName.openvikingGrep': 'OpenViking 文字列検索',
  'toolDisplayName.openvikingGlob': 'OpenViking パターン検索',
  'toolDisplayName.openvikingWrite': 'OpenViking 書き込み',
  'toolDisplayName.openvikingEdit': 'OpenViking 編集',
  'toolDisplayName.openvikingAddResource': 'OpenViking リソース追加',
  'toolDisplayName.openvikingForget': 'OpenViking 忘却',
  'toolDisplayName.openvikingListWatches': 'OpenViking 監視一覧',
  'toolDisplayName.openvikingCancelWatch': 'OpenViking 監視をキャンセル',
  'toolDisplayName.openvikingHealth': 'OpenViking ヘルスチェック',
  'sessions.sidebar.session.fork.toast.forkedFrom': '{title} から分岐しました',
  'sessions.sidebar.session.fork.toast.failed': 'セッションを分岐できませんでした',
  'header.sessions.untitled': '無題のセッション',
  'settings.menu.opencodeStatusFailed': 'OpenCode の状態を読み取れませんでした',
  'tray.respondPermissionFailed': '権限リクエストに応答できませんでした',
  'session.newWorktree.toast.noActiveProject': 'アクティブなプロジェクトがありません',
  'session.newWorktree.toast.notGitRepository': 'このディレクトリは Git リポジトリではありません',
  'chat.toolPart.subagent.waiting': 'サブエージェントの活動を待機中…',
  'chat.toolPart.subagent.missingSessionId': 'タスクメタデータにサブエージェントのセッション ID がありません.',
  'chat.toolOutputDialog.labels.command': 'コマンド：',
  'chat.toolOutputDialog.labels.task': 'タスク詳細：',
  'chat.toolOutputDialog.labels.input': '入力：',
  'chat.toolOutputDialog.imagePreview': '画像プレビュー',
  'settings.commands.sidebar.toast.commandRenamed': 'コマンド「{name}」の名前を変更しました',
  'agentManager.view.toast.creatingGroup': 'エージェントグループ「{name}」を作成中（{count} 回の実行）…',
  'agentManager.view.toast.groupCreated': 'エージェントグループ「{name}」を作成しました（{count} セッション）',
  'header.services.remoteUpdate.checkFailed': 'リモートインスタンスの更新を確認できませんでした',
  'settings.remoteInstances.page.forward.localTarget': 'ローカルターゲット',
  'settings.remoteInstances.page.forward.localListen': 'ローカルリッスン',
  'settings.remoteInstances.page.forward.remoteListen': 'リモートリッスン',
  'settings.remoteInstances.page.forward.remoteTarget': 'リモートターゲット',
  'settings.remoteInstances.page.forward.localTargetHint': 'リモート -R リスナーからのトラフィックを受け取る、ローカルのホストとポート。',
  'settings.remoteInstances.page.forward.localListenHint': 'この転送がローカルで待ち受けるホストとポート。',
  'settings.remoteInstances.page.forward.remoteListenHint': 'SSH が -R リスナーを作成するリモートのホストとポート。',
  'settings.remoteInstances.page.forward.remoteTargetHint': 'ローカル -L リスナーからのトラフィックを受け取るリモートのホストとポート。',
  'chat.toolOutputDialog.taskFields.task': 'タスク：',
  'chat.toolOutputDialog.taskFields.agentType': 'エージェント種別：',
  'chat.toolOutputDialog.taskFields.instructions': '指示：',
  'gitView.toast.removeRemoteFailed': 'リモート {name} の削除に失敗しました',
  'gitView.toast.upstreamSetFailed': 'アップストリームの設定に失敗しました',
  'gitView.toast.mergeFailed': '{branch} のマージに失敗しました',
  'gitView.toast.rebaseFailed': '{branch} へのリベースに失敗しました',
  'contextSidebar.message.userLabel': 'ユーザー：',
  'artifacts.toast.collectFailed': 'このファイルを成果物として収集できませんでした',
  'guests.host.notGranted': 'ユーザーはこの拡張機能にその機能を許可していません.',
  'guests.host.extensionUnavailable': '拡張機能を利用できません。',
  'guests.host.extensionDisabled': 'この拡張機能は「設定 → 拡張」で無効化されています。',
  'guests.host.requestFailed': 'リクエストに失敗しました.',
  'guests.host.noProject': '開いているプロジェクトがありません.',
  'guests.host.operationFailed': '拡張機能の操作に失敗しました.',
  'guests.service.noService': 'この拡張機能で利用可能なサービスがありません.',
  'serverMessage.opencode.configReloaded': '設定を再読み込みしました。画面を更新しています…',
  'serverMessage.opencode.manualRestart': 'ディスクに保存しました。接続中の OpenCode サーバーを再起動して変更を適用してください.',
  'serverMessage.session.interruptedByRestart': 'OpenCode の再起動により中断されました',
  'serverMessage.session.interruptedByRestartDetail': '実行中のターンは OpenCode の再起動時に中断されました.',
  'serverMessage.opencode.restartToApply': '保存しました。適用するには OpenCode を再起動してください.',
  'serverMessage.opencode.noSkillsInstalled': 'スキルはインストールされませんでした',
  'serverMessage.git.statusFailed': 'Git 状態を取得できませんでした',
  'serverMessage.git.diffFailed': 'Git 差分を読み込めませんでした',
  'serverMessage.git.pushFailed': 'push に失敗しました',
  'serverMessage.git.pullFailed': 'pull に失敗しました',
  'serverMessage.git.branchesFailed': 'ブランチを読み込めませんでした',
  'serverMessage.git.remotesFailed': 'リモートを読み込めませんでした',
  'serverMessage.git.mergeFailed': 'マージに失敗しました',
  'serverMessage.git.removeRemoteFailed': 'リモートの削除に失敗しました',
  'configUpdate.updatingOpenCode': 'OpenCode 設定を更新しています…',
  'configUpdate.creatingCommand': 'コマンド設定を作成しています…',
  'configUpdate.updatingCommand': 'コマンド設定を更新しています…',
  'configUpdate.deletingCommand': 'コマンド設定を削除しています…',
  'configUpdate.creatingSkill': 'スキルを作成しています…',
  'configUpdate.updatingSkill': 'スキルを更新しています…',
  'configUpdate.renamingSkill': 'スキル名を変更しています…',
  'configUpdate.deletingSkill': 'スキルを削除しています…',
  'configUpdate.installingSkills': 'スキルをインストールしています…',
  'configUpdate.creatingMcp': 'MCP サーバー設定を作成しています…',
  'configUpdate.updatingMcp': 'MCP サーバー設定を更新しています…',
  'configUpdate.deletingMcp': 'MCP サーバー設定を削除しています…',
  'configUpdate.creatingAgent': 'エージェント設定を作成しています…',
  'configUpdate.updatingAgent': 'エージェント設定を更新しています…',
  'configUpdate.deletingAgent': 'エージェント設定を削除しています…',
  'configUpdate.reloadingOpenCode': 'OpenCode 設定を再読み込みしています…',
};
