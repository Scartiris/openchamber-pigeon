...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.planMode.label': '计划模式',
  'chat.planMode.enable': '开启计划模式',
  'chat.planMode.disable': '关闭计划模式',
  'chat.planMode.description': '使用「计划」智能体：只能读取文件、写计划文件，不改代码。关闭后回到上一个智能体。',
  'chat.planMode.unavailable': '当前会话没有可用的「计划」智能体。',
