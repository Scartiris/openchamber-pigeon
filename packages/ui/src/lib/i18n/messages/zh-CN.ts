...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.history.actions.revert': '还原',
  ...
  // Document preview
  'contextPanel.mode.doc': '文档',
  'contextRail.surface.doc.description': '预览 Word、Excel、PowerPoint 与 PDF 文档',
  ...
  'diffView.reviewDialog.description': '为当前更改启动一个独立的审查会话。',
  'diffView.reviewDialog.generateHandoff': '生成交接',
  ...
  'fleet.header.aria': '机队状态：宿主内存 {mem}%、磁盘 {disk}%、设备 {online}/{total}',
  'fleet.header.tooltip.title': '机队状态',
  'fleet.header.tooltip.host': '宿主内存 {mem}% · 磁盘 {disk}%',
  'fleet.header.tooltip.devices': '设备在线 {online}/{total}',
  'fleet.header.tooltip.stale': '宿主指标已过期 {seconds} 秒',
  'fleet.header.tooltip.unavailable': '宿主指标不可用',
  'fleet.dialog.title': '机队状态',
  'fleet.dialog.description': '工作台宿主与所有已注册设备的内存、磁盘与网络。',
  'fleet.dialog.refresh': '刷新',
  'fleet.dialog.refreshing': '刷新中…',
  'fleet.dialog.checkedAt': '{seconds} 秒前采集',
  ...
  'fleet.metric.memory': '内存',
  'fleet.metric.disk': '磁盘',
  'fleet.metric.network': '网络',
  'fleet.metric.networkUnavailable': '不可用',
  'fleet.metric.load': '负载',
  'fleet.metric.uptime': '运行时长',
  'fleet.metric.containers': '容器',
  'fleet.metric.swap': '交换分区',
  'fleet.metric.rtt': '往返延迟 {ms} ms',
  'fleet.status.online': '在线',
  'fleet.status.offline': '离线',
  'fleet.error.load': '机队状态 HTTP {status}',
  'fleet.error.parse': '机队状态响应无法解析',
  'fleet.hostHelper.hint': '网络一列需要服务器上的 oc-host-metrics 采集器。',
  ...
  'chat.emptyState.draftTitle': '我们要做点什么？',
  'chat.emptyState.draftTitleWithProject': '在 {project} 里做点什么？',
  'chat.draftPresets.explore.label': '探索代码库',
  'chat.draftPresets.catchup.label': '帮我跟上进度',
  'chat.draftPresets.weigh.label': '权衡我的选择',
  ...
  'chat.draftStarters.add': '添加引导语',
  'chat.draftStarters.searchPlaceholder': '搜索命令和技能…',
  'chat.draftStarters.empty': '没有可添加项',
  ...
  'chat.queuedMessage.title': '已排队的消息',
  ...
  'chat.composerMode.label': '对话模式',
  'chat.composerMode.build': '施工',
  'chat.composerMode.plan': '计划',
  'chat.composerMode.chat': '聊天',
  'chat.composerMode.buildDescription': '正常施工：读写文件、执行命令，按任务交付产物。',
  'chat.composerMode.planDescription': '先出方案：只读文件、只写计划文件，不改代码。',
  'chat.composerMode.chatDescription': '纯聊天：不写文件、不执行命令、不交付产物。',
  'chat.composerMode.unavailable': '「{mode}」智能体当前不可用。',
  'chat.promptEnhance.action': '优化提示词',
  'chat.promptEnhance.busy': '正在优化提示词…',
  'chat.promptEnhance.applied': '提示词已优化（{model}）',
  'chat.promptEnhance.undo': '撤销',
  'chat.promptEnhance.draftChanged': '草稿已改动，优化结果未替换',
  'chat.promptEnhance.failed': '提示词优化失败',
  'chat.promptEnhance.errorTooLong': '内容比这个模型能接收的还长，请缩短后重试。',
  'chat.promptEnhance.errorUnavailable': '服务器无法调用这个模型。检查它的凭据，或在「设置 → 会话 → 小模型」里另选一个。',
  'chat.promptEnhance.errorGeneric': '模型没有返回可用的提示词，请重试。',
  ...
  'chat.permissionCard.allowOnce': '仅允许一次',
  'chat.permissionCard.allowAlways': '始终允许',
  'chat.permissionCard.allowAlwaysWithPatterns': '始终允许：{patterns}',
  'chat.permissionCard.deny': '拒绝',
  'common.optional': '可选',
  'settings.voice.page.field.apiKey': 'API 密钥',
  'settings.voice.page.field.sttApiKey': 'API 密钥',
  ...
  // Artifact Center
  'artifacts.page.title': '产物中心',
  'artifacts.list.searchPlaceholder': '搜索产物…',
  'artifacts.list.loading': '加载中…',
  'artifacts.list.retry': '重试',
  'artifacts.list.empty': '还没有收集产物。在文件树里把文件「收集为产物」即可开始版本管理。',
  'artifacts.list.missing': '源文件已丢失',
  'artifacts.detail.selectHint': '选择一个产物查看版本。',
  'artifacts.detail.meta': '{size} · 更新于 {when}',
  'artifacts.versions.title': '版本',
  'artifacts.versions.count': '{count} 个版本',
  'artifacts.versions.tierHot': '热存',
  'artifacts.versions.tierCold': '冷存（Drive）',
  'artifacts.versions.tierRestoring': '拉取中',
  'artifacts.versions.labelPlaceholder': '版本备注…',
  'artifacts.actions.preview': '预览',
  'artifacts.actions.restore': '回滚',
  'artifacts.actions.pull': '从 Drive 拉回',
  'artifacts.actions.saveLabel': '保存备注',
  'artifacts.actions.uncollect': '移出中心',
  'artifacts.actions.collect': '收集为产物',
  'artifacts.actions.openCenter': '打开产物中心',
  'artifacts.actions.openCenterShort': '中心',
  'artifacts.status.collectedVersions': '{count} 个版本',
  'artifacts.status.notCollected': '未收集',
  'artifacts.status.collected': '已在产物中心',
  'artifacts.candidates.title': '候选收件',
  'artifacts.candidates.count': '{count} 个候选',
  'artifacts.candidates.empty': '最近没有可收集的交付文件。',
  'artifacts.list.collectedTitle': '已收集',
  'artifacts.sidebar.badgeAria': '{count} 个产物',
  'sessions.sidebar.nav.artifacts': '产物中心',
  'artifacts.toast.collected': '已收入产物中心',
  'artifacts.toast.alreadyCollected': '该文件已在产物中心',
  'artifacts.toast.labelSaved': '版本备注已保存',
  'artifacts.toast.labelCleared': '版本备注已清除',
  'artifacts.toast.restored': '已用该版本回滚源文件',
  'artifacts.toast.pulled': '版本已拉回热存',
  'artifacts.toast.uncollected': '已移出产物中心',
  'artifacts.restore.dirtyConfirm': '源文件有尚未快照的改动。仍要回滚并覆盖它们吗？',
  'commandPalette.item.openArtifactCenter': '打开产物中心',
  // Google Drive cold tier
  'settings.integrations.googleDrive.title': 'Google Drive',
  'settings.integrations.googleDrive.description': '产物中心版本的冷存储。服务器需配置 Drive OAuth 客户端。',
  'settings.integrations.googleDrive.status.notConfigured': '本服务器未配置',
  'settings.integrations.googleDrive.status.connected': '已连接',
  'settings.integrations.googleDrive.status.notConnected': '未连接',
  'settings.integrations.googleDrive.actions.connect': '连接',
  'settings.integrations.googleDrive.actions.disconnect': '断开',
  'settings.integrations.googleDrive.actions.refresh': '刷新',
  'settings.integrations.googleDrive.toast.authOpened': '请在打开的窗口完成 Google 登录',
  'settings.integrations.googleDrive.toast.disconnected': '已断开 Google Drive',
  ...
  'contextFileOpen.failure.missing': '未找到文件',
  ...
  'header.workspaceEntry.hint': '侧栏只列出这一区的会话。',
  'header.workspaceEntry.code': '代码',
  ...
  // Document preview
  'documentPreview.actions.download': '下载原件',
  ...
  'documentPreview.state.converting': '正在转换文档…',
  ...
  'documentPreview.error.unavailable': '文档转换服务不可用，可下载原件。',
  'documentPreview.error.failed': '无法打开该文档。',
  'documentPreview.error.tooLarge': '文件过大，无法预览。',
  'documentPreview.error.unsupported': '该文件类型暂不支持预览。',
  'chat.fileLink.previewTitle': '点击预览',
  'filesView.actions.openDocumentPreview': '打开文档预览',
  // Token 消耗统计（顶栏）
  'tokenUsage.header.aria': '打开 Token 消耗统计',
  ...
  'tokenUsage.dialog.description': '按周期、模型与缓存命中查看 Token 消耗。',
  'tokenUsage.dialog.byModel': '按模型',
  'tokenUsage.dialog.empty': '该时段暂无 Token 消耗。',
  'tokenUsage.dialog.unknownModel': '未知模型',
  'tokenUsage.dialog.cacheHitValue': '缓存命中 {percent}%',
  'tokenUsage.dialog.refresh': '刷新',
  'tokenUsage.dialog.refreshAria': '刷新 Token 消耗',
  'tokenUsage.dialog.loading': '正在统计 Token 消耗…',
  'tokenUsage.dialog.partial': '{scanned} 个会话中有 {failed} 个无法读取。',
  'tokenUsage.stats.input': '输入',
  'tokenUsage.stats.output': '输出',
  ...
  // 运行中的实时状态（顶栏「{model} · {status}」、回到底部胶囊、重试倒计时）
  'assistantStatus.readingFile': '正在读取文件',
  'assistantStatus.writingFile': '正在写入文件',
  'assistantStatus.editingFile': '正在编辑文件',
  'assistantStatus.editingFiles': '正在编辑多个文件',
  'assistantStatus.applyingPatch': '正在应用补丁',
  'assistantStatus.runningCommand': '正在执行命令',
  'assistantStatus.searchingContent': '正在搜索内容',
  'assistantStatus.findingFiles': '正在查找文件',
  'assistantStatus.listingDirectory': '正在列出目录',
  'assistantStatus.delegatingTask': '正在派发子任务',
  'assistantStatus.fetchingUrl': '正在抓取网址',
  'assistantStatus.searchingWeb': '正在搜索网络',
  'assistantStatus.webCodeSearch': '正在搜索网络代码',
  'assistantStatus.updatingTodos': '正在更新待办',
  'assistantStatus.readingTodos': '正在读取待办',
  'assistantStatus.learningSkill': '正在学习技能',
  'assistantStatus.askingQuestion': '正在提问',
  'assistantStatus.switchingToPlanning': '正在切换到规划模式',
  'assistantStatus.switchingToBuilding': '正在切换到构建模式',
  'assistantStatus.usingTool': '正在使用{tool}',
  'assistantStatus.thinking': '正在思考',
  'assistantStatus.composing': '正在组织回复',
  'assistantStatus.waitingForPermission': '等待授权',
  'assistantStatus.working': '正在工作',
  'assistantStatus.processing': '正在处理',
  'assistantStatus.preparing': '正在准备',
  'assistantStatus.warmingUp': '正在预热',
  'assistantStatus.gearsTurning': '正在转动齿轮',
  'assistantStatus.computing': '正在计算',
  'assistantStatus.calculating': '正在推算',
  'assistantStatus.analyzing': '正在分析',
  'assistantStatus.wheelsSpinning': '正在飞速运转',
  'assistantStatus.calibrating': '正在校准',
  'assistantStatus.synthesizing': '正在综合',
  'assistantStatus.connectingDots': '正在串联线索',
  'assistantStatus.inspectingLogic': '正在检查逻辑',
  'assistantStatus.weighingOptions': '正在权衡方案',
  'assistantStatus.retrying': '正在重试',
  'assistantStatus.retryIn': '，{countdown} 后',
  'assistantStatus.retryAttempt': '（第 {attempt} 次尝试）',
  'chat.toolPart.multipleFiles': '{count} 个文件',
  'chat.toolPart.askedQuestion': '提问了 {count} 个问题',
  'chat.toolPart.askedQuestions': '提问了 {count} 个问题',
  // 工具调用在对话里显示的名称（英文原名见 lib/toolHelpers.ts）
  'toolDisplayName.read': '读取文件',
  'toolDisplayName.write': '写入文件',
  'toolDisplayName.edit': '编辑文件',
  'toolDisplayName.multiedit': '批量编辑',
  'toolDisplayName.applyPatch': '应用补丁',
  'toolDisplayName.bash': '执行命令',
  'toolDisplayName.grep': '搜索文件内容',
  'toolDisplayName.glob': '查找文件',
  'toolDisplayName.list': '列出目录',
  'toolDisplayName.task': '子代理任务',
  'toolDisplayName.webfetch': '抓取网页',
  'toolDisplayName.websearch': '网络搜索',
  'toolDisplayName.codesearch': '代码搜索',
  'toolDisplayName.todowrite': '更新待办列表',
  'toolDisplayName.todoread': '读取待办列表',
  'toolDisplayName.skill': '加载技能',
  'toolDisplayName.question': '提问',
  'toolDisplayName.lsp': 'LSP',
  'toolDisplayName.openchamber': 'OpenChamber',
  'toolDisplayName.openchamberWeb': 'OpenChamber Web',
  'toolDisplayName.openchamberMemory': 'OpenChamber 记忆库',
  'toolDisplayName.planEnter': '规划模式',
  'toolDisplayName.planExit': '构建模式',
  'toolDisplayName.structuredOutput': '结构化输出',
  'toolDisplayName.openvikingSearch': 'OpenViking 语义检索',
  'toolDisplayName.openvikingFind': 'OpenViking 快速查找',
  'toolDisplayName.openvikingRemember': 'OpenViking 记忆写入',
  'toolDisplayName.openvikingRead': 'OpenViking 读取',
  'toolDisplayName.openvikingList': 'OpenViking 列出目录',
  'toolDisplayName.openvikingTree': 'OpenViking 目录树',
  'toolDisplayName.openvikingGrep': 'OpenViking 精确搜索',
  'toolDisplayName.openvikingGlob': 'OpenViking 模式匹配',
  'toolDisplayName.openvikingWrite': 'OpenViking 写入',
  'toolDisplayName.openvikingEdit': 'OpenViking 编辑',
  'toolDisplayName.openvikingAddResource': 'OpenViking 添加资源',
  'toolDisplayName.openvikingForget': 'OpenViking 遗忘删除',
  'toolDisplayName.openvikingListWatches': 'OpenViking 查看监视任务',
  'toolDisplayName.openvikingCancelWatch': 'OpenViking 取消监视',
  'toolDisplayName.openvikingHealth': 'OpenViking 健康检查',
  'sessions.sidebar.session.fork.toast.forkedFrom': '已从 {title} 派生',
  'sessions.sidebar.session.fork.toast.failed': '无法派生会话',
  'header.sessions.untitled': '未命名会话',
  'settings.menu.opencodeStatusFailed': '无法获取 OpenCode 状态',
  'tray.respondPermissionFailed': '无法响应权限请求',
  'session.newWorktree.toast.noActiveProject': '没有活动项目',
  'session.newWorktree.toast.notGitRepository': '当前目录不是 Git 仓库',
  ...
  'chat.toolOutputDialog.labels.task': '任务详情：',
  'chat.toolOutputDialog.labels.input': '输入：',
  'chat.toolOutputDialog.imagePreview': '图片预览',
  'settings.commands.sidebar.toast.commandRenamed': '命令「{name}」已重命名',
  'agentManager.view.toast.creatingGroup': '正在创建智能体组「{name}」，共 {count} 个运行…',
  'agentManager.view.toast.groupCreated': '智能体组「{name}」已创建，共 {count} 个会话',
  'header.services.remoteUpdate.checkFailed': '无法检查远程实例更新',
  'settings.remoteInstances.page.forward.localTarget': '本地目标',
  'settings.remoteInstances.page.forward.localListen': '本地监听',
  'settings.remoteInstances.page.forward.remoteListen': '远程监听',
  'settings.remoteInstances.page.forward.remoteTarget': '远程目标',
  'settings.remoteInstances.page.forward.localTargetHint': '本机上接收远程 -R 监听流量的主机与端口。',
  'settings.remoteInstances.page.forward.localListenHint': '本机上此转发开始监听的主机与端口。',
  'settings.remoteInstances.page.forward.remoteListenHint': 'SSH 创建 -R 监听的远程主机与端口。',
  'settings.remoteInstances.page.forward.remoteTargetHint': '接收本机 -L 监听流量的远程主机与端口。',
  'chat.toolOutputDialog.taskFields.task': '任务：',
  'chat.toolOutputDialog.taskFields.agentType': '智能体类型：',
  'chat.toolOutputDialog.taskFields.instructions': '指令：',
  'gitView.toast.removeRemoteFailed': '移除远程 {name} 失败',
  'gitView.toast.upstreamSetFailed': '设置上游失败',
  'gitView.toast.mergeFailed': '合并 {branch} 失败',
  'gitView.toast.rebaseFailed': '变基到 {branch} 失败',
  'contextSidebar.message.userLabel': '用户：',
  'artifacts.toast.collectFailed': '无法将此文件收集为制品',
  'guests.host.notGranted': '用户尚未允许该扩展使用此能力。',
  'guests.host.extensionUnavailable': '扩展不可用。',
  'guests.host.extensionDisabled': '该扩展已在「设置 → 扩展」中禁用。',
  'guests.host.requestFailed': '请求失败。',
  'guests.host.noProject': '当前没有打开的项目。',
  'guests.host.operationFailed': '扩展操作失败。',
  'guests.service.noService': '该扩展没有可用的本地服务。',
  'serverMessage.opencode.configReloaded': '配置重新加载成功。正在刷新界面…',
  'serverMessage.opencode.manualRestart': '已保存到磁盘。请重启已连接的 OpenCode 服务器以应用更改。',
  'serverMessage.session.interruptedByRestart': '因 OpenCode 重启而中断',
  'serverMessage.session.interruptedByRestartDetail': '当前回合在 OpenCode 重启时被中断。',
  'serverMessage.opencode.restartToApply': '已保存。请重启 OpenCode 以应用。',
  'serverMessage.opencode.noSkillsInstalled': '没有安装任何技能',
  'serverMessage.git.statusFailed': '无法获取 Git 状态',
  'serverMessage.git.diffFailed': '无法加载 Git 差异',
  'serverMessage.git.pushFailed': '推送失败',
  'serverMessage.git.pullFailed': '拉取失败',
  'serverMessage.git.branchesFailed': '无法加载分支',
  'serverMessage.git.remotesFailed': '无法加载远程仓库',
  'serverMessage.git.mergeFailed': '合并失败',
  'serverMessage.git.removeRemoteFailed': '移除远程仓库失败',
  'configUpdate.updatingOpenCode': '正在更新 OpenCode 配置…',
  'configUpdate.creatingCommand': '正在创建命令配置…',
  'configUpdate.updatingCommand': '正在更新命令配置…',
  'configUpdate.deletingCommand': '正在删除命令配置…',
  'configUpdate.creatingSkill': '正在创建技能…',
  'configUpdate.updatingSkill': '正在更新技能…',
  'configUpdate.renamingSkill': '正在重命名技能…',
  'configUpdate.deletingSkill': '正在删除技能…',
  'configUpdate.installingSkills': '正在安装技能…',
  'configUpdate.creatingMcp': '正在创建 MCP 服务器配置…',
  'configUpdate.updatingMcp': '正在更新 MCP 服务器配置…',
  'configUpdate.deletingMcp': '正在删除 MCP 服务器配置…',
  'configUpdate.creatingAgent': '正在创建智能体配置…',
  'configUpdate.updatingAgent': '正在更新智能体配置…',
  'configUpdate.deletingAgent': '正在删除智能体配置…',
  'configUpdate.reloadingOpenCode': '正在重新加载 OpenCode 配置…',
};
