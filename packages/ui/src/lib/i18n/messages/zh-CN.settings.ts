...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': '界面动态背景',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': '在整个工作台背后循环播放一段视频：侧栏、Header、右侧面板都会透出它。仅桌面端生效。',
  'settings.openchamber.visual.field.chatBackdropIntensity': '背景强度',
  ...
  'settings.page.memorySettings.title': '记忆设置',
  'settings.page.memorySettings.description': 'OpenViking 记忆库的连接与就绪状态。',
  'settings.page.memoryBrowse.title': '记忆浏览',
  'settings.page.memoryBrowse.description': '按文件树浏览 OpenViking 里的长期记忆。',
  'settings.page.knowledgeSettings.title': '知识库设置',
  'settings.page.knowledgeSettings.description': 'OpenViking 知识库的连接与就绪状态。',
  'settings.page.knowledgeBrowse.title': '知识库浏览',
  'settings.page.knowledgeBrowse.description': '按文件树浏览 OpenViking 里的资源与文档。',
  'settings.openviking.notConfigured.short': '没有配置 OpenViking。',
  'settings.openviking.notConfigured.long': '这台工作台没有配置 OpenViking，所以记忆与知识库的浏览不可用。',
  'settings.openviking.settings.envHint': '在容器的环境变量里设',
  'settings.openviking.settings.connection': '连接',
  'settings.openviking.settings.storage': '存储',
  'settings.openviking.settings.upstream': '上游地址',
  'settings.openviking.settings.version': '版本',
  'settings.openviking.settings.ready': '就绪状态',
  'settings.openviking.settings.identity': '身份',
  ...
  'settings.openviking.memory.sidebar.description': 'OpenViking 记住的全部内容，按文件树排列。',
  'settings.openviking.memory.empty': '还没有存下任何记忆。',
  'settings.openviking.knowledge.sidebar.title': '知识库',
  'settings.openviking.knowledge.sidebar.description': '已导入的资源与文档，按文件树排列。',
  'settings.openviking.knowledge.empty': '还没有导入任何资源。',
  'settings.openviking.browse.loading': '加载中…',
  'settings.openviking.browse.loadFailed': '加载文件树失败。',
  'settings.openviking.browse.readFailed': '读取这个条目失败。',
  'settings.openviking.browse.refresh': '刷新',
  'settings.openviking.browse.pickHint': '在左边选一个条目查看内容。',
  'settings.openviking.browse.overview': '概览',
  'settings.openviking.browse.overviewEmpty': '这个目录还没有生成概览。',
  'settings.openviking.browse.overviewFailed': '加载目录概览失败。',
  'settings.openviking.browse.childCount': '{{count}} 个条目',
  'settings.openviking.browse.edit': '编辑',
  'settings.openviking.browse.editBody': '文件正文',
  'settings.openviking.browse.save': '保存',
  'settings.openviking.browse.saving': '保存中…',
  'settings.openviking.browse.saveFailed': '没能保存这个条目。',
  'settings.openviking.browse.cancel': '取消',
  'settings.openviking.browse.delete': '删除',
  'settings.openviking.browse.deleteTitle': '删除这个条目？',
  'settings.openviking.browse.deleteDescription': '删除「{name}」？此操作无法撤销。',
  'settings.openviking.browse.deleteNoRecycle': '没有回收站。删除后无法恢复。',
  'settings.openviking.browse.deleteConfirm': '删除',
  'settings.openviking.browse.deleting': '删除中…',
  'settings.openviking.browse.deleteFailed': '没能删除这个条目。',
  'settings.openviking.browse.create': '新建条目',
  'settings.openviking.browse.createTitle': '新建条目',
  'settings.openviking.browse.createDescription': '在 {parent} 下创建',
  'settings.openviking.browse.createNoParent': '请先选择一个目录。',
  'settings.openviking.browse.createNameLabel': '文件名',
  'settings.openviking.browse.createNamePlaceholder': 'note.md',
  'settings.openviking.browse.createContentLabel': '正文',
  'settings.openviking.browse.createContentPlaceholder': '写下内容…',
  'settings.openviking.browse.createSubmit': '创建',
  'settings.openviking.browse.createFailed': '没能创建这个条目。',
  'settings.openviking.browse.createInvalidName': '请使用不含 / 或 \\ 的普通文件名，且不要用保留名。',
  ...
  'settings.remoteInstances.direct.headers.description': '桌面端 API 请求的可选 HTTP 请求头。Authorization 保留给连接令牌。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.remoteInstances.relay.title': 'OpenChamber 中继',
  ...
  'settings.gitIdentities.editor.field.authToken': '令牌',
  ...
  'settings.openchamber.visual.section.chatBackdrop': '界面背景',
  'settings.openchamber.visual.section.chatBackdropInfo': '视频由本实例提供，路径为 /ambient/chat-backdrop.mp4；换素材就替换该文件后重新构建。',
  ...
  'settings.openchamber.visual.section.followUpBehavior': '追问行为',
  'settings.openchamber.visual.section.followUpBehaviorAria': '追问行为',
  'settings.openchamber.visual.field.followUpBehaviorAria': '追问行为：{option}',
  'settings.openchamber.visual.field.followUpBehaviorDescription': '选择智能体仍在回复时，你按下 Enter 发送追问消息的处理方式。',
  ...
  'settings.page.devices.description': '登记 Windows 设备，供 agent 通过 MCP 操作 shell / 文件 / 屏幕。',
  'settings.page.pigeonBrain.description': '长期记忆与知识库的管理界面。',
  'settings.devices.approval.deny': '禁止操作',
  'settings.devices.approval.smart': '智能审批',
  'settings.devices.approval.auto': '全自动',
  'settings.devices.section.registered': '已登记设备',
  'settings.devices.section.agentMcpToken': 'Agent MCP Token',
  'settings.devices.section.audit': '最近审计',
  'settings.devices.audit.empty': '暂无记录。',
  'settings.devices.empty': '还没有设备。在下方登记第一台 Windows 机器。',
  'settings.devices.status.probing': '正在探测状态…',
  'settings.devices.actions.probing': '探测中…',
  'settings.devices.actions.refresh': '刷新状态',
  'settings.devices.status.probeFailed': '状态探测失败：{error}',
  'settings.devices.status.onlineCount': '在线 {online}/{total}',
  'settings.devices.status.probedAt': '探测于 {time}',
  'settings.devices.status.online': '在线',
  'settings.devices.status.offline': '离线',
  'settings.devices.actions.approval': '审批',
  'settings.devices.actions.delete': '删除',
  'settings.devices.dialog.deleteConfirm': '确定删除这台登记设备？',
  'settings.devices.enroll.title': '一键注册',
  'settings.devices.enroll.description': '在目标 Windows 上以管理员 PowerShell 执行一条命令。注册码 15 分钟内有效，成功后自动作废。',
  'settings.devices.enroll.generate': '生成注册码',
  'settings.devices.enroll.hint': '点「生成注册码」得到一键命令。',
  'settings.devices.enroll.copyToTarget': '复制到目标机器执行（过期：{expiresAt}）：',
  'settings.devices.enroll.copyCommand': '复制命令',
  'settings.devices.enroll.copyCodeOnly': '只复制注册码',
  'settings.devices.enroll.scriptHelp': '脚本会：生成/复用 SSH 密钥、尽量授权到 administrators_authorized_keys、探测 Tailscale、可选打印 Windows-MCP 启动参数，然后向本工作台登记设备。',
  'settings.devices.enroll.tokenItem': '未使用 · {label} · 过期 {expiresAt}',
  'settings.devices.form.manual': '手动登记（高级）',
  'settings.devices.form.namePlaceholder': '名称，例如 施工机',
  'settings.devices.form.hostPlaceholder': 'Tailscale IP（可选）',
  'settings.devices.form.sshPortPlaceholder': 'SSH 端口（默认 22）',
  'settings.devices.form.mcpPortPlaceholder': 'Windows-MCP 端口（可选，隧道出口）',
  'settings.devices.form.sshUserPlaceholder': 'SSH 用户',
  'settings.devices.form.mcpBearerPlaceholder': 'Windows-MCP Bearer（可选）',
  'settings.devices.form.sshKeyPlaceholder': 'SSH 私钥（可选，仅存服务器 data dir）',
  'settings.devices.actions.enroll': '登记设备',
  'settings.devices.actions.createToken': '生成 token',
  'settings.devices.token.copyOnce': '请立即复制，关闭后不再显示：',
  'settings.devices.token.endpointHint': 'MCP 端点：POST /api/devices/mcp（Authorization: Bearer <token>）',
  'settings.devices.token.createdAt': '创建于 {time}',
  'settings.devices.toast.copyFailed': '复制失败，请手动选中命令',
  'settings.devices.error.loadDevices': '设备列表 HTTP {status}',
  'settings.devices.error.statusProbe': '状态探测 HTTP {status}',
  'settings.devices.error.nameRequired': '请填写设备名称',
  'settings.devices.error.enrollFailed': '登记失败 HTTP {status}',
  'settings.devices.error.approvalFailed': '更新审批档失败 HTTP {status}',
  'settings.devices.error.deleteFailed': '删除失败 HTTP {status}',
  'settings.devices.error.createTokenFailed': '创建 token 失败 HTTP {status}',
  'settings.devices.error.createEnrollFailed': '创建一键注册码失败 HTTP {status}',
  'settings.devices.error.enrollTokenMissing': '注册码响应缺少 token',
  'settings.pigeonBrain.actions.reload': '重新加载',
  'settings.pigeonBrain.actions.openInNewTab': '在新标签打开',
  'settings.pigeonBrain.status.error': '读不到状态（{error}）。工作台服务器可能没起来。',
  'settings.pigeonBrain.status.checking': '正在检查…',
  'settings.pigeonBrain.notConfigured.title': '这台工作台没有配置记忆库。',
  'settings.pigeonBrain.notConfigured.help': '在容器的环境变量里设 PIGEON_BRAIN_URL（例如 http://brain:3210）后重启即可。没配时这条链路整段不挂载，工作台其余部分不受影响。',
  'settings.pigeonBrain.iframeTitle': 'pigeon-brain 管理界面',
  'settings.mcp.oauth.callback.working': '正在完成 MCP 授权…',
  'settings.mcp.oauth.callback.success': '授权完成。可以关闭此标签页，然后返回 OpenChamber。',
  'settings.mcp.oauth.callback.error': '授权失败',
  'settings.mcp.oauth.callback.browserUnavailable': '浏览器上下文不可用。',
  'settings.mcp.oauth.callback.sessionExpired': '授权会话已过期，或在重新加载时被清除。请返回 OpenChamber 后再次点击授权。',
  'settings.mcp.oauth.callback.missingCode': '缺少 OAuth 授权码。请在 MCP 设置中重新发起授权，或手动将返回的授权码粘贴到 OpenChamber。',
  'settings.mcp.oauth.callback.sessionUnavailable': '无法获取授权会话详情。请在 MCP 设置中重新发起授权，或手动将返回的授权码粘贴到 OpenChamber。',
  'settings.mcp.oauth.callback.completeFailed': '无法完成 MCP 授权。',
  'settings.mcp.oauth.callback.return': '返回 OpenChamber',
  'settings.mcp.oauth.callback.titles.working': '正在完成授权',
  'settings.mcp.oauth.callback.titles.success': '授权完成',
  'settings.mcp.oauth.callback.titles.error': '授权失败',
  'settings.page.home.title': '设置',
  'settings.page.home.description': '搜索并跳转到常用页面。',
} as const;
