...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': '对话动态背景',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': '在消息区背后循环播放一段视频。侧栏、面板与浮层保持不透明。仅桌面端生效。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.section.chatBackdrop': '对话背景',
