...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': '채팅 뒤 영상 배경',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': '메시지 뒤에서 동영상을 반복 재생합니다. 사이드바, 패널, 팝오버는 불투명하게 유지됩니다. 데스크톱 전용.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.section.chatBackdrop': '채팅 배경',
