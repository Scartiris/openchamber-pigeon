...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': '인터페이스 뒤 영상 배경',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': '워크스페이스 전체 뒤에서 동영상을 반복 재생합니다. 사이드바, 헤더, 패널 모두 비쳐 보입니다. 데스크톱 전용.',
  'settings.openchamber.visual.field.chatBackdropIntensity': '배경 강도',
  ...
  'settings.page.memoryBrowse.description': 'OpenViking의 장기 메모리를 파일 트리로 탐색합니다.',
  'settings.page.knowledgeSettings.title': '지식 설정',
  'settings.page.knowledgeSettings.description': 'OpenViking 지식 저장소의 연결 및 준비 상태입니다.',
  'settings.page.knowledgeBrowse.title': '지식 탐색',
  'settings.page.knowledgeBrowse.description': 'OpenViking의 리소스와 문서를 파일 트리로 탐색합니다.',
  'settings.openviking.notConfigured.short': 'OpenViking이 설정되지 않았습니다.',
  'settings.openviking.notConfigured.long': '이 작업 공간에는 OpenViking이 설정되어 있지 않아 메모리와 지식 탐색을 사용할 수 없습니다.',
  'settings.openviking.settings.envHint': '컨테이너의 환경 변수를 설정하세요',
  'settings.openviking.settings.connection': '연결',
  'settings.openviking.settings.storage': '저장소',
  'settings.openviking.settings.upstream': '업스트림 주소',
  'settings.openviking.settings.version': '버전',
  'settings.openviking.settings.ready': '준비 상태',
  'settings.openviking.settings.identity': 'ID',
  'settings.openviking.settings.scope': '범위',
  ...
  'settings.openviking.memory.sidebar.description': 'OpenViking이 기억한 모든 내용을 파일 트리로 표시합니다.',
  'settings.openviking.memory.empty': '아직 저장된 메모리가 없습니다.',
  'settings.openviking.knowledge.sidebar.title': '지식',
  'settings.openviking.knowledge.sidebar.description': '가져온 리소스와 문서를 파일 트리로 표시합니다.',
  'settings.openviking.knowledge.empty': '아직 가져온 리소스가 없습니다.',
  'settings.openviking.browse.loading': '불러오는 중…',
  'settings.openviking.browse.loadFailed': '파일 트리를 불러오지 못했습니다.',
  'settings.openviking.browse.readFailed': '이 항목을 읽지 못했습니다.',
  'settings.openviking.browse.refresh': '새로 고침',
  'settings.openviking.browse.pickHint': '왼쪽에서 항목을 선택하면 내용이 표시됩니다.',
  'settings.openviking.browse.overview': '개요',
  'settings.openviking.browse.overviewEmpty': '이 디렉터리의 개요가 아직 생성되지 않았습니다.',
  'settings.openviking.browse.overviewFailed': '디렉터리 개요를 불러오지 못했습니다.',
  'settings.openviking.browse.childCount': '{{count}}개 항목',
  'settings.openviking.browse.edit': '편집',
  'settings.openviking.browse.editBody': '파일 내용',
  'settings.openviking.browse.save': '저장',
  'settings.openviking.browse.saving': '저장 중…',
  'settings.openviking.browse.saveFailed': '이 항목을 저장하지 못했습니다.',
  'settings.openviking.browse.cancel': '취소',
  'settings.openviking.browse.delete': '삭제',
  'settings.openviking.browse.deleteTitle': '이 항목을 삭제할까요?',
  'settings.openviking.browse.deleteDescription': '“{name}”을(를) 삭제할까요? 되돌릴 수 없습니다.',
  'settings.openviking.browse.deleteNoRecycle': '휴지통이 없습니다. 삭제한 항목은 복구할 수 없습니다.',
  'settings.openviking.browse.deleteConfirm': '삭제',
  'settings.openviking.browse.deleting': '삭제 중…',
  'settings.openviking.browse.deleteFailed': '이 항목을 삭제하지 못했습니다.',
  'settings.openviking.browse.create': '새 항목',
  'settings.openviking.browse.createTitle': '새 항목',
  'settings.openviking.browse.createDescription': '{parent} 아래에 만들기',
  'settings.openviking.browse.createNoParent': '먼저 디렉터리를 선택하세요.',
  'settings.openviking.browse.createNameLabel': '파일 이름',
  'settings.openviking.browse.createNamePlaceholder': 'note.md',
  'settings.openviking.browse.createContentLabel': '내용',
  'settings.openviking.browse.createContentPlaceholder': '내용을 입력하세요…',
  'settings.openviking.browse.createSubmit': '만들기',
  'settings.openviking.browse.createFailed': '이 항목을 만들지 못했습니다.',
  'settings.openviking.browse.createInvalidName': '/ 또는 \\가 없는 일반 파일 이름을 사용하고 예약된 이름은 피하세요.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.section.chatBackdrop': '인터페이스 배경',
  'settings.openchamber.visual.section.chatBackdropInfo': '동영상은 이 인스턴스의 /ambient/chat-backdrop.mp4 에서 제공됩니다. 파일을 바꾸고 다시 빌드하세요.',
  ...
  'settings.page.devices.description': '에이전트가 MCP로 셸/파일/화면을 조작할 수 있도록 Windows 기기를 등록합니다.',
  'settings.page.pigeonBrain.description': '장기 기억과 지식 저장소를 관리합니다。',
  'settings.devices.approval.deny': '거부',
  'settings.devices.approval.smart': '스마트 승인',
  'settings.devices.approval.auto': '자동',
  'settings.devices.section.registered': '등록된 기기',
  'settings.devices.section.agentMcpToken': 'Agent MCP 토큰',
  'settings.devices.section.audit': '최근 감사',
  'settings.devices.audit.empty': '아직 기록이 없습니다.',
  'settings.devices.empty': '아직 기기가 없습니다. 아래에서 첫 Windows 머신을 등록하세요.',
  'settings.devices.status.probing': '상태 확인 중…',
  'settings.devices.actions.probing': '확인 중…',
  'settings.devices.actions.refresh': '상태 새로고침',
  'settings.devices.status.probeFailed': '상태 확인 실패: {error}',
  'settings.devices.status.onlineCount': '온라인 {online}/{total}',
  'settings.devices.status.probedAt': '확인 시각 {time}',
  'settings.devices.status.online': '온라인',
  'settings.devices.status.offline': '오프라인',
  'settings.devices.actions.approval': '승인',
  'settings.devices.actions.delete': '삭제',
  'settings.devices.dialog.deleteConfirm': '이 등록된 기기를 삭제할까요?',
  'settings.devices.enroll.title': '원클릭 등록',
  'settings.devices.enroll.description': '대상 Windows에서 관리자 PowerShell 명령을 한 번 실행하세요. 등록 코드는 15분간 유효하며 성공 후 자동으로 무효화됩니다.',
  'settings.devices.enroll.generate': '등록 코드 생성',
  'settings.devices.enroll.hint': '「등록 코드 생성」을 클릭하면 원클릭 명령이 표시됩니다.',
  'settings.devices.enroll.copyToTarget': '대상 머신에 복사(만료: {expiresAt}):',
  'settings.devices.enroll.copyCommand': '명령 복사',
  'settings.devices.enroll.copyCodeOnly': '코드만 복사',
  'settings.devices.enroll.scriptHelp': '스크립트는 SSH 키를 생성하거나 재사용하고, 가능한 경우 administrators_authorized_keys를 승인하며, Tailscale을 확인하고, 선택적으로 Windows-MCP 시작 인자를 출력한 뒤 이 작업대에 기기를 등록합니다.',
  'settings.devices.enroll.tokenItem': '미사용 · {label} · 만료 {expiresAt}',
  'settings.devices.form.manual': '수동 등록(고급)',
  'settings.devices.form.namePlaceholder': '이름(예: 현장 노트북)',
  'settings.devices.form.hostPlaceholder': 'Tailscale IP(선택)',
  'settings.devices.form.sshPortPlaceholder': 'SSH 포트(기본 22)',
  'settings.devices.form.mcpPortPlaceholder': 'Windows-MCP 포트(선택, 터널 출구)',
  'settings.devices.form.sshUserPlaceholder': 'SSH 사용자',
  'settings.devices.form.mcpBearerPlaceholder': 'Windows-MCP Bearer(선택)',
  'settings.devices.form.sshKeyPlaceholder': 'SSH 개인 키(선택, 서버 data dir에만 저장)',
  'settings.devices.actions.enroll': '기기 등록',
  'settings.devices.actions.createToken': '토큰 생성',
  'settings.devices.token.copyOnce': '지금 복사하세요. 이 카드를 닫으면 다시 표시되지 않습니다:',
  'settings.devices.token.endpointHint': 'MCP 엔드포인트: POST /api/devices/mcp (Authorization: Bearer <token>)',
  'settings.devices.token.createdAt': '생성 {time}',
  'settings.devices.toast.copyFailed': '복사에 실패했습니다. 명령을 직접 선택하세요.',
  'settings.devices.error.loadDevices': '기기 목록 HTTP {status}',
  'settings.devices.error.statusProbe': '상태 확인 HTTP {status}',
  'settings.devices.error.nameRequired': '기기 이름을 입력하세요.',
  'settings.devices.error.enrollFailed': '등록 실패 HTTP {status}',
  'settings.devices.error.approvalFailed': '승인 업데이트 실패 HTTP {status}',
  'settings.devices.error.deleteFailed': '삭제 실패 HTTP {status}',
  'settings.devices.error.createTokenFailed': '토큰 생성 실패 HTTP {status}',
  'settings.devices.error.createEnrollFailed': '등록 코드 생성 실패 HTTP {status}',
  'settings.devices.error.enrollTokenMissing': '등록 코드 응답에 토큰이 없습니다.',
  'settings.pigeonBrain.actions.reload': '새로고침',
  'settings.pigeonBrain.actions.openInNewTab': '새 탭에서 열기',
  'settings.pigeonBrain.status.error': '상태를 읽을 수 없습니다({error}). 작업대 서버가 실행 중이지 않을 수 있습니다.',
  'settings.pigeonBrain.status.checking': '확인 중…',
  'settings.pigeonBrain.notConfigured.title': '이 작업대에는 pigeon-brain이 설정되어 있지 않습니다.',
  'settings.pigeonBrain.notConfigured.help': '컨테이너 환경 변수에 PIGEON_BRAIN_URL(예: http://brain:3210)을 설정한 뒤 재시작하세요. 설정하지 않으면 이 경로는 마운트되지 않으며 작업대의 나머지는 영향을 받지 않습니다.',
  'settings.pigeonBrain.iframeTitle': 'pigeon-brain 관리 UI',
  'settings.mcp.oauth.callback.working': 'MCP 인증을 완료하는 중…',
  'settings.mcp.oauth.callback.success': '인증이 완료되었습니다. 이 탭을 닫고 OpenChamber로 돌아가세요.',
  'settings.mcp.oauth.callback.error': '인증 실패',
  'settings.mcp.oauth.callback.browserUnavailable': '브라우저 컨텍스트를 사용할 수 없습니다.',
  'settings.mcp.oauth.callback.sessionExpired': '인증 세션이 만료되었거나 새로고침 중에 지워졌습니다. OpenChamber로 돌아가 다시 승인을 클릭하세요.',
  'settings.mcp.oauth.callback.missingCode': 'OAuth 인증 코드가 없습니다. MCP 설정에서 인증을 다시 시작하거나 반환된 코드를 OpenChamber에 직접 붙여넣으세요.',
  'settings.mcp.oauth.callback.sessionUnavailable': '인증 세션 세부 정보를 사용할 수 없습니다. MCP 설정에서 인증을 다시 시작하거나 반환된 코드를 OpenChamber에 직접 붙여넣으세요.',
  'settings.mcp.oauth.callback.completeFailed': 'MCP 인증을 완료하지 못했습니다.',
  'settings.mcp.oauth.callback.return': 'OpenChamber로 돌아가기',
  'settings.mcp.oauth.callback.titles.working': '인증 완료 중',
  'settings.mcp.oauth.callback.titles.success': '인증 완료',
  'settings.mcp.oauth.callback.titles.error': '인증 실패',
  'settings.page.home.title': '설정',
  'settings.page.home.description': '자주 사용하는 페이지를 검색하고 이동합니다.',
} as const;
