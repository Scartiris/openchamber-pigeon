...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': '對話動態背景',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': '在訊息後方循環播放影片。側欄、面板與浮層維持不透明。僅限桌面版。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.visual.section.chatBackdrop': '對話背景',
