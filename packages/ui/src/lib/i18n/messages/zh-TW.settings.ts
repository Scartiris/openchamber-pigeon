...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': '介面動態背景',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': '在整個工作台後方循環播放影片：側欄、Header、右側面板都會透出它。僅限桌面版。',
  'settings.openchamber.visual.field.chatBackdropIntensity': '背景強度',
  'settings.openchamber.visual.field.chatBackdropIntensityHint': '畫面有多少能透過主題遮罩留下。0 為完全隱去，100 為原樣呈現。',
  'settings.openchamber.visual.field.chatBackdropScrim': '遮罩',
  'settings.openchamber.visual.field.chatBackdropScrimHint': '向主題背景色額外疊一層紗，用來換回文字對比度。亮色主題會自動再加 20%。',
  'settings.openchamber.visual.field.chatBackdropSurfaceOpacity': '面板不透明度',
  'settings.openchamber.visual.field.chatBackdropSurfaceOpacityHint': '面板底色有多實。調低會讓壁紙透出更多、氛圍更足；調高則文字更穩。氛圍感的強弱主要就由它決定。',
  'settings.openchamber.visual.field.chatBackdropMotion': '呼吸動效',
  'settings.openchamber.visual.field.chatBackdropMotionHint': '緩慢縮放畫面，避免靜止畫面看起來像卡住。系統開啟「減少動態效果」時自動跳過。',
  ...
  'settings.page.memoryBrowse.description': '以檔案樹瀏覽 OpenViking 裡的長期記憶。',
  'settings.page.knowledgeSettings.title': '知識庫設定',
  'settings.page.knowledgeSettings.description': 'OpenViking 知識庫的連線與就緒狀態。',
  'settings.page.knowledgeBrowse.title': '知識庫瀏覽',
  'settings.page.knowledgeBrowse.description': '以檔案樹瀏覽 OpenViking 裡的資源與文件。',
  'settings.openviking.notConfigured.short': '沒有設定 OpenViking。',
  'settings.openviking.notConfigured.long': '這台工作台沒有設定 OpenViking，因此記憶與知識庫的瀏覽無法使用。',
  'settings.openviking.settings.envHint': '在容器的環境變數裡設定',
  'settings.openviking.settings.connection': '連線',
  'settings.openviking.settings.storage': '儲存',
  'settings.openviking.settings.upstream': '上游位址',
  'settings.openviking.settings.version': '版本',
  'settings.openviking.settings.ready': '就緒狀態',
  'settings.openviking.settings.identity': '身分',
  'settings.openviking.settings.scope': '作用域',
  'settings.openviking.settings.unknown': '未知',
  'settings.openviking.settings.unreachable': '連不上',
  'settings.openviking.settings.probeFailed': '讀不到 OpenViking 的狀態。容器在跑嗎？',
  'settings.openviking.settings.readyUnavailable': '就緒檢查逾時了。',
  'settings.openviking.settings.healthFailed': '讀不到 OpenViking 的版本資訊。容器在跑嗎？',
  'settings.openviking.settings.recheck': '重新檢查',
  'settings.openviking.settings.readOnlyNote': '這一頁目前是唯讀的。記憶的提交策略在 OpenViking 的每個工作階段上，不在這裡。',
  'settings.openviking.memory.sidebar.title': '長期記憶',
  'settings.openviking.memory.sidebar.description': 'OpenViking 記住的所有內容，以檔案樹排列。',
  'settings.openviking.memory.empty': '還沒有存下任何記憶。',
  'settings.openviking.knowledge.sidebar.title': '知識庫',
  'settings.openviking.knowledge.sidebar.description': '已匯入的資源與文件，以檔案樹排列。',
  'settings.openviking.knowledge.empty': '還沒有匯入任何資源。',
  'settings.openviking.browse.loading': '載入中…',
  'settings.openviking.browse.loadFailed': '載入檔案樹失敗。',
  'settings.openviking.browse.readFailed': '讀取這個項目失敗。',
  'settings.openviking.browse.refresh': '重新整理',
  'settings.openviking.browse.pickHint': '在左邊選一個項目查看內容。',
  'settings.openviking.browse.overview': '概觀',
  'settings.openviking.browse.overviewEmpty': '這個目錄還沒有產生概觀。',
  'settings.openviking.browse.overviewFailed': '載入目錄概觀失敗。',
  'settings.openviking.browse.childCount': '{{count}} 個項目',
  'settings.openviking.browse.edit': '編輯',
  'settings.openviking.browse.editBody': '檔案內容',
  'settings.openviking.browse.save': '儲存',
  'settings.openviking.browse.saving': '儲存中…',
  'settings.openviking.browse.saveFailed': '無法儲存此項目。',
  'settings.openviking.browse.cancel': '取消',
  'settings.openviking.browse.delete': '刪除',
  'settings.openviking.browse.deleteTitle': '刪除此項目？',
  'settings.openviking.browse.deleteDescription': '刪除「{name}」？此操作無法復原。',
  'settings.openviking.browse.deleteNoRecycle': '沒有資源回收筒。刪除後無法還原。',
  'settings.openviking.browse.deleteConfirm': '刪除',
  'settings.openviking.browse.deleting': '刪除中…',
  'settings.openviking.browse.deleteFailed': '無法刪除此項目。',
  'settings.openviking.browse.create': '新建項目',
  'settings.openviking.browse.createTitle': '新建項目',
  'settings.openviking.browse.createDescription': '在 {parent} 下建立',
  'settings.openviking.browse.createNoParent': '請先選擇一個目錄。',
  'settings.openviking.browse.createNameLabel': '檔名',
  'settings.openviking.browse.createNamePlaceholder': 'note.md',
  'settings.openviking.browse.createContentLabel': '內容',
  'settings.openviking.browse.createContentPlaceholder': '寫下內容…',
  'settings.openviking.browse.createSubmit': '建立',
  'settings.openviking.browse.createFailed': '無法建立此項目。',
  'settings.openviking.browse.createInvalidName': '請使用不含 / 或 \\ 的一般檔名，且不要使用保留名稱。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.visual.section.chatBackdrop': '介面背景',
  'settings.openchamber.visual.section.chatBackdropInfo': '影片由本執行個體提供，路徑為 /ambient/chat-backdrop.mp4；換素材就替換該檔案後重新建置。',
  ...
  'settings.page.devices.title': '設備',
  'settings.page.devices.description': '登錄 Windows 裝置，供 agent 透過 MCP 操作 shell / 檔案 / 畫面。',
  'settings.page.pigeonBrain.description': '長期記憶與知識庫的管理介面。',
  'settings.devices.approval.deny': '禁止操作',
  'settings.devices.approval.smart': '智慧審批',
  'settings.devices.approval.auto': '全自動',
  'settings.devices.section.registered': '已登錄裝置',
  'settings.devices.section.agentMcpToken': 'Agent MCP Token',
  'settings.devices.section.audit': '最近審計',
  'settings.devices.audit.empty': '尚無記錄。',
  'settings.devices.empty': '尚無裝置。請在下方登錄第一台 Windows 機器。',
  'settings.devices.status.probing': '正在探測狀態…',
  'settings.devices.actions.probing': '探測中…',
  'settings.devices.actions.refresh': '重新整理狀態',
  'settings.devices.status.probeFailed': '狀態探測失敗：{error}',
  'settings.devices.status.onlineCount': '線上 {online}/{total}',
  'settings.devices.status.probedAt': '探測於 {time}',
  'settings.devices.status.online': '線上',
  'settings.devices.status.offline': '離線',
  'settings.devices.actions.approval': '審批',
  'settings.devices.actions.delete': '刪除',
  'settings.devices.dialog.deleteConfirm': '確定刪除這台登錄裝置？',
  'settings.devices.enroll.title': '一鍵註冊',
  'settings.devices.enroll.description': '在目標 Windows 上以系統管理員 PowerShell 執行一條命令。註冊碼 15 分鐘內有效，成功後自動作廢。',
  'settings.devices.enroll.generate': '產生註冊碼',
  'settings.devices.enroll.hint': '點「產生註冊碼」取得一鍵命令。',
  'settings.devices.enroll.copyToTarget': '複製到目標機器執行（過期：{expiresAt}）：',
  'settings.devices.enroll.copyCommand': '複製命令',
  'settings.devices.enroll.copyCodeOnly': '只複製註冊碼',
  'settings.devices.enroll.scriptHelp': '腳本會：產生/複用 SSH 金鑰、盡量授權到 administrators_authorized_keys、探測 Tailscale、可選列印 Windows-MCP 啟動參數，然後向本工作台登錄裝置。',
  'settings.devices.enroll.tokenItem': '未使用 · {label} · 過期 {expiresAt}',
  'settings.devices.form.manual': '手動登錄（進階）',
  'settings.devices.form.namePlaceholder': '名稱，例如 施工機',
  'settings.devices.form.hostPlaceholder': 'Tailscale IP（可選）',
  'settings.devices.form.sshPortPlaceholder': 'SSH 連接埠（預設 22）',
  'settings.devices.form.mcpPortPlaceholder': 'Windows-MCP 連接埠（可選，隧道出口）',
  'settings.devices.form.sshUserPlaceholder': 'SSH 使用者',
  'settings.devices.form.mcpBearerPlaceholder': 'Windows-MCP Bearer（可選）',
  'settings.devices.form.sshKeyPlaceholder': 'SSH 私鑰（可選，僅存伺服器 data dir）',
  'settings.devices.actions.enroll': '登錄裝置',
  'settings.devices.actions.createToken': '產生 token',
  'settings.devices.token.copyOnce': '請立即複製，關閉後不再顯示：',
  'settings.devices.token.endpointHint': 'MCP 端點：POST /api/devices/mcp（Authorization: Bearer <token>）',
  'settings.devices.token.createdAt': '建立於 {time}',
  'settings.devices.toast.copyFailed': '複製失敗，請手動選取命令',
  'settings.devices.error.loadDevices': '裝置清單 HTTP {status}',
  'settings.devices.error.statusProbe': '狀態探測 HTTP {status}',
  'settings.devices.error.nameRequired': '請填寫裝置名稱',
  'settings.devices.error.enrollFailed': '登錄失敗 HTTP {status}',
  'settings.devices.error.approvalFailed': '更新審批檔失敗 HTTP {status}',
  'settings.devices.error.deleteFailed': '刪除失敗 HTTP {status}',
  'settings.devices.error.createTokenFailed': '建立 token 失敗 HTTP {status}',
  'settings.devices.error.createEnrollFailed': '建立一鍵註冊碼失敗 HTTP {status}',
  'settings.devices.error.enrollTokenMissing': '註冊碼回應缺少 token',
  'settings.pigeonBrain.actions.reload': '重新載入',
  'settings.pigeonBrain.actions.openInNewTab': '在新分頁開啟',
  'settings.pigeonBrain.status.error': '讀不到狀態（{error}）。工作台伺服器可能沒起來。',
  'settings.pigeonBrain.status.checking': '正在檢查…',
  'settings.pigeonBrain.notConfigured.title': '這台工作台沒有配置記憶庫。',
  'settings.pigeonBrain.notConfigured.help': '在容器的環境變數裡設 PIGEON_BRAIN_URL（例如 http://brain:3210）後重啟即可。沒配時這條鏈路整段不掛載，工作台其餘部分不受影響。',
  'settings.pigeonBrain.iframeTitle': 'pigeon-brain 管理介面',
  'settings.mcp.oauth.callback.working': '正在完成 MCP 授權…',
  'settings.mcp.oauth.callback.success': '授權完成。可以關閉此分頁，然後返回 OpenChamber。',
  'settings.mcp.oauth.callback.error': '授權失敗',
  'settings.mcp.oauth.callback.browserUnavailable': '瀏覽器上下文不可用。',
  'settings.mcp.oauth.callback.sessionExpired': '授權會話已過期，或在重新載入時被清除。請返回 OpenChamber 後再次點擊授權。',
  'settings.mcp.oauth.callback.missingCode': '缺少 OAuth 授權碼。請在 MCP 設定中重新發起授權，或手動將返回的授權碼貼到 OpenChamber。',
  'settings.mcp.oauth.callback.sessionUnavailable': '無法取得授權會話詳情。請在 MCP 設定中重新發起授權，或手動將返回的授權碼貼到 OpenChamber。',
  'settings.mcp.oauth.callback.completeFailed': '無法完成 MCP 授權。',
  'settings.mcp.oauth.callback.return': '返回 OpenChamber',
  'settings.mcp.oauth.callback.titles.working': '正在完成授權',
  'settings.mcp.oauth.callback.titles.success': '授權完成',
  'settings.mcp.oauth.callback.titles.error': '授權失敗',
  'settings.page.home.title': '設定',
  'settings.page.home.description': '搜尋並跳至常用頁面。',
} as const;
