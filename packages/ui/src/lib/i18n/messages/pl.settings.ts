...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': 'Wideo w tle interfejsu',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': 'Odtwarza zapętlone wideo za całym interfejsem – pasek boczny, nagłówek i panele je przepuszczają. Tylko pulpit.',
  'settings.openchamber.visual.field.chatBackdropIntensity': 'Intensywność tła',
  ...
  'settings.openchamber.visual.section.chatBackdrop': 'Tło interfejsu',
  'settings.openchamber.visual.section.chatBackdropInfo': 'Wideo jest serwowane przez tę instancję pod /ambient/chat-backdrop.mp4. Podmień plik i przebuduj, aby je zmienić.',
  ...
  'settings.page.memoryBrowse.description': 'Przeglądaj pamięć długoterminową OpenViking jako drzewo plików.',
  'settings.page.knowledgeSettings.title': 'Ustawienia wiedzy',
  'settings.page.knowledgeSettings.description': 'Połączenie i gotowość magazynu wiedzy OpenViking.',
  'settings.page.knowledgeBrowse.title': 'Przeglądarka wiedzy',
  'settings.page.knowledgeBrowse.description': 'Przeglądaj zasoby i dokumenty OpenViking jako drzewo plików.',
  'settings.openviking.notConfigured.short': 'OpenViking nie jest skonfigurowany.',
  'settings.openviking.notConfigured.long': 'To środowisko nie ma skonfigurowanego OpenViking, więc przeglądanie pamięci i wiedzy jest niedostępne.',
  'settings.openviking.settings.envHint': 'Ustaw zmienne środowiskowe kontenera',
  'settings.openviking.settings.connection': 'Połączenie',
  'settings.openviking.settings.storage': 'Przechowywanie',
  'settings.openviking.settings.upstream': 'Adres nadrzędny',
  'settings.openviking.settings.version': 'Wersja',
  'settings.openviking.settings.ready': 'Gotowość',
  'settings.openviking.settings.identity': 'Tożsamość',
  'settings.openviking.settings.scope': 'Zakres',
  ...
  'settings.openviking.memory.sidebar.description': 'Wszystko, co zapamiętał OpenViking, jako drzewo plików.',
  'settings.openviking.memory.empty': 'Nie zapisano jeszcze żadnej pamięci.',
  'settings.openviking.knowledge.sidebar.title': 'Wiedza',
  'settings.openviking.knowledge.sidebar.description': 'Zaimportowane zasoby i dokumenty jako drzewo plików.',
  'settings.openviking.knowledge.empty': 'Nie zaimportowano jeszcze żadnego zasobu.',
  'settings.openviking.browse.loading': 'Wczytywanie…',
  'settings.openviking.browse.loadFailed': 'Nie udało się wczytać drzewa.',
  'settings.openviking.browse.readFailed': 'Nie udało się odczytać tego wpisu.',
  'settings.openviking.browse.refresh': 'Odśwież',
  'settings.openviking.browse.pickHint': 'Wybierz wpis po lewej, aby zobaczyć jego treść.',
  'settings.openviking.browse.overview': 'Przegląd',
  'settings.openviking.browse.overviewEmpty': 'Dla tego katalogu nie wygenerowano jeszcze przeglądu.',
  'settings.openviking.browse.overviewFailed': 'Nie udało się wczytać przeglądu katalogu.',
  'settings.openviking.browse.childCount': '{{count}} wpisów',
  'settings.openviking.browse.edit': 'Edytuj',
  'settings.openviking.browse.editBody': 'Treść pliku',
  'settings.openviking.browse.save': 'Zapisz',
  'settings.openviking.browse.saving': 'Zapisywanie…',
  'settings.openviking.browse.saveFailed': 'Nie udało się zapisać tego wpisu.',
  'settings.openviking.browse.cancel': 'Anuluj',
  'settings.openviking.browse.delete': 'Usuń',
  'settings.openviking.browse.deleteTitle': 'Usunąć ten wpis?',
  'settings.openviking.browse.deleteDescription': 'Usunąć „{name}”? Tej operacji nie można cofnąć.',
  'settings.openviking.browse.deleteNoRecycle': 'Brak kosza. Usuniętych wpisów nie można odzyskać.',
  'settings.openviking.browse.deleteConfirm': 'Usuń',
  'settings.openviking.browse.deleting': 'Usuwanie…',
  'settings.openviking.browse.deleteFailed': 'Nie udało się usunąć tego wpisu.',
  'settings.openviking.browse.create': 'Nowy wpis',
  'settings.openviking.browse.createTitle': 'Nowy wpis',
  'settings.openviking.browse.createDescription': 'Utwórz w {parent}',
  'settings.openviking.browse.createNoParent': 'Najpierw wybierz katalog.',
  'settings.openviking.browse.createNameLabel': 'Nazwa pliku',
  'settings.openviking.browse.createNamePlaceholder': 'note.md',
  'settings.openviking.browse.createContentLabel': 'Treść',
  'settings.openviking.browse.createContentPlaceholder': 'Wpisz treść…',
  'settings.openviking.browse.createSubmit': 'Utwórz',
  'settings.openviking.browse.createFailed': 'Nie udało się utworzyć tego wpisu.',
  'settings.openviking.browse.createInvalidName': 'Użyj prostej nazwy pliku bez / i \\ oraz unikaj zastrzeżonych nazw.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.page.devices.description': 'Zarejestruj urządzenia Windows, aby agent mógł przez MCP obsługiwać powłokę, pliki i ekran.',
  'settings.page.pigeonBrain.description': 'Zarządzaj pamięcią długoterminową i magazynem wiedzy.',
  'settings.devices.approval.deny': 'Odmów',
  'settings.devices.approval.smart': 'Inteligentna zgoda',
  'settings.devices.approval.auto': 'Automatycznie',
  'settings.devices.section.registered': 'Zarejestrowane urządzenia',
  'settings.devices.section.agentMcpToken': 'Token MCP agenta',
  'settings.devices.section.audit': 'Ostatni audyt',
  'settings.devices.audit.empty': 'Brak wpisów.',
  'settings.devices.empty': 'Brak urządzeń. Zarejestruj pierwszą maszynę Windows poniżej.',
  'settings.devices.status.probing': 'Sprawdzanie stanu…',
  'settings.devices.actions.probing': 'Sprawdzanie…',
  'settings.devices.actions.refresh': 'Odśwież status',
  'settings.devices.status.probeFailed': 'Sprawdzenie stanu nie powiodło się: {error}',
  'settings.devices.status.onlineCount': 'Online {online}/{total}',
  'settings.devices.status.probedAt': 'sprawdzono o {time}',
  'settings.devices.status.online': 'Online',
  'settings.devices.status.offline': 'Offline',
  'settings.devices.actions.approval': 'Zgoda',
  'settings.devices.actions.delete': 'Usuń',
  'settings.devices.dialog.deleteConfirm': 'Usunąć to zarejestrowane urządzenie?',
  'settings.devices.enroll.title': 'Rejestracja jednym kliknięciem',
  'settings.devices.enroll.description': 'Uruchom jedno polecenie administratora PowerShell na docelowej maszynie Windows. Kod rejestracji jest ważny 15 minut i zostaje zużyty po sukcesie.',
  'settings.devices.enroll.generate': 'Generuj kod rejestracji',
  'settings.devices.enroll.hint': 'Kliknij „Generuj kod rejestracji”, aby otrzymać polecenie jednym kliknięciem.',
  'settings.devices.enroll.copyToTarget': 'Skopiuj na maszynę docelową (wygasa: {expiresAt}):',
  'settings.devices.enroll.copyCommand': 'Kopiuj polecenie',
  'settings.devices.enroll.copyCodeOnly': 'Kopiuj tylko kod',
  'settings.devices.enroll.scriptHelp': 'Skrypt wygeneruje lub ponownie użyje klucza SSH, spróbuje autoryzować administrators_authorized_keys, sprawdzi Tailscale, opcjonalnie wypisze argumenty startowe Windows-MCP, a następnie zarejestruje urządzenie w warsztacie.',
  'settings.devices.enroll.tokenItem': 'Nieużyty · {label} · wygasa {expiresAt}',
  'settings.devices.form.manual': 'Rejestracja ręczna (zaawansowane)',
  'settings.devices.form.namePlaceholder': 'Nażwa, na przykład laptop budowy',
  'settings.devices.form.hostPlaceholder': 'IP Tailscale (opcjonalne)',
  'settings.devices.form.sshPortPlaceholder': 'Port SSH (domyślnie 22)',
  'settings.devices.form.mcpPortPlaceholder': 'Port Windows-MCP (opcjonalny, wyjście tunelu)',
  'settings.devices.form.sshUserPlaceholder': 'Użytkownik SSH',
  'settings.devices.form.mcpBearerPlaceholder': 'Windows-MCP Bearer (opcjonalny)',
  'settings.devices.form.sshKeyPlaceholder': 'Prywatny klucz SSH (opcjonalny, zapisywany tylko w katalogu danych serwera)',
  'settings.devices.actions.enroll': 'Zarejestruj urządzenie',
  'settings.devices.actions.createToken': 'Generuj token',
  'settings.devices.token.copyOnce': 'Skopiuj teraz — po zamknięciu karty nie zostanie ponownie pokazany:',
  'settings.devices.token.endpointHint': 'Punkt końcowy MCP: POST /api/devices/mcp (Authorization: Bearer <token>)',
  'settings.devices.token.createdAt': 'utworzono {time}',
  'settings.devices.toast.copyFailed': 'Kopiowanie nie powiodło się. Zaznacz polecenie ręcznie.',
  'settings.devices.error.loadDevices': 'Lista urządzeń HTTP {status}',
  'settings.devices.error.statusProbe': 'Sonda statusu HTTP {status}',
  'settings.devices.error.nameRequired': 'Wprowadź nazwę urządzenia.',
  'settings.devices.error.enrollFailed': 'Rejestracja nie powiodła się HTTP {status}',
  'settings.devices.error.approvalFailed': 'Aktualizacja zgody nie powiodła się HTTP {status}',
  'settings.devices.error.deleteFailed': 'Usuwanie nie powiodło się HTTP {status}',
  'settings.devices.error.createTokenFailed': 'Tworzenie tokena nie powiodło się HTTP {status}',
  'settings.devices.error.createEnrollFailed': 'Tworzenie kodu rejestracji nie powiodło się HTTP {status}',
  'settings.devices.error.enrollTokenMissing': 'Odpowiedź kodu rejestracji nie zawierała tokena.',
  'settings.pigeonBrain.actions.reload': 'Odśwież',
  'settings.pigeonBrain.actions.openInNewTab': 'Otwórz w nowej karcie',
  'settings.pigeonBrain.status.error': 'Nie udało się odczytać stanu ({error}). Serwer warsztatu może nie działać.',
  'settings.pigeonBrain.status.checking': 'Sprawdzanie…',
  'settings.pigeonBrain.notConfigured.title': 'Ten warsztat nie ma skonfigurowanego pigeon-brain.',
  'settings.pigeonBrain.notConfigured.help': 'Ustaw PIGEON_BRAIN_URL w środowisku kontenera (na przykład http://brain:3210) i uruchom ponownie. Gdy wartość nie jest ustawiona, trasa nie jest montowana, a pozostała część warsztatu pozostaje bez zmian.',
  'settings.pigeonBrain.iframeTitle': 'Interfejs administracyjny pigeon-brain',
  'settings.mcp.oauth.callback.working': 'Uzupełnianie autoryzacji MCP…',
  'settings.mcp.oauth.callback.success': 'Autoryzacja zakończona. Możesz zamknąć tę kartę i wrócić do OpenChamber.',
  'settings.mcp.oauth.callback.error': 'Autoryzacja nie powiodła się',
  'settings.mcp.oauth.callback.browserUnavailable': 'Kontekst przeglądarki jest niedostępny.',
  'settings.mcp.oauth.callback.sessionExpired': 'Sesja autoryzacji wygasła lub została wyczyszczona podczas przeładowania. Wróć do OpenChamber i kliknij ponownie Autoryzuj.',
  'settings.mcp.oauth.callback.missingCode': 'Brak kodu autoryzacji OAuth. Uruchom ponownie autoryzację w ustawieniach MCP albo wklej zwrócony kod ręcznie do OpenChamber.',
  'settings.mcp.oauth.callback.sessionUnavailable': 'Szczegóły sesji autoryzacji nie były dostępne. Uruchom ponownie autoryzację w ustawieniach MCP albo wklej kod ręcznie do OpenChamber.',
  'settings.mcp.oauth.callback.completeFailed': 'Nie udało się dokończyć autoryzacji MCP.',
  'settings.mcp.oauth.callback.return': 'Wróć do OpenChamber',
  'settings.mcp.oauth.callback.titles.working': 'Uzupełnianie autoryzacji',
  'settings.mcp.oauth.callback.titles.success': 'Autoryzacja zakończona',
  'settings.mcp.oauth.callback.titles.error': 'Autoryzacja nie powiodła się',
  'settings.page.home.title': 'Ustawienia',
  'settings.page.home.description': 'Szukaj i przechodź do popularnych stron.',
};
