...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.planMode.label": "Modo plan",
  "chat.planMode.enable": "Activar el modo plan",
  "chat.planMode.disable": "Desactivar el modo plan",
  "chat.planMode.description": "Usa el agente de planificación: solo puede leer y escribir archivos de plan, nunca tu código. Al desactivarlo vuelve al agente anterior.",
  "chat.planMode.unavailable": "El agente de planificación no está disponible en esta sesión.",
