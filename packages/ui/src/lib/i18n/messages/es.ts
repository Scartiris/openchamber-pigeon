...
export const dict: Record<I18nKey, string> = {
  ...
  "contextRail.surface.doc.description": "Previsualiza documentos de Word, Excel, PowerPoint y PDF",
  ...
  "fleet.header.aria": "Estado de la flota: memoria del host {mem} %, disco {disk} %, equipos {online}/{total}",
  "fleet.header.tooltip.title": "Estado de la flota",
  "fleet.header.tooltip.host": "Memoria del host {mem} % · disco {disk} %",
  "fleet.header.tooltip.devices": "Equipos en línea {online}/{total}",
  "fleet.header.tooltip.stale": "Las métricas del host tienen {seconds} s",
  "fleet.header.tooltip.unavailable": "Las métricas del host no están disponibles",
  "fleet.dialog.title": "Estado de la flota",
  "fleet.dialog.description": "Memoria, disco y red del host del workbench y de todos los equipos registrados.",
  "fleet.dialog.refresh": "Actualizar",
  "fleet.dialog.refreshing": "Actualizando…",
  "fleet.dialog.checkedAt": "Recogido hace {seconds} s",
  "fleet.section.host": "Host (este workbench)",
  "fleet.section.devices": "Equipos registrados",
  "fleet.devices.empty": "Aún no hay equipos registrados.",
  "fleet.devices.expand": "Expandir {name}",
  "fleet.devices.collapse": "Contraer {name}",
  "fleet.devices.openSettings": "Abrir ajustes de equipos",
  "fleet.devices.metricsUnavailable": "Métricas no disponibles",
  "fleet.devices.offline": "El equipo está desconectado",
  "fleet.metric.memory": "Memoria",
  "fleet.metric.disk": "Disco",
  "fleet.metric.network": "Red",
  "fleet.metric.networkUnavailable": "No disponible",
  "fleet.metric.load": "Carga",
  "fleet.metric.uptime": "Tiempo activo",
  "fleet.metric.containers": "Contenedores",
  "fleet.metric.swap": "Swap",
  "fleet.metric.rtt": "RTT {ms} ms",
  "fleet.status.online": "En línea",
  "fleet.status.offline": "Desconectado",
  "fleet.error.load": "Estado de la flota HTTP {status}",
  "fleet.error.parse": "No se entendió la respuesta del estado de la flota",
  "fleet.hostHelper.hint": "La columna de red necesita el ayudante oc-host-metrics en el servidor.",
  ...
  "chat.composerMode.build": "Trabajo",
  "chat.composerMode.plan": "Plan",
  "chat.composerMode.chat": "Charla",
  "chat.composerMode.buildDescription": "Trabaja con normalidad: lee, escribe y ejecuta lo que pida la tarea.",
  "chat.composerMode.planDescription": "Primero planifica: solo lee y escribe archivos de plan, sin tocar el código.",
  "chat.composerMode.chatDescription": "Solo charla: no escribe archivos, no ejecuta comandos, no entrega nada.",
  "chat.composerMode.unavailable": "El agente «{mode}» no está disponible.",
  "chat.promptEnhance.action": "Mejorar el prompt",
  "chat.promptEnhance.busy": "Mejorando el prompt…",
  "chat.promptEnhance.applied": "Prompt mejorado ({model})",
  "chat.promptEnhance.undo": "Deshacer",
  "chat.promptEnhance.draftChanged": "El borrador cambió, así que la mejora no se aplicó",
  "chat.promptEnhance.failed": "No se pudo mejorar el prompt",
  "chat.promptEnhance.errorTooLong": "El borrador es más largo de lo que admite este modelo. Acórtalo y vuelve a intentarlo.",
  "chat.promptEnhance.errorUnavailable": "El servidor no puede acceder a este modelo. Revisa sus credenciales o elige un modelo pequeño en Ajustes → Sesiones.",
  "chat.promptEnhance.errorGeneric": "El modelo no devolvió ningún prompt utilizable. Inténtalo de nuevo.",
  ...
  // Artifact Center
  'artifacts.page.title': 'Centro de artefactos',
  'artifacts.list.searchPlaceholder': 'Buscar artefactos…',
  'artifacts.list.loading': 'Cargando…',
  'artifacts.list.retry': 'Reintentar',
  'artifacts.list.empty': 'Aún no hay artefactos. Recoge un archivo del árbol para empezar a versionarlo.',
  'artifacts.list.missing': 'Falta el archivo de origen',
  'artifacts.detail.selectHint': 'Selecciona un artefacto para ver sus versiones.',
  'artifacts.detail.meta': '{size} · actualizado {when}',
  'artifacts.versions.title': 'Versiones',
  'artifacts.versions.count': '{count} versiones',
  'artifacts.versions.tierHot': 'Caliente',
  'artifacts.versions.tierCold': 'Frío (Drive)',
  'artifacts.versions.tierRestoring': 'Recuperando',
  'artifacts.versions.labelPlaceholder': 'Etiqueta de versión…',
  'artifacts.actions.preview': 'Vista previa',
  'artifacts.actions.restore': 'Restaurar',
  'artifacts.actions.pull': 'Traer de Drive',
  'artifacts.actions.saveLabel': 'Guardar etiqueta',
  'artifacts.actions.uncollect': 'Quitar del centro',
  'artifacts.actions.collect': 'Recoger como artefacto',
  'artifacts.actions.openCenter': 'Abrir centro de artefactos',
  'artifacts.actions.openCenterShort': 'Centro',
  'artifacts.status.collectedVersions': '{count} versiones',
  'artifacts.status.notCollected': 'Sin recolectar',
  'artifacts.status.collected': 'Recolectado',
  'artifacts.candidates.title': 'Bandeja de candidatos',
  'artifacts.candidates.count': '{count} candidatos',
  'artifacts.candidates.empty': 'No hay archivos de entrega recientes para recolectar.',
  'artifacts.list.collectedTitle': 'Recolectados',
  'artifacts.sidebar.badgeAria': '{count} artefactos',
  'sessions.sidebar.nav.artifacts': 'Centro de artefatos',
  'artifacts.toast.collected': 'Recogido en el centro de artefactos',
  'artifacts.toast.alreadyCollected': 'Ya está en el centro de artefactos',
  'artifacts.toast.labelSaved': 'Etiqueta de versión guardada',
  'artifacts.toast.labelCleared': 'Etiqueta de versión borrada',
  'artifacts.toast.restored': 'Archivo de origen restaurado desde la versión',
  'artifacts.toast.pulled': 'Versión traída a almacenamiento caliente',
  'artifacts.toast.uncollected': 'Quitado del centro de artefactos',
  'artifacts.restore.dirtyConfirm': 'El archivo de origen tiene cambios sin capturar. ¿Restaurar y sobrescribir de todos modos?',
  'commandPalette.item.openArtifactCenter': 'Abrir centro de artefactos',
  // Google Drive cold tier
  'settings.integrations.googleDrive.title': 'Google Drive',
  'settings.integrations.googleDrive.description': 'Capa fría para versiones del centro de artefactos. El servidor necesita un cliente OAuth de Drive.',
  'settings.integrations.googleDrive.status.notConfigured': 'Sin configurar en este servidor',
  'settings.integrations.googleDrive.status.connected': 'Conectado',
  'settings.integrations.googleDrive.status.notConnected': 'Sin conectar',
  ...
  'settings.integrations.googleDrive.actions.refresh': 'Actualizar',
  'settings.integrations.googleDrive.toast.authOpened': 'Completa el inicio de sesión de Google en la ventana abierta',
  ...
  'header.workspaceEntry.label': 'Área del taller',
  'header.workspaceEntry.hint': 'La barra lateral solo muestra las sesiones de esta área.',
  'header.workspaceEntry.code': 'Código',
  'header.workspaceEntry.work': 'Trabajo',
  ...
  // Document preview
  "documentPreview.actions.download": "Descargar original",
  ...
  "documentPreview.error.tooLarge": "Este archivo es demasiado grande para previsualizarlo.",
  "documentPreview.error.unsupported": "Este tipo de archivo no se puede previsualizar.",
  "chat.fileLink.previewTitle": "Haz clic para previsualizar",
  "filesView.actions.openDocumentPreview": "Abrir vista previa de documentos",
  // Estadísticas de uso de tokens (barra superior)
  'tokenUsage.header.aria': 'Abrir estadísticas de uso de tokens',
  'tokenUsage.header.tooltip': 'Hoy: {tokens} tokens',
  'tokenUsage.period.today': 'Hoy',
  'tokenUsage.period.last7Days': 'Últimos 7 días',
  'tokenUsage.period.last30Days': 'Últimos 30 días',
  'tokenUsage.dialog.title': 'Uso de tokens',
  'tokenUsage.dialog.description': 'Consumo de tokens por periodo, modelo y aciertos de caché.',
  'tokenUsage.dialog.byModel': 'Por modelo',
  'tokenUsage.dialog.empty': 'Sin uso de tokens en este periodo.',
  'tokenUsage.dialog.unknownModel': 'Modelo desconocido',
  'tokenUsage.dialog.cacheHitValue': 'Aciertos de caché {percent}%',
  'tokenUsage.dialog.refresh': 'Actualizar',
  'tokenUsage.dialog.refreshAria': 'Actualizar uso de tokens',
  'tokenUsage.dialog.loading': 'Recopilando uso de tokens…',
  'tokenUsage.dialog.partial': 'No se pudieron leer {failed} de {scanned} sesiones.',
  'tokenUsage.stats.input': 'Entrada',
  'tokenUsage.stats.output': 'Salida',
  'tokenUsage.stats.reasoning': 'Razonamiento',
  'tokenUsage.stats.cacheRead': 'Lectura de caché',
  'tokenUsage.stats.cacheWrite': 'Escritura de caché',
  'tokenUsage.stats.cacheHit': 'Aciertos de caché',
  ...
  'toolDisplayName.openvikingSearch': 'Búsqueda OpenViking',
  'toolDisplayName.openvikingFind': 'Buscar en OpenViking',
  'toolDisplayName.openvikingRemember': 'Recordar en OpenViking',
  'toolDisplayName.openvikingRead': 'Leer OpenViking',
  'toolDisplayName.openvikingList': 'Listar OpenViking',
  'toolDisplayName.openvikingTree': 'Árbol OpenViking',
  'toolDisplayName.openvikingGrep': 'Grep OpenViking',
  'toolDisplayName.openvikingGlob': 'Glob OpenViking',
  'toolDisplayName.openvikingWrite': 'Escribir OpenViking',
  'toolDisplayName.openvikingEdit': 'Editar OpenViking',
  'toolDisplayName.openvikingAddResource': 'Añadir recurso OpenViking',
  'toolDisplayName.openvikingForget': 'Olvidar OpenViking',
  'toolDisplayName.openvikingListWatches': 'Listar vigilancias OpenViking',
  'toolDisplayName.openvikingCancelWatch': 'Cancelar vigilancia OpenViking',
  'toolDisplayName.openvikingHealth': 'Estado de OpenViking',
  'sessions.sidebar.session.fork.toast.forkedFrom': 'Derivada de {title}',
  'sessions.sidebar.session.fork.toast.failed': 'No se pudo derivar la sesión',
  'header.sessions.untitled': 'Sesión sin título',
  'settings.menu.opencodeStatusFailed': 'No se pudo leer el estado de OpenCode',
  'tray.respondPermissionFailed': 'No se pudo responder a la solicitud de permiso',
  'session.newWorktree.toast.noActiveProject': 'No hay un proyecto activo',
  'session.newWorktree.toast.notGitRepository': 'Este directorio no es un repositorio Git',
  'chat.toolPart.subagent.waiting': 'Esperando actividad del subagente…',
  'chat.toolPart.subagent.missingSessionId': 'No hay ID de sesión de subagente en los metadatos de la tarea.',
  'chat.toolOutputDialog.labels.command': 'Comando:',
  'chat.toolOutputDialog.labels.task': 'Detalles de la tarea:',
  'chat.toolOutputDialog.labels.input': 'Entrada:',
  'chat.toolOutputDialog.imagePreview': 'Vista previa de la imagen',
  'settings.commands.sidebar.toast.commandRenamed': 'Comando "{name}" renombrado',
  'agentManager.view.toast.creatingGroup': 'Creando el grupo de agentes "{name}" con {count} ejecución(es)...',
  'agentManager.view.toast.groupCreated': 'Grupo de agentes "{name}" creado con {count} sesión(es)',
  'header.services.remoteUpdate.checkFailed': 'No se pudo comprobar si hay actualizaciones de la instancia remota',
  'settings.remoteInstances.page.forward.localTarget': 'Destino local',
  'settings.remoteInstances.page.forward.localListen': 'Escucha local',
  'settings.remoteInstances.page.forward.remoteListen': 'Escucha remota',
  'settings.remoteInstances.page.forward.remoteTarget': 'Destino remoto',
  'settings.remoteInstances.page.forward.localTargetHint': 'Host y puerto locales en tu máquina que reciben el tráfico del oyente remoto -R.',
  'settings.remoteInstances.page.forward.localListenHint': 'Host y puerto locales donde esta redirección escucha en tu máquina.',
  'settings.remoteInstances.page.forward.remoteListenHint': 'Host y puerto remotos donde SSH crea el oyente -R.',
  'settings.remoteInstances.page.forward.remoteTargetHint': 'Host y puerto remotos que reciben el tráfico del oyente local -L.',
  'chat.toolOutputDialog.taskFields.task': 'Tarea:',
  'chat.toolOutputDialog.taskFields.agentType': 'Tipo de agente:',
  'chat.toolOutputDialog.taskFields.instructions': 'Instrucciones:',
  'gitView.toast.removeRemoteFailed': 'No se pudo quitar el remoto {name}',
  'gitView.toast.upstreamSetFailed': 'No se pudo configurar el upstream',
  'gitView.toast.mergeFailed': 'No se pudo fusionar {branch}',
  'gitView.toast.rebaseFailed': 'No se pudo hacer rebase sobre {branch}',
  'contextSidebar.message.userLabel': 'Usuario:',
  'artifacts.toast.collectFailed': 'No se pudo recoplar este archivo como artefacto',
  'guests.host.notGranted': 'El usuario no ha permitido esta capacidad para la extensión.',
  'guests.host.extensionUnavailable': 'La extensión no está disponible.',
  'guests.host.extensionDisabled': 'Esta extensión está desactivada en Ajustes → Extensiones.',
  'guests.host.requestFailed': 'La solicitud falló.',
  'guests.host.noProject': 'No hay ningún proyecto abierto.',
  'guests.host.operationFailed': 'Falló la operación de la extensión.',
  'guests.service.noService': 'No hay servicio disponible para esta extensión.',
  'serverMessage.opencode.configReloaded': 'Configuración recargada correctamente. Actualizando la interfaz…',
  'serverMessage.opencode.manualRestart': 'Guardado en disco. Reinicia el servidor OpenCode conectado para aplicar los cambios.',
  'serverMessage.session.interruptedByRestart': 'Interrumpido por el reinicio de OpenCode',
  'serverMessage.session.interruptedByRestartDetail': 'El turno en ejecución se interrumpió al reiniciar OpenCode.',
  'serverMessage.opencode.restartToApply': 'Guardado. Reinicia OpenCode para aplicar.',
  'serverMessage.opencode.noSkillsInstalled': 'No se instaló ninguna skill',
  'serverMessage.git.statusFailed': 'No se pudo obtener el estado de Git',
  'serverMessage.git.diffFailed': 'No se pudo cargar el diff de Git',
  'serverMessage.git.pushFailed': 'Error al hacer push',
  'serverMessage.git.pullFailed': 'Error al hacer pull',
  'serverMessage.git.branchesFailed': 'No se pudo cargar las ramas',
  'serverMessage.git.remotesFailed': 'No se pudo cargar los remotos',
  'serverMessage.git.mergeFailed': 'Error al fusionar',
  'serverMessage.git.removeRemoteFailed': 'No se pudo quitar el remoto',
  'configUpdate.updatingOpenCode': 'Actualizando la configuración de OpenCode…',
  'configUpdate.creatingCommand': 'Creando la configuración del comando…',
  'configUpdate.updatingCommand': 'Actualizando la configuración del comando…',
  'configUpdate.deletingCommand': 'Eliminando la configuración del comando…',
  'configUpdate.creatingSkill': 'Creando la skill…',
  'configUpdate.updatingSkill': 'Actualizando la skill…',
  'configUpdate.renamingSkill': 'Renombrando la skill…',
  'configUpdate.deletingSkill': 'Eliminando la skill…',
  'configUpdate.installingSkills': 'Instalando skills…',
  'configUpdate.creatingMcp': 'Creando la configuración del servidor MCP…',
  'configUpdate.updatingMcp': 'Actualizando la configuración del servidor MCP…',
  'configUpdate.deletingMcp': 'Eliminando la configuración del servidor MCP…',
  'configUpdate.creatingAgent': 'Creando la configuración del agente…',
  'configUpdate.updatingAgent': 'Actualizando la configuración del agente…',
  'configUpdate.deletingAgent': 'Eliminando la configuración del agente…',
  'configUpdate.reloadingOpenCode': 'Recargando la configuración de OpenCode…',
};
