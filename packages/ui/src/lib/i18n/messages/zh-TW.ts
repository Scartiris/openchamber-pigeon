...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.planMode.label': '計劃模式',
  'chat.planMode.enable': '開啟計劃模式',
  'chat.planMode.disable': '關閉計劃模式',
  'chat.planMode.description': '使用「計劃」智慧體：只能讀取檔案、寫計畫檔，不改程式碼。關閉後回到上一個智慧體。',
  'chat.planMode.unavailable': '目前工作階段沒有可用的「計劃」智慧體。',
