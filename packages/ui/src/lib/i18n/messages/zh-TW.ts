...
export const dict: Record<I18nKey, string> = {
  ...
  // Document preview
  'contextPanel.mode.doc': '文件',
  'contextRail.surface.doc.description': '預覽 Word、Excel、PowerPoint 與 PDF 文件',
  ...
  'fleet.header.aria': '機隊狀態：宿主記憶體 {mem}%、磁碟 {disk}%、裝置 {online}/{total}',
  'fleet.header.tooltip.title': '機隊狀態',
  'fleet.header.tooltip.host': '宿主記憶體 {mem}% · 磁碟 {disk}%',
  'fleet.header.tooltip.devices': '裝置在線 {online}/{total}',
  'fleet.header.tooltip.stale': '宿主指標已過期 {seconds} 秒',
  'fleet.header.tooltip.unavailable': '宿主指標不可用',
  'fleet.dialog.title': '機隊狀態',
  'fleet.dialog.description': '工作台宿主與所有已註冊裝置的記憶體、磁碟與網路。',
  'fleet.dialog.refresh': '重新整理',
  'fleet.dialog.refreshing': '重新整理中…',
  'fleet.dialog.checkedAt': '{seconds} 秒前收集',
  ...
  'fleet.metric.memory': '記憶體',
  'fleet.metric.disk': '磁碟',
  'fleet.metric.network': '網路',
  'fleet.metric.networkUnavailable': '不可用',
  'fleet.metric.load': '負載',
  'fleet.metric.uptime': '運行時長',
  'fleet.metric.containers': '容器',
  'fleet.metric.swap': '交換分區',
  'fleet.metric.rtt': '往返延遲 {ms} ms',
  'fleet.status.online': '在線',
  'fleet.status.offline': '離線',
  'fleet.error.load': '機隊狀態 HTTP {status}',
  'fleet.error.parse': '機隊狀態回應無法解析',
  'fleet.hostHelper.hint': '網路一欄需要伺服器上的 oc-host-metrics 收集器。',
  ...
  'chat.composerMode.label': '對話模式',
  'chat.composerMode.build': '施工',
  'chat.composerMode.plan': '計劃',
  'chat.composerMode.chat': '聊天',
  'chat.composerMode.buildDescription': '正常施工：讀寫檔案、執行命令，依任務交付產物。',
  'chat.composerMode.planDescription': '先出方案：只讀檔案、只寫計畫檔，不改程式碼。',
  'chat.composerMode.chatDescription': '純聊天：不寫檔案、不執行命令、不交付產物。',
  'chat.composerMode.unavailable': '「{mode}」智慧體目前無法使用。',
  'chat.promptEnhance.action': '最佳化提示詞',
  'chat.promptEnhance.busy': '正在最佳化提示詞…',
  'chat.promptEnhance.applied': '提示詞已最佳化（{model}）',
  'chat.promptEnhance.undo': '復原',
  'chat.promptEnhance.draftChanged': '草稿已變更，最佳化結果未套用',
  'chat.promptEnhance.failed': '提示詞最佳化失敗',
  'chat.promptEnhance.errorTooLong': '內容比這個模型能接收的還長，請縮短後再試。',
  'chat.promptEnhance.errorUnavailable': '伺服器無法呼叫這個模型。請檢查它的憑證，或在「設定 → 工作階段 → 小模型」改用其他模型。',
  'chat.promptEnhance.errorGeneric': '模型沒有回傳可用的提示詞，請再試一次。',
  ...
  'agents.builtin.build': '建置',
  'agents.builtin.plan': '計劃',
  ...
  // Artifact Center
  'artifacts.page.title': '產物中心',
  'artifacts.list.searchPlaceholder': '搜尋產物…',
  'artifacts.list.loading': '載入中…',
  'artifacts.list.retry': '重試',
  'artifacts.list.empty': '尚未收集產物。在檔案樹將檔案「收集為產物」即可開始版本管理。',
  'artifacts.list.missing': '來源檔案已遺失',
  'artifacts.detail.selectHint': '選擇一個產物以檢視版本。',
  'artifacts.detail.meta': '{size} · 更新於 {when}',
  'artifacts.versions.title': '版本',
  'artifacts.versions.count': '{count} 個版本',
  'artifacts.versions.tierHot': '熱存',
  'artifacts.versions.tierCold': '冷存（Drive）',
  'artifacts.versions.tierRestoring': '拉取中',
  'artifacts.versions.labelPlaceholder': '版本備註…',
  'artifacts.actions.preview': '預覽',
  'artifacts.actions.restore': '回滾',
  'artifacts.actions.pull': '自 Drive 拉回',
  'artifacts.actions.saveLabel': '儲存備註',
  'artifacts.actions.uncollect': '移出中心',
  'artifacts.actions.collect': '收集為產物',
  'artifacts.actions.openCenter': '開啟產物中心',
  'artifacts.actions.openCenterShort': '中心',
  'artifacts.status.collectedVersions': '{count} 個版本',
  'artifacts.status.notCollected': '未收集',
  'artifacts.status.collected': '已在產物中心',
  'artifacts.candidates.title': '候選收件',
  'artifacts.candidates.count': '{count} 個候選',
  'artifacts.candidates.empty': '最近沒有可收集的交付檔案。',
  'artifacts.list.collectedTitle': '已收集',
  'artifacts.sidebar.badgeAria': '{count} 個產物',
  'sessions.sidebar.nav.artifacts': '產物中心',
  'artifacts.toast.collected': '已收入產物中心',
  'artifacts.toast.alreadyCollected': '該檔案已在產物中心',
  'artifacts.toast.labelSaved': '版本備註已儲存',
  'artifacts.toast.labelCleared': '版本備註已清除',
  'artifacts.toast.restored': '已用該版本回滾來源檔案',
  'artifacts.toast.pulled': '版本已拉回熱存',
  'artifacts.toast.uncollected': '已移出產物中心',
  'artifacts.restore.dirtyConfirm': '來源檔案有尚未快照的變更。仍要回滾並覆寫它們嗎？',
  'commandPalette.item.openArtifactCenter': '開啟產物中心',
  // Google Drive cold tier
  'settings.integrations.googleDrive.title': 'Google Drive',
  'settings.integrations.googleDrive.description': '產物中心版本的冷儲存。伺服器需設定 Drive OAuth 用戶端。',
  'settings.integrations.googleDrive.status.notConfigured': '本伺服器未設定',
  'settings.integrations.googleDrive.status.connected': '已連線',
  'settings.integrations.googleDrive.status.notConnected': '未連線',
  'settings.integrations.googleDrive.actions.connect': '連線',
  'settings.integrations.googleDrive.actions.disconnect': '中斷',
  'settings.integrations.googleDrive.actions.refresh': '重新整理',
  'settings.integrations.googleDrive.toast.authOpened': '請在開啟的視窗完成 Google 登入',
  'settings.integrations.googleDrive.toast.disconnected': '已中斷 Google Drive',
  ...
  'header.workspaceEntry.label': '工作台入口',
  'header.workspaceEntry.hint': '側欄只列出這一區的會話。',
  'header.workspaceEntry.code': '程式碼',
  'header.workspaceEntry.work': '工作',
  ...
  // Document preview
  'documentPreview.actions.download': '下載原件',
  ...
  'documentPreview.error.tooLarge': '檔案過大，無法預覽。',
  'documentPreview.error.unsupported': '此檔案類型無法預覽。',
  'chat.fileLink.previewTitle': '點擊預覽',
  'filesView.actions.openDocumentPreview': '開啟文件預覽',
  // Token 消耗統計（頂欄）
  'tokenUsage.header.aria': '開啟 Token 消耗統計',
  'tokenUsage.header.tooltip': '今日：{tokens} Token',
  'tokenUsage.period.today': '今日',
  'tokenUsage.period.last7Days': '近 7 天',
  'tokenUsage.period.last30Days': '近 30 天',
  'tokenUsage.dialog.title': 'Token 消耗',
  'tokenUsage.dialog.description': '依週期、模型與快取命中檢視 Token 消耗。',
  'tokenUsage.dialog.byModel': '依模型',
  'tokenUsage.dialog.empty': '此時段尚無 Token 消耗。',
  'tokenUsage.dialog.unknownModel': '未知模型',
  'tokenUsage.dialog.cacheHitValue': '快取命中 {percent}%',
  'tokenUsage.dialog.refresh': '重新整理',
  'tokenUsage.dialog.refreshAria': '重新整理 Token 消耗',
  'tokenUsage.dialog.loading': '正在統計 Token 消耗…',
  'tokenUsage.dialog.partial': '{scanned} 個工作階段中有 {failed} 個無法讀取。',
  'tokenUsage.stats.input': '輸入',
  'tokenUsage.stats.output': '輸出',
  'tokenUsage.stats.reasoning': '推理',
  ...
  'toolDisplayName.openvikingSearch': 'OpenViking 語意檢索',
  'toolDisplayName.openvikingFind': 'OpenViking 快速查找',
  'toolDisplayName.openvikingRemember': 'OpenViking 記憶寫入',
  'toolDisplayName.openvikingRead': 'OpenViking 讀取',
  'toolDisplayName.openvikingList': 'OpenViking 列出目錄',
  'toolDisplayName.openvikingTree': 'OpenViking 目錄樹',
  'toolDisplayName.openvikingGrep': 'OpenViking 精確搜尋',
  'toolDisplayName.openvikingGlob': 'OpenViking 模式匹配',
  'toolDisplayName.openvikingWrite': 'OpenViking 寫入',
  'toolDisplayName.openvikingEdit': 'OpenViking 編輯',
  'toolDisplayName.openvikingAddResource': 'OpenViking 新增資源',
  'toolDisplayName.openvikingForget': 'OpenViking 遺忘刪除',
  'toolDisplayName.openvikingListWatches': 'OpenViking 檢視監看任務',
  'toolDisplayName.openvikingCancelWatch': 'OpenViking 取消監看',
  'toolDisplayName.openvikingHealth': 'OpenViking 健康檢查',
  'sessions.sidebar.session.fork.toast.forkedFrom': '已從 {title} 衍生',
  'sessions.sidebar.session.fork.toast.failed': '無法衍生工作階段',
  'header.sessions.untitled': '未命名工作階段',
  'settings.menu.opencodeStatusFailed': '無法取得 OpenCode 狀態',
  'tray.respondPermissionFailed': '無法回應權限請求',
  'session.newWorktree.toast.noActiveProject': '沒有活動專案',
  'session.newWorktree.toast.notGitRepository': '目前目錄不是 Git 儲存庫',
  'chat.toolPart.subagent.waiting': '正在等待子代理活動…',
  'chat.toolPart.subagent.missingSessionId': '任務中繼資料中沒有子代理工作階段 ID。',
  'chat.toolOutputDialog.labels.command': '命令：',
  'chat.toolOutputDialog.labels.task': '任務詳情：',
  'chat.toolOutputDialog.labels.input': '輸入：',
  'chat.toolOutputDialog.imagePreview': '圖片預覽',
  'settings.commands.sidebar.toast.commandRenamed': '命令「{name}」已重新命名',
  'agentManager.view.toast.creatingGroup': '正在建立智慧體群組「{name}」，共 {count} 個執行…',
  'agentManager.view.toast.groupCreated': '智慧體群組「{name}」已建立，共 {count} 個工作階段',
  'header.services.remoteUpdate.checkFailed': '無法檢查遠端實例更新',
  'settings.remoteInstances.page.forward.localTarget': '本機目標',
  'settings.remoteInstances.page.forward.localListen': '本機監聽',
  'settings.remoteInstances.page.forward.remoteListen': '遠端監聽',
  'settings.remoteInstances.page.forward.remoteTarget': '遠端目標',
  'settings.remoteInstances.page.forward.localTargetHint': '本機上接收遠端 -R 監聽流量的主機與連接埠。',
  'settings.remoteInstances.page.forward.localListenHint': '本機上此轉發開始監聽的主機與連接埠。',
  'settings.remoteInstances.page.forward.remoteListenHint': 'SSH 建立 -R 監聽的遠端主機與連接埠。',
  'settings.remoteInstances.page.forward.remoteTargetHint': '接收本機 -L 監聽流量的遠端主機與連接埠。',
  'chat.toolOutputDialog.taskFields.task': '任務：',
  'chat.toolOutputDialog.taskFields.agentType': '智慧體類型：',
  'chat.toolOutputDialog.taskFields.instructions': '指令：',
  'gitView.toast.removeRemoteFailed': '移除遠端 {name} 失敗',
  'gitView.toast.upstreamSetFailed': '設定上游失敗',
  'gitView.toast.mergeFailed': '合併 {branch} 失敗',
  'gitView.toast.rebaseFailed': '變基到 {branch} 失敗',
  'contextSidebar.message.userLabel': '使用者：',
  'artifacts.toast.collectFailed': '無法將此檔案收集為成品',
  'guests.host.notGranted': '使用者尚未允許該擴充使用此能力。',
  'guests.host.extensionUnavailable': '擴充無法使用。',
  'guests.host.extensionDisabled': '該擴充已在「設定 → 擴充」中停用。',
  'guests.host.requestFailed': '請求失敗。',
  'guests.host.noProject': '目前沒有開啟的專案。',
  'guests.host.operationFailed': '擴充操作失敗。',
  'guests.service.noService': '該擴充沒有可用的本機服務。',
  'serverMessage.opencode.configReloaded': '設定重新載入成功。正在重新整理介面…',
  'serverMessage.opencode.manualRestart': '已儲存到磁碟。請重新啟動已連線的 OpenCode 伺服器以套用變更。',
  'serverMessage.session.interruptedByRestart': '因 OpenCode 重新啟動而中斷',
  'serverMessage.session.interruptedByRestartDetail': '目前回合在 OpenCode 重新啟動時被中斷。',
  'serverMessage.opencode.restartToApply': '已儲存。請重新啟動 OpenCode 以套用。',
  'serverMessage.opencode.noSkillsInstalled': '沒有安裝任何技能',
  'serverMessage.git.statusFailed': '無法取得 Git 狀態',
  'serverMessage.git.diffFailed': '無法載入 Git 差異',
  'serverMessage.git.pushFailed': '推送失敗',
  'serverMessage.git.pullFailed': '拉取失敗',
  'serverMessage.git.branchesFailed': '無法載入分支',
  'serverMessage.git.remotesFailed': '無法載入遠端儲存庫',
  'serverMessage.git.mergeFailed': '合併失敗',
  'serverMessage.git.removeRemoteFailed': '移除遠端儲存庫失敗',
  'configUpdate.updatingOpenCode': '正在更新 OpenCode 設定…',
  'configUpdate.creatingCommand': '正在建立命令設定…',
  'configUpdate.updatingCommand': '正在更新命令設定…',
  'configUpdate.deletingCommand': '正在刪除命令設定…',
  'configUpdate.creatingSkill': '正在建立技能…',
  'configUpdate.updatingSkill': '正在更新技能…',
  'configUpdate.renamingSkill': '正在重新命名技能…',
  'configUpdate.deletingSkill': '正在刪除技能…',
  'configUpdate.installingSkills': '正在安裝技能…',
  'configUpdate.creatingMcp': '正在建立 MCP 伺服器設定…',
  'configUpdate.updatingMcp': '正在更新 MCP 伺服器設定…',
  'configUpdate.deletingMcp': '正在刪除 MCP 伺服器設定…',
  'configUpdate.creatingAgent': '正在建立智慧體設定…',
  'configUpdate.updatingAgent': '正在更新智慧體設定…',
  'configUpdate.deletingAgent': '正在刪除智慧體設定…',
  'configUpdate.reloadingOpenCode': '正在重新載入 OpenCode 設定…',
};
