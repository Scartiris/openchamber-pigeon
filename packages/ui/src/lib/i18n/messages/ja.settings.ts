...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': 'チャット背面の動画壁紙',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': 'メッセージの背後で動画をループ再生します。サイドバー・パネル・ポップオーバーは不透明のままです。デスクトップのみ。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.openchamber.visual.section.chatBackdrop': 'チャット背景',
