...
export const dict = {
  ...
  'fleet.header.aria': 'Fleet status: host memory {mem}%, disk {disk}%, devices {online}/{total}',
  'fleet.header.tooltip.title': 'Fleet status',
  'fleet.header.tooltip.host': 'Host memory {mem}% · disk {disk}%',
  'fleet.header.tooltip.devices': 'Devices online {online}/{total}',
  'fleet.header.tooltip.stale': 'Host metrics are {seconds}s old',
  'fleet.header.tooltip.unavailable': 'Host metrics are unavailable',
  'fleet.dialog.title': 'Fleet status',
  'fleet.dialog.description': 'Memory, disk and network of the workbench host and every registered device.',
  'fleet.dialog.refresh': 'Refresh',
  'fleet.dialog.refreshing': 'Refreshing…',
  'fleet.dialog.checkedAt': 'Collected {seconds}s ago',
  ...
  'fleet.metric.memory': 'Memory',
  'fleet.metric.disk': 'Disk',
  'fleet.metric.network': 'Network',
  'fleet.metric.networkUnavailable': 'Unavailable',
  'fleet.metric.load': 'Load',
  'fleet.metric.uptime': 'Uptime',
  'fleet.metric.containers': 'Containers',
  'fleet.metric.swap': 'Swap',
  'fleet.metric.rtt': 'RTT {ms} ms',
  'fleet.status.online': 'Online',
  'fleet.status.offline': 'Offline',
  'fleet.error.load': 'Fleet status HTTP {status}',
  'fleet.error.parse': 'Fleet status response was not understood',
  'fleet.hostHelper.hint': 'The network column needs the oc-host-metrics helper on the server.',
  ...
  'chat.composerMode.label': 'Composer mode',
  'chat.composerMode.build': 'Build',
  'chat.composerMode.plan': 'Plan',
  'chat.composerMode.chat': 'Chat',
  'chat.composerMode.buildDescription': 'Works normally: reads, writes and runs whatever the task needs.',
  'chat.composerMode.planDescription': 'Plans first: reads and writes plan files only, and changes no code.',
  'chat.composerMode.chatDescription': 'Chat only: no files written, no commands run, nothing delivered.',
  'chat.composerMode.unavailable': 'The “{mode}” agent is not available.',
  'chat.promptEnhance.action': 'Enhance prompt',
  'chat.promptEnhance.busy': 'Enhancing prompt…',
  'chat.promptEnhance.applied': 'Prompt enhanced ({model})',
  'chat.promptEnhance.undo': 'Undo',
  'chat.promptEnhance.draftChanged': 'The draft changed, so the enhanced prompt was not applied',
  'chat.promptEnhance.failed': 'Could not enhance the prompt',
  'chat.promptEnhance.errorTooLong': 'The draft is longer than this model can take. Shorten it and try again.',
  'chat.promptEnhance.errorUnavailable': 'The server cannot reach this model. Check its credentials, or pick a Small Model in Settings → Sessions.',
  'chat.promptEnhance.errorGeneric': 'The model returned no usable prompt. Try again.',
  ...
  // Artifact Center
  'artifacts.page.title': 'Artifact Center',
  'artifacts.list.searchPlaceholder': 'Search artifacts…',
  'artifacts.list.loading': 'Loading…',
  'artifacts.list.retry': 'Retry',
  'artifacts.list.empty': 'No artifacts collected yet. Collect a file from the file tree to start versioning it.',
  'artifacts.list.missing': 'Source file missing',
  'artifacts.detail.selectHint': 'Select an artifact to see its versions.',
  'artifacts.detail.meta': '{size} · updated {when}',
  'artifacts.versions.title': 'Versions',
  'artifacts.versions.count': '{count} versions',
  'artifacts.versions.tierHot': 'Hot',
  'artifacts.versions.tierCold': 'Cold (Drive)',
  'artifacts.versions.tierRestoring': 'Restoring',
  'artifacts.versions.labelPlaceholder': 'Version label…',
  'artifacts.actions.preview': 'Preview',
  'artifacts.actions.restore': 'Restore',
  'artifacts.actions.pull': 'Pull from Drive',
  'artifacts.actions.saveLabel': 'Save label',
  'artifacts.actions.uncollect': 'Remove from center',
  'artifacts.actions.collect': 'Collect as artifact',
  'artifacts.actions.openCenter': 'Open Artifact Center',
  'artifacts.actions.openCenterShort': 'Center',
  'artifacts.status.collectedVersions': '{count} versions',
  'artifacts.status.notCollected': 'Not collected',
  'artifacts.status.collected': 'Collected',
  'artifacts.candidates.title': 'Candidate inbox',
  'artifacts.candidates.count': '{count} candidates',
  'artifacts.candidates.empty': 'No recent deliverable files to collect.',
  'artifacts.list.collectedTitle': 'Collected',
  'artifacts.sidebar.badgeAria': '{count} artifacts',
  'sessions.sidebar.nav.artifacts': 'Artifact Center',
  'artifacts.toast.collected': 'Collected into Artifact Center',
  'artifacts.toast.alreadyCollected': 'Already in Artifact Center',
  'artifacts.toast.labelSaved': 'Version label saved',
  'artifacts.toast.labelCleared': 'Version label cleared',
  'artifacts.toast.restored': 'Restored source file from version',
  'artifacts.toast.pulled': 'Version pulled back to hot storage',
  'artifacts.toast.uncollected': 'Removed from Artifact Center',
  'artifacts.restore.dirtyConfirm': 'The source file has unsnapshotted changes. Restore anyway and overwrite them?',
  'commandPalette.item.openArtifactCenter': 'Open Artifact Center',
  // Google Drive cold tier
  'settings.integrations.googleDrive.title': 'Google Drive',
  'settings.integrations.googleDrive.description': 'Cold tier for Artifact Center versions. Needs a Drive OAuth client on the server.',
  'settings.integrations.googleDrive.status.notConfigured': 'Not configured on this server',
  'settings.integrations.googleDrive.status.connected': 'Connected',
  'settings.integrations.googleDrive.status.notConnected': 'Not connected',
  'settings.integrations.googleDrive.actions.connect': 'Connect',
  'settings.integrations.googleDrive.actions.disconnect': 'Disconnect',
  'settings.integrations.googleDrive.actions.refresh': 'Refresh',
  'settings.integrations.googleDrive.toast.authOpened': 'Finish Google sign-in in the opened window',
  'settings.integrations.googleDrive.toast.disconnected': 'Google Drive disconnected',
  ...
  'header.workspaceEntry.label': 'Workbench entry',
  'header.workspaceEntry.hint': 'The sidebar lists only the sessions of this entry.',
  'header.workspaceEntry.code': 'Code',
  'header.workspaceEntry.work': 'Work',
  ...
  'toolDisplayName.openvikingSearch': 'OpenViking Search',
  'toolDisplayName.openvikingFind': 'OpenViking Find',
  'toolDisplayName.openvikingRemember': 'OpenViking Remember',
  'toolDisplayName.openvikingRead': 'OpenViking Read',
  'toolDisplayName.openvikingList': 'OpenViking List',
  'toolDisplayName.openvikingTree': 'OpenViking Tree',
  'toolDisplayName.openvikingGrep': 'OpenViking Grep',
  'toolDisplayName.openvikingGlob': 'OpenViking Glob',
  'toolDisplayName.openvikingWrite': 'OpenViking Write',
  'toolDisplayName.openvikingEdit': 'OpenViking Edit',
  'toolDisplayName.openvikingAddResource': 'OpenViking Add Resource',
  'toolDisplayName.openvikingForget': 'OpenViking Forget',
  'toolDisplayName.openvikingListWatches': 'OpenViking List Watches',
  'toolDisplayName.openvikingCancelWatch': 'OpenViking Cancel Watch',
  'toolDisplayName.openvikingHealth': 'OpenViking Health',
  'sessions.sidebar.session.fork.toast.forkedFrom': 'Forked from {title}',
  'sessions.sidebar.session.fork.toast.failed': 'Could not fork the session',
  'header.sessions.untitled': 'Untitled Session',
  'settings.menu.opencodeStatusFailed': 'Could not read OpenCode status',
  'tray.respondPermissionFailed': 'Could not respond to the permission request',
  'session.newWorktree.toast.noActiveProject': 'No active project',
  'session.newWorktree.toast.notGitRepository': 'This directory is not a Git repository',
  ...
  'chat.toolOutputDialog.labels.command': 'Command:',
  'chat.toolOutputDialog.labels.task': 'Task Details:',
  'chat.toolOutputDialog.labels.input': 'Input:',
  'chat.toolOutputDialog.imagePreview': 'Image preview',
  'settings.commands.sidebar.toast.commandRenamed': 'Command "{name}" renamed',
  'agentManager.view.toast.creatingGroup': 'Creating agent group "{name}" with {count} run(s)...',
  'agentManager.view.toast.groupCreated': 'Agent group "{name}" created with {count} session(s)',
  'header.services.remoteUpdate.checkFailed': 'Could not check for remote instance updates',
  'settings.remoteInstances.page.forward.localTarget': 'Local target',
  'settings.remoteInstances.page.forward.localListen': 'Local listen',
  'settings.remoteInstances.page.forward.remoteListen': 'Remote listen',
  'settings.remoteInstances.page.forward.remoteTarget': 'Remote target',
  'settings.remoteInstances.page.forward.localTargetHint': 'Local host and port on your machine that receives traffic from the remote -R listener.',
  'settings.remoteInstances.page.forward.localListenHint': 'Local host and port where this forward listens on your machine.',
  'settings.remoteInstances.page.forward.remoteListenHint': 'Remote host and port where SSH creates the -R listener.',
  'settings.remoteInstances.page.forward.remoteTargetHint': 'Remote host and port that receive traffic from the local -L listener.',
  'chat.toolOutputDialog.taskFields.task': 'Task:',
  'chat.toolOutputDialog.taskFields.agentType': 'Agent Type:',
  'chat.toolOutputDialog.taskFields.instructions': 'Instructions:',
  'gitView.toast.removeRemoteFailed': 'Failed to remove remote {name}',
  'gitView.toast.upstreamSetFailed': 'Failed to set upstream',
  'gitView.toast.mergeFailed': 'Failed to merge {branch}',
  'gitView.toast.rebaseFailed': 'Failed to rebase onto {branch}',
  'contextSidebar.message.userLabel': 'User:',
  'artifacts.toast.collectFailed': 'Failed to collect this file as an artifact',
  'guests.host.notGranted': 'The user has not allowed this capability for the extension.',
  'guests.host.extensionUnavailable': 'Extension is unavailable.',
  'guests.host.extensionDisabled': 'This extension is disabled in Settings → Extensions.',
  'guests.host.requestFailed': 'Request failed.',
  'guests.host.noProject': 'No project is open.',
  'guests.host.operationFailed': 'Extension operation failed.',
  'guests.service.noService': 'No service is available for this extension.',
  'serverMessage.opencode.configReloaded': 'Configuration reloaded successfully. Refreshing interface…',
  'serverMessage.opencode.manualRestart': 'Saved to disk. Restart the connected OpenCode server to apply the changes.',
  'serverMessage.session.interruptedByRestart': 'Interrupted by OpenCode restart',
  'serverMessage.session.interruptedByRestartDetail': 'The running turn was interrupted when OpenCode restarted.',
  'serverMessage.opencode.restartToApply': 'Saved. Restart OpenCode to apply.',
  'serverMessage.opencode.noSkillsInstalled': 'No skills were installed',
  'serverMessage.git.statusFailed': 'Failed to get git status',
  'serverMessage.git.diffFailed': 'Failed to load the Git diff',
  'serverMessage.git.pushFailed': 'Failed to push',
  'serverMessage.git.pullFailed': 'Failed to pull',
  'serverMessage.git.branchesFailed': 'Failed to load branches',
  'serverMessage.git.remotesFailed': 'Failed to load remotes',
  'serverMessage.git.mergeFailed': 'Failed to merge',
  'serverMessage.git.removeRemoteFailed': 'Failed to remove remote',
  'configUpdate.updatingOpenCode': 'Updating OpenCode configuration...',
  'configUpdate.creatingCommand': 'Creating command configuration…',
  'configUpdate.updatingCommand': 'Updating command configuration…',
  'configUpdate.deletingCommand': 'Deleting command configuration…',
  'configUpdate.creatingSkill': 'Creating skill...',
  'configUpdate.updatingSkill': 'Updating skill...',
  'configUpdate.renamingSkill': 'Renaming skill...',
  'configUpdate.deletingSkill': 'Deleting skill...',
  'configUpdate.installingSkills': 'Installing skills…',
  'configUpdate.creatingMcp': 'Creating MCP server configuration…',
  'configUpdate.updatingMcp': 'Updating MCP server configuration…',
  'configUpdate.deletingMcp': 'Deleting MCP server configuration…',
  'configUpdate.creatingAgent': 'Creating agent configuration…',
  'configUpdate.updatingAgent': 'Updating agent configuration…',
  'configUpdate.deletingAgent': 'Deleting agent configuration…',
  'configUpdate.reloadingOpenCode': 'Reloading OpenCode configuration…',
} as const;
