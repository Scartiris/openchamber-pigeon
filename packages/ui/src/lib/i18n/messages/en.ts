...
export const dict = {
  ...
  'chat.planMode.label': 'Plan mode',
  'chat.planMode.enable': 'Turn on plan mode',
  'chat.planMode.disable': 'Turn off plan mode',
  'chat.planMode.description': 'Runs the plan agent: it can read and write plan files only, never your code. Turning it off returns to the previous agent.',
  'chat.planMode.unavailable': 'The plan agent is not available for this session.',
