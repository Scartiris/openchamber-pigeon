...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.planMode.label": "Режим планування",
  "chat.planMode.enable": "Увімкнути режим планування",
  "chat.planMode.disable": "Вимкнути режим планування",
  "chat.planMode.description": "Використовує агента планування: він може лише читати та записувати файли плану, але не змінює код. Вимкнення повертає попереднього агента.",
  "chat.planMode.unavailable": "У цій сесії агент планування недоступний.",
