...
export const dict: Record<I18nKey, string> = {
  ...
  // Document preview
  "contextPanel.mode.doc": "Документ",
  "contextRail.surface.doc.description": "Переглядайте документи Word, Excel, PowerPoint і PDF",
  ...
  "fleet.header.aria": "Стан флоту: памʼять хоста {mem}%, диск {disk}%, пристрої {online}/{total}",
  "fleet.header.tooltip.title": "Стан флоту",
  "fleet.header.tooltip.host": "Памʼять хоста {mem}% · диск {disk}%",
  "fleet.header.tooltip.devices": "Пристрої онлайн {online}/{total}",
  "fleet.header.tooltip.stale": "Метрики хоста мають {seconds} с",
  "fleet.header.tooltip.unavailable": "Метрики хоста недоступні",
  "fleet.dialog.title": "Стан флоту",
  "fleet.dialog.description": "Памʼять, диск і мережа хоста workbench та всіх зареєстрованих пристроїв.",
  "fleet.dialog.refresh": "Оновити",
  "fleet.dialog.refreshing": "Оновлення…",
  "fleet.dialog.checkedAt": "Зібрано {seconds} с тому",
  ...
  "fleet.metric.memory": "Памʼять",
  "fleet.metric.disk": "Диск",
  "fleet.metric.network": "Мережа",
  "fleet.metric.networkUnavailable": "Недоступно",
  "fleet.metric.load": "Навантаження",
  "fleet.metric.uptime": "Час роботи",
  "fleet.metric.containers": "Контейнери",
  "fleet.metric.swap": "Своп",
  "fleet.metric.rtt": "RTT {ms} мс",
  "fleet.status.online": "Онлайн",
  "fleet.status.offline": "Офлайн",
  "fleet.error.load": "Стан флоту HTTP {status}",
  "fleet.error.parse": "Відповідь стану флоту не зрозуміла",
  "fleet.hostHelper.hint": "Стовпець мережі потребує помічника oc-host-metrics на сервері.",
  ...
  "chat.composerMode.label": "Режим",
  "chat.composerMode.build": "Робота",
  "chat.composerMode.plan": "План",
  "chat.composerMode.chat": "Чат",
  "chat.composerMode.buildDescription": "Працює як звично: читає, пише й виконує те, що потрібно для задачі.",
  "chat.composerMode.planDescription": "Спершу планує: лише читає та записує файли плану, коду не змінює.",
  "chat.composerMode.chatDescription": "Лише чат: не пише файлів, не виконує команд, нічого не видає.",
  "chat.composerMode.unavailable": "Агент «{mode}» недоступний.",
  "chat.promptEnhance.action": "Покращити промпт",
  "chat.promptEnhance.busy": "Покращення промпту…",
  "chat.promptEnhance.applied": "Промпт покращено ({model})",
  "chat.promptEnhance.undo": "Скасувати",
  "chat.promptEnhance.draftChanged": "Чернетку змінено, тож покращення не застосовано",
  "chat.promptEnhance.failed": "Не вдалося покращити промпт",
  "chat.promptEnhance.errorTooLong": "Чернетка довша, ніж приймає ця модель. Скоротіть її та спробуйте знову.",
  "chat.promptEnhance.errorUnavailable": "Сервер не може звернутися до цієї моделі. Перевірте її облікові дані або виберіть малу модель у «Налаштування → Сеанси».",
  "chat.promptEnhance.errorGeneric": "Модель не повернула придатного промпту. Спробуйте ще раз.",
  ...
  "agents.builtin.plan": "План",
  "agents.builtin.chat": "Чат",
  ...
  // Artifact Center
  'artifacts.page.title': 'Центр артефактів',
  'artifacts.list.searchPlaceholder': 'Пошук артефактів…',
  'artifacts.list.loading': 'Завантаження…',
  'artifacts.list.retry': 'Повторити',
  'artifacts.list.empty': 'Артефактів ще немає. Зберіть файл із дерева, щоб почати керування версіями.',
  'artifacts.list.missing': 'Вихідний файл відсутній',
  'artifacts.detail.selectHint': 'Виберіть артефакт, щоб переглянути версії.',
  'artifacts.detail.meta': '{size} · оновлено {when}',
  'artifacts.versions.title': 'Версії',
  'artifacts.versions.count': '{count} версій',
  'artifacts.versions.tierHot': 'Гаряче',
  'artifacts.versions.tierCold': 'Холодне (Drive)',
  'artifacts.versions.tierRestoring': 'Відновлення',
  'artifacts.versions.labelPlaceholder': 'Мітка версії…',
  'artifacts.actions.preview': 'Попередній перегляд',
  'artifacts.actions.restore': 'Відновити',
  'artifacts.actions.pull': 'Отримати з Drive',
  'artifacts.actions.saveLabel': 'Зберегти мітку',
  'artifacts.actions.uncollect': 'Прибрати з центру',
  'artifacts.actions.collect': 'Зібрати як артефакт',
  'artifacts.actions.openCenter': 'Відкрити центр артефактів',
  'artifacts.actions.openCenterShort': 'Центр',
  'artifacts.status.collectedVersions': '{count} версій',
  'artifacts.status.notCollected': 'Не зібрано',
  'artifacts.status.collected': 'Зібрано',
  'artifacts.candidates.title': 'Вхідні кандидати',
  'artifacts.candidates.count': '{count} кандидатів',
  'artifacts.candidates.empty': 'Немає нещодавніх файлів результатів для збору.',
  'artifacts.list.collectedTitle': 'Зібрані',
  'artifacts.sidebar.badgeAria': '{count} артефактів',
  'sessions.sidebar.nav.artifacts': 'Центр артефактів',
  'artifacts.toast.collected': 'Додано до центру артефактів',
  'artifacts.toast.alreadyCollected': 'Уже в центрі артефактів',
  'artifacts.toast.labelSaved': 'Мітку версії збережено',
  'artifacts.toast.labelCleared': 'Мітку версії очищено',
  'artifacts.toast.restored': 'Вихідний файл відновлено з версії',
  'artifacts.toast.pulled': 'Версію повернено в гаряче сховище',
  'artifacts.toast.uncollected': 'Прибрано з центру артефактів',
  'artifacts.restore.dirtyConfirm': 'У вихідному файлі є незбережені зміни. Все одно відновити й перезаписати?',
  'commandPalette.item.openArtifactCenter': 'Відкрити центр артефактів',
  // Google Drive cold tier
  'settings.integrations.googleDrive.title': 'Google Drive',
  'settings.integrations.googleDrive.description': 'Холодний шар для версій центру артефактів. Потрібен OAuth-клієнт Drive на сервері.',
  'settings.integrations.googleDrive.status.notConfigured': 'Не налаштовано на цьому сервері',
  'settings.integrations.googleDrive.status.connected': 'Підключено',
  'settings.integrations.googleDrive.status.notConnected': 'Не підключено',
  'settings.integrations.googleDrive.actions.connect': 'Підключити',
  'settings.integrations.googleDrive.actions.disconnect': 'Відключити',
  'settings.integrations.googleDrive.actions.refresh': 'Оновити',
  'settings.integrations.googleDrive.toast.authOpened': 'Завершіть вхід Google у відкритому вікні',
  'settings.integrations.googleDrive.toast.disconnected': 'Google Drive відключено',
  ...
  'header.workspaceEntry.label': 'Робоча ділянка',
  'header.workspaceEntry.hint': 'Бічна панель показує лише сесії цієї ділянки.',
  'header.workspaceEntry.code': 'Код',
  'header.workspaceEntry.work': 'Робота',
  ...
  // Document preview
  "documentPreview.actions.download": "Завантажити оригінал",
  ...
  "documentPreview.error.tooLarge": "Цей файл завеликий для перегляду.",
  "documentPreview.error.unsupported": "Цей тип файлу не можна переглянути.",
  "chat.fileLink.previewTitle": "Натисніть, щоб переглянути",
  "filesView.actions.openDocumentPreview": "Відкрити перегляд документів",
  // Статистика використання токенів (шапка)
  'tokenUsage.header.aria': 'Відкрити статистику використання токенів',
  'tokenUsage.header.tooltip': 'Сьогодні: {tokens} токенів',
  'tokenUsage.period.today': 'Сьогодні',
  'tokenUsage.period.last7Days': 'Останні 7 днів',
  'tokenUsage.period.last30Days': 'Останні 30 днів',
  'tokenUsage.dialog.title': 'Використання токенів',
  'tokenUsage.dialog.description': 'Споживання токенів за періодом, моделлю та попаданнями кешу.',
  'tokenUsage.dialog.byModel': 'За моделлю',
  'tokenUsage.dialog.empty': 'У цьому періоді немає використання токенів.',
  'tokenUsage.dialog.unknownModel': 'Невідома модель',
  'tokenUsage.dialog.cacheHitValue': 'Попадання кешу {percent}%',
  'tokenUsage.dialog.refresh': 'Оновити',
  'tokenUsage.dialog.refreshAria': 'Оновити використання токенів',
  'tokenUsage.dialog.loading': 'Збір використання токенів…',
  'tokenUsage.dialog.partial': 'Не вдалося прочитати {failed} із {scanned} сесій.',
  'tokenUsage.stats.input': 'Вхід',
  'tokenUsage.stats.output': 'Вихід',
  'tokenUsage.stats.reasoning': 'Міркування',
  ...
  'toolDisplayName.openvikingSearch': 'Пошук OpenViking',
  'toolDisplayName.openvikingFind': 'OpenViking Find',
  'toolDisplayName.openvikingRemember': 'OpenViking Запам’ятати',
  'toolDisplayName.openvikingRead': 'OpenViking Читання',
  'toolDisplayName.openvikingList': 'OpenViking Список',
  'toolDisplayName.openvikingTree': 'OpenViking Дерево',
  'toolDisplayName.openvikingGrep': 'OpenViking Grep',
  'toolDisplayName.openvikingGlob': 'OpenViking Glob',
  'toolDisplayName.openvikingWrite': 'OpenViking Запис',
  'toolDisplayName.openvikingEdit': 'OpenViking Редагування',
  'toolDisplayName.openvikingAddResource': 'OpenViking Додати ресурс',
  'toolDisplayName.openvikingForget': 'OpenViking Забути',
  'toolDisplayName.openvikingListWatches': 'OpenViking Список спостережень',
  'toolDisplayName.openvikingCancelWatch': 'OpenViking Скасувати спостереження',
  'toolDisplayName.openvikingHealth': 'OpenViking Стан',
  'sessions.sidebar.session.fork.toast.forkedFrom': 'Відгалужено від {title}',
  'sessions.sidebar.session.fork.toast.failed': 'Не вдалося відгалузити сесію',
  'header.sessions.untitled': 'Сесія без назви',
  'settings.menu.opencodeStatusFailed': 'Не вдалося прочитати стан OpenCode',
  'tray.respondPermissionFailed': 'Не вдалося відповісти на запит дозволу',
  'session.newWorktree.toast.noActiveProject': 'Немає активного проєкту',
  'session.newWorktree.toast.notGitRepository': 'Ця тека не є Git-репозиторієм',
  'chat.toolPart.subagent.waiting': 'Очікування активності підагента…',
  'chat.toolPart.subagent.missingSessionId': 'Немає ID сесії підагента в метаданих завдання.',
  'chat.toolOutputDialog.labels.command': 'Команда:',
  'chat.toolOutputDialog.labels.task': 'Деталі завдання:',
  'chat.toolOutputDialog.labels.input': 'Вхідні дані:',
  'chat.toolOutputDialog.imagePreview': 'Попередній перегляд зображення',
  'settings.commands.sidebar.toast.commandRenamed': 'Команду «{name}» перейменовано',
  'agentManager.view.toast.creatingGroup': 'Створення групи агентів «{name}» з {count} запусками...',
  'agentManager.view.toast.groupCreated': 'Групу агентів «{name}» створено з {count} сесіями',
  'header.services.remoteUpdate.checkFailed': 'Не вдалося перевірити оновлення віддаленого екземпляра',
  'settings.remoteInstances.page.forward.localTarget': 'Локальна ціль',
  'settings.remoteInstances.page.forward.localListen': 'Локальне прослуховування',
  'settings.remoteInstances.page.forward.remoteListen': 'Віддалене прослуховування',
  'settings.remoteInstances.page.forward.remoteTarget': 'Віддалена ціль',
  'settings.remoteInstances.page.forward.localTargetHint': 'Локальний хост і порт на вашій машині, які отримують трафік від віддаленого слухача -R.',
  'settings.remoteInstances.page.forward.localListenHint': 'Локальний хост і порт, де ця передача прослуховує на вашій машині.',
  'settings.remoteInstances.page.forward.remoteListenHint': 'Віддалений хост і порт, де SSH створює слухача -R.',
  'settings.remoteInstances.page.forward.remoteTargetHint': 'Віддалений хост і порт, які отримують трафік від локального слухача -L.',
  'chat.toolOutputDialog.taskFields.task': 'Завдання:',
  'chat.toolOutputDialog.taskFields.agentType': 'Тип агента:',
  'chat.toolOutputDialog.taskFields.instructions': 'Інструкції:',
  'gitView.toast.removeRemoteFailed': 'Не вдалося видалити віддалений {name}',
  'gitView.toast.upstreamSetFailed': 'Не вдалося налаштувати upstream',
  'gitView.toast.mergeFailed': 'Не вдалося злити {branch}',
  'gitView.toast.rebaseFailed': 'Не вдалося rebase на {branch}',
  'contextSidebar.message.userLabel': 'Користувач:',
  'artifacts.toast.collectFailed': 'Не вдалося зібрати цей файл як артефакт',
  'guests.host.notGranted': 'Користувач не дозволив цю можливість для розширення.',
  'guests.host.extensionUnavailable': 'Розширення недоступне.',
  'guests.host.extensionDisabled': 'Це розширення вимкнено в Налаштування → Розширення.',
  'guests.host.requestFailed': 'Запит не вдався.',
  'guests.host.noProject': 'Немає відкритого проєкту.',
  'guests.host.operationFailed': 'Операцію розширення не виконано.',
  'guests.service.noService': 'Немає доступного сервісу для цього розширення.',
  'serverMessage.opencode.configReloaded': 'Конфігурацію перезавантажено. Оновлення інтерфейсу…',
  'serverMessage.opencode.manualRestart': 'Збережено на диску. Перезапустіть підключений сервер OpenCode, щоб застосувати зміни.',
  'serverMessage.session.interruptedByRestart': 'Перервано через перезапуск OpenCode',
  'serverMessage.session.interruptedByRestartDetail': 'Поточний хід перервано під час перезапуску OpenCode.',
  'serverMessage.opencode.restartToApply': 'Збережено. Перезапустіть OpenCode, щоб застосувати.',
  'serverMessage.opencode.noSkillsInstalled': 'Навички не встановлено',
  'serverMessage.git.statusFailed': 'Не вдалося отримати стан Git',
  'serverMessage.git.diffFailed': 'Не вдалося завантажити Git-різницю',
  'serverMessage.git.pushFailed': 'Не вдалося push',
  'serverMessage.git.pullFailed': 'Не вдалося pull',
  'serverMessage.git.branchesFailed': 'Не вдалося завантажити гілки',
  'serverMessage.git.remotesFailed': 'Не вдалося завантажити віддалені',
  'serverMessage.git.mergeFailed': 'Не вдалося злити',
  'serverMessage.git.removeRemoteFailed': 'Не вдалося видалити віддалений',
  'configUpdate.updatingOpenCode': 'Оновлення конфігурації OpenCode…',
  'configUpdate.creatingCommand': 'Створення конфігурації команди…',
  'configUpdate.updatingCommand': 'Оновлення конфігурації команди…',
  'configUpdate.deletingCommand': 'Видалення конфігурації команди…',
  'configUpdate.creatingSkill': 'Створення навички…',
  'configUpdate.updatingSkill': 'Оновлення навички…',
  'configUpdate.renamingSkill': 'Перейменування навички…',
  'configUpdate.deletingSkill': 'Видалення навички…',
  'configUpdate.installingSkills': 'Встановлення навичок…',
  'configUpdate.creatingMcp': 'Створення конфігурації MCP-сервера…',
  'configUpdate.updatingMcp': 'Оновлення конфігурації MCP-сервера…',
  'configUpdate.deletingMcp': 'Видалення конфігурації MCP-сервера…',
  'configUpdate.creatingAgent': 'Створення конфігурації агента…',
  'configUpdate.updatingAgent': 'Оновлення конфігурації агента…',
  'configUpdate.deletingAgent': 'Видалення конфігурації агента…',
  'configUpdate.reloadingOpenCode': 'Перезавантаження конфігурації OpenCode…',
};
