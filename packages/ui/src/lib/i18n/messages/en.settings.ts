...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': 'Wallpaper behind the interface',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': 'Plays a looping video behind the whole workspace — sidebar, header and panels all let it through. Desktop only.',
  'settings.openchamber.visual.field.chatBackdropIntensity': 'Wallpaper intensity',
  ...
  'settings.page.memoryBrowse.description': 'Browse long-term memory in OpenViking as a file tree.',
  'settings.page.knowledgeSettings.title': 'Knowledge settings',
  'settings.page.knowledgeSettings.description': 'Connection and readiness of the OpenViking knowledge store.',
  'settings.page.knowledgeBrowse.title': 'Knowledge browser',
  'settings.page.knowledgeBrowse.description': 'Browse resources and documents in OpenViking as a file tree.',
  'settings.openviking.notConfigured.short': 'OpenViking is not configured.',
  'settings.openviking.notConfigured.long': 'This workspace has no OpenViking configured, so memory and knowledge browsing are unavailable.',
  'settings.openviking.settings.envHint': 'Set the container environment variables',
  'settings.openviking.settings.connection': 'Connection',
  'settings.openviking.settings.storage': 'Storage',
  'settings.openviking.settings.upstream': 'Upstream address',
  'settings.openviking.settings.version': 'Version',
  'settings.openviking.settings.ready': 'Readiness',
  'settings.openviking.settings.identity': 'Identity',
  'settings.openviking.settings.scope': 'Scope',
  ...
  'settings.openviking.memory.sidebar.description': 'Everything OpenViking remembered, by file tree.',
  'settings.openviking.memory.empty': 'No memory has been stored yet.',
  'settings.openviking.knowledge.sidebar.title': 'Knowledge',
  'settings.openviking.knowledge.sidebar.description': 'Imported resources and documents, by file tree.',
  'settings.openviking.knowledge.empty': 'No resource has been imported yet.',
  'settings.openviking.browse.loading': 'Loading…',
  'settings.openviking.browse.loadFailed': 'Could not load the tree.',
  'settings.openviking.browse.readFailed': 'Could not read this entry.',
  'settings.openviking.browse.refresh': 'Refresh',
  'settings.openviking.browse.pickHint': 'Pick an entry on the left to see its content.',
  'settings.openviking.browse.overview': 'Overview',
  'settings.openviking.browse.overviewEmpty': 'No overview has been generated for this directory yet.',
  'settings.openviking.browse.overviewFailed': 'Could not load the directory overview.',
  'settings.openviking.browse.childCount': '{{count}} entries',
  'settings.openviking.browse.edit': 'Edit',
  'settings.openviking.browse.editBody': 'File content',
  'settings.openviking.browse.save': 'Save',
  'settings.openviking.browse.saving': 'Saving…',
  'settings.openviking.browse.saveFailed': 'Could not save this entry.',
  'settings.openviking.browse.cancel': 'Cancel',
  'settings.openviking.browse.delete': 'Delete',
  'settings.openviking.browse.deleteTitle': 'Delete this entry?',
  'settings.openviking.browse.deleteDescription': 'Delete "{name}"? This cannot be undone.',
  'settings.openviking.browse.deleteNoRecycle': 'There is no trash. Deleted entries cannot be recovered.',
  'settings.openviking.browse.deleteConfirm': 'Delete',
  'settings.openviking.browse.deleting': 'Deleting…',
  'settings.openviking.browse.deleteFailed': 'Could not delete this entry.',
  'settings.openviking.browse.create': 'New entry',
  'settings.openviking.browse.createTitle': 'New entry',
  'settings.openviking.browse.createDescription': 'Create under {parent}',
  'settings.openviking.browse.createNoParent': 'Pick a directory first.',
  'settings.openviking.browse.createNameLabel': 'File name',
  'settings.openviking.browse.createNamePlaceholder': 'note.md',
  'settings.openviking.browse.createContentLabel': 'Content',
  'settings.openviking.browse.createContentPlaceholder': 'Write the content…',
  'settings.openviking.browse.createSubmit': 'Create',
  'settings.openviking.browse.createFailed': 'Could not create this entry.',
  'settings.openviking.browse.createInvalidName': 'Use a plain file name without / or \\, and avoid reserved names.',
  ...
  'settings.openchamber.visual.section.chatBackdrop': 'App backdrop',
  'settings.openchamber.visual.section.chatBackdropInfo': 'The video is served from this instance at /ambient/chat-backdrop.mp4. Replace that file and rebuild to change it.',
  ...
  'settings.page.devices.description': 'Register Windows devices for agent MCP shell, file, and screen access.',
  'settings.page.pigeonBrain.description': 'Manage long-term memory and the knowledge store.',
  'settings.devices.approval.deny': 'Deny',
  'settings.devices.approval.smart': 'Smart approve',
  'settings.devices.approval.auto': 'Auto',
  'settings.devices.section.registered': 'Registered devices',
  'settings.devices.section.agentMcpToken': 'Agent MCP Token',
  'settings.devices.section.audit': 'Recent audit',
  'settings.devices.audit.empty': 'No entries yet.',
  'settings.devices.empty': 'No devices yet. Register the first Windows machine below.',
  'settings.devices.status.probing': 'Probing status…',
  'settings.devices.actions.probing': 'Probing…',
  'settings.devices.actions.refresh': 'Refresh status',
  'settings.devices.status.probeFailed': 'Status probe failed: {error}',
  'settings.devices.status.onlineCount': 'Online {online}/{total}',
  'settings.devices.status.probedAt': 'probed at {time}',
  'settings.devices.status.online': 'Online',
  'settings.devices.status.offline': 'Offline',
  'settings.devices.actions.approval': 'Approval',
  'settings.devices.actions.delete': 'Delete',
  'settings.devices.dialog.deleteConfirm': 'Delete this registered device?',
  'settings.devices.enroll.title': 'One-click enrollment',
  'settings.devices.enroll.description': 'Run one admin PowerShell command on the target Windows machine. The enroll code is valid for 15 minutes and is consumed after success.',
  'settings.devices.enroll.generate': 'Generate enroll code',
  'settings.devices.enroll.hint': 'Click Generate enroll code to get the one-click command.',
  'settings.devices.enroll.copyToTarget': 'Copy to the target machine (expires: {expiresAt}):',
  'settings.devices.enroll.copyCommand': 'Copy command',
  'settings.devices.enroll.copyCodeOnly': 'Copy code only',
  'settings.devices.enroll.scriptHelp': 'The script will generate or reuse an SSH key, try to authorize administrators_authorized_keys, probe Tailscale, optionally print Windows-MCP startup arguments, then register this device with the workbench.',
  'settings.devices.enroll.tokenItem': 'Unused · {label} · expires {expiresAt}',
  'settings.devices.form.manual': 'Manual registration (advanced)',
  'settings.devices.form.namePlaceholder': 'Name, for example site laptop',
  'settings.devices.form.hostPlaceholder': 'Tailscale IP (optional)',
  'settings.devices.form.sshPortPlaceholder': 'SSH port (default 22)',
  'settings.devices.form.mcpPortPlaceholder': 'Windows-MCP port (optional, tunnel exit)',
  'settings.devices.form.sshUserPlaceholder': 'SSH user',
  'settings.devices.form.mcpBearerPlaceholder': 'Windows-MCP Bearer (optional)',
  'settings.devices.form.sshKeyPlaceholder': 'SSH private key (optional, stored only in the server data dir)',
  'settings.devices.actions.enroll': 'Register device',
  'settings.devices.actions.createToken': 'Create token',
  'settings.devices.token.copyOnce': 'Copy it now — it will not be shown again after you close this card:',
  'settings.devices.token.endpointHint': 'MCP endpoint: POST /api/devices/mcp (Authorization: Bearer <token>)',
  'settings.devices.token.createdAt': 'created {time}',
  'settings.devices.toast.copyFailed': 'Copy failed. Select the command manually.',
  'settings.devices.error.loadDevices': 'Device list HTTP {status}',
  'settings.devices.error.statusProbe': 'Status probe HTTP {status}',
  'settings.devices.error.nameRequired': 'Enter a device name.',
  'settings.devices.error.enrollFailed': 'Enrollment failed HTTP {status}',
  'settings.devices.error.approvalFailed': 'Update approval failed HTTP {status}',
  'settings.devices.error.deleteFailed': 'Delete failed HTTP {status}',
  'settings.devices.error.createTokenFailed': 'Create token failed HTTP {status}',
  'settings.devices.error.createEnrollFailed': 'Create enroll code failed HTTP {status}',
  'settings.devices.error.enrollTokenMissing': 'Enroll code response was missing the token.',
  'settings.pigeonBrain.actions.reload': 'Reload',
  'settings.pigeonBrain.actions.openInNewTab': 'Open in a new tab',
  'settings.pigeonBrain.status.error': 'Could not read status ({error}). The workbench server may not be running.',
  'settings.pigeonBrain.status.checking': 'Checking…',
  'settings.pigeonBrain.notConfigured.title': 'This workbench does not have pigeon-brain configured.',
  'settings.pigeonBrain.notConfigured.help': 'Set PIGEON_BRAIN_URL in the container environment (for example http://brain:3210) and restart. When unset, this route is not mounted and the rest of the workbench is unaffected.',
  'settings.pigeonBrain.iframeTitle': 'pigeon-brain admin UI',
  'settings.mcp.oauth.callback.working': 'Completing MCP authorization...',
  'settings.mcp.oauth.callback.success': 'Authorization completed. You can close this tab and return to OpenChamber.',
  'settings.mcp.oauth.callback.error': 'Authorization failed',
  'settings.mcp.oauth.callback.browserUnavailable': 'Browser context unavailable.',
  'settings.mcp.oauth.callback.sessionExpired': 'Authorization session expired or was cleared during reload. Return to OpenChamber and click Authorize again.',
  'settings.mcp.oauth.callback.missingCode': 'Missing OAuth authorization code. Start authorization again from MCP Settings, or paste the returned code into OpenChamber manually.',
  'settings.mcp.oauth.callback.sessionUnavailable': 'Authorization session details were not available. Start authorization again from MCP Settings, or paste the returned code into OpenChamber manually.',
  'settings.mcp.oauth.callback.completeFailed': 'Failed to complete MCP authorization.',
  'settings.mcp.oauth.callback.return': 'Return to OpenChamber',
  'settings.mcp.oauth.callback.titles.working': 'Completing Authorization',
  'settings.mcp.oauth.callback.titles.success': 'Authorization Complete',
  'settings.mcp.oauth.callback.titles.error': 'Authorization Failed',
  'settings.page.home.title': 'Settings',
  'settings.page.home.description': 'Search and jump to common pages.',
} as const;
