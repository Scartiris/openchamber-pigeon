...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.chatBackdropEnabled': 'Wallpaper behind the chat',
  'settings.openchamber.visual.field.chatBackdropEnabledHint': 'Plays a looping video behind the messages. Sidebars, panels and popovers stay solid. Desktop only.',
  ...
  'settings.openchamber.visual.section.chatBackdrop': 'Chat backdrop',
