...
export const Header: React.FC = () => {
  ...
  const activeSurfaceHeader = React.useMemo<{ title: string; subtitle: string | null } | null>(() => {
    ...
    return null;
  }, [guestPage, isArchiveSurfaceOpen, isArtifactCenterSurfaceOpen, isMultiRunSurfaceOpen, isScheduledSurfaceOpen, t, worktreesSurfaceProjectId, worktreesSurfaceProjectLabel]);
